...
![lay: double Shift layout rescue](https://raw.githubusercontent.com/radislabus-star/lay-public/main/docs/publicity/cover.png)
...
![lay demo](https://raw.githubusercontent.com/radislabus-star/lay-public/main/docs/publicity/demo.gif)

Проект ещё beta, но для ежедневного RU/EN набора он уже стал рабочим
...
## Почему не серые подсказки прямо в поле
...
IBus или Fcitx. Это уже отдельная архитектура, ближе к IME, а не маленький патч
к daemon.
...
Поэтому текущий стабильный путь остаётся без inline-магии: double Shift,
автопомощь после пробела и минимальные замены.
...
Сейчас `lay` — beta для Linux desktops и RU/EN раскладок.
...
- подумать об отдельном IME/preedit-режиме, но не тащить его в стабильный
  daemon без отдельного плана;
