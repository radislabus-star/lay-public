...
task_id: m3-v8r3-latency-failure-decision-v1-route-v4
domain: general
...
|----|---------|----------|--------|----------|------------|--------------|-------------|-------|-------|
| s1 | V8R3 history | remains | immutable terminal BLOCKED_LATENCY | latency-decision-v1.md:94 | 1.0 | historical experiment | terminal predecessor | history | history |
| s2 | V8R3 passing evidence | remains_valid_within | exact test-only semantic capacity RSS and reload scope | latency-decision-v1.md:94-96 | 1.0 | scoped predecessor evidence | retained claim | history | history |
...
| s4 | V8R3 measurement | does_not_prove | dominant operation inside final materialization | latency-decision-v1.md:74-90 | 1.0 | measured outer span | unmeasured inner cause | interpretation | interpretation |
...
| id | subject | relation | object | evidence | confidence | subject_role | object_role | route | group |
|----|---------|----------|--------|----------|------------|--------------|-------------|-------|-------|
| c1 | V8R3 history | remains | immutable terminal BLOCKED_LATENCY | exact terminal receipt SHA and consumed marker | 1.0 | historical experiment | terminal predecessor | history | history |
...
- V1 remains VETO; V2 and V3 remain WATCH. None grants code authority.
- V4 groups compatible historical and interpretation claims to remain within the eight-route limit.
