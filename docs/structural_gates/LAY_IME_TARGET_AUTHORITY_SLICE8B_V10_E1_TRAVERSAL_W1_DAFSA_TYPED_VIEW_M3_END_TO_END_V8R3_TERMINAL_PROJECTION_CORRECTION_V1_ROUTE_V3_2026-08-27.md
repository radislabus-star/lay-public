...
task_id: m3-end-to-end-v8r3-terminal-projection-correction-v1-route-v3
domain: general
...
| s2 | V8R1 remote state | represents | E2E_CREATED_UNAUDITED producer observation | terminal-projection-v1.md:31-34 | 1.0 | remote producer | immutable observation | projection | projection |
| s3 | V8R1 terminal receipt | represents | independent BLOCKED_PROVENANCE verdict | terminal-projection-v1.md:36-43 | 1.0 | local auditor | terminal authority | projection | projection |
...
- V1 carried a shared-span repair item; V2 exceeded the route-count target.
- V3 uses one projection route with distinct evidence spans for producer and auditor facts.
