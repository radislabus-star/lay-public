...
task_id: lay-v10-loaded-pmu-diagnosis-v2-route-v3
domain: code
...
| c9 | V2 publication owner | preserves | raw counted inactive parity and environment evidence | publication contract | 1.0 | evidence owner | diagnostic artifact | publication | pmu-v2-publication |
...
- The V2 all-owner worksheet and its VETO receipt remain immutable evidence.
