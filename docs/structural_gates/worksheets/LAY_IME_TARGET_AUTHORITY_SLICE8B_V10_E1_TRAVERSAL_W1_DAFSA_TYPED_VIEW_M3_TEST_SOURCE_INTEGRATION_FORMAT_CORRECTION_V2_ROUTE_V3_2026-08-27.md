...
task_id: m3-test-source-integration-format-correction-v2-route-v3
domain: general
...
|----|---------|----------|--------|----------|------------|--------------|-------------|-------|-------|
| f1 | sealed M3 sidecar | has_format | LAYV13D2 12-byte records | exact header and M3 source | 1.0 | historical evidence | old encoding | history | history |
| f2 | current V13DafsaView | validates | LAYV13D3 8-8-4 records | current source d9edfe73 | 1.0 | byte validator | current encoding | current-format | current-format |
...
| f6 | current byte validator | provides | validated decoded fields to typed materializer | correction V2 ownership chain | 1.0 | format validator | safe decoder consumer | validation | validation |
...
| f9 | old V10 sidecar | remains | immutable historical evidence only | correction V2 preserved scope | 1.0 | historical evidence | non-input artifact | history | history |
...
| id | subject | relation | object | evidence | confidence | subject_role | object_role | route | group |
|----|---------|----------|--------|----------|------------|--------------|-------------|-------|-------|
| c1 | sealed M3 sidecar | has_format | LAYV13D2 12-byte records | candidate does not feed it to current loader | 1.0 | historical evidence | old encoding | history | history |
| c2 | current V13DafsaView | validates | LAYV13D3 8-8-4 records | candidate preserves current format owner | 1.0 | byte validator | current encoding | current-format | current-format |
...
| c6 | current byte validator | provides | validated decoded fields to typed materializer | candidate adds no second parser | 1.0 | format validator | safe decoder consumer | validation | validation |
...
| c9 | old V10 sidecar | remains | immutable historical evidence only | candidate never mutates old artifact | 1.0 | historical evidence | non-input artifact | history | history |
