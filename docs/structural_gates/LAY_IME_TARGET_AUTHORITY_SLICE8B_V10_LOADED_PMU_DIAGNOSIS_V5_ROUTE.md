...
task_id: lay-v10-loaded-pmu-diagnosis-v2-route-v5
domain: code
...
| s9 | V2 result | does_not_admit | formal B clean C1 V12 or runtime deployment | correction claim boundary | 1.0 | scoped evidence | future authority | boundary | pmu-v2-boundary |
...
| c9 | V2 result | does_not_admit | formal B clean C1 V12 or runtime deployment | correction claim boundary | 1.0 | scoped evidence | future authority | boundary | pmu-v2-boundary |

## notes

- The V2 all-owner and V3/V4 weak-publication worksheets and their VETO receipts remain immutable evidence.
- Atomic publication remains mandatory in the correction contract and implementation preflight; it is not a route-gate decision owner.
