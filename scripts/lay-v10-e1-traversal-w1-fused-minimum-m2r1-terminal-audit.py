#!/usr/bin/env python3
"""Independent terminal scientific audit for W1 fused-minimum M2R1."""
...
def self_check() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2r1-terminal-audit-self-check.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "M2R1_TERMINAL_AUDITOR_VERIFIED_UNRUN",
        **values,
...
def audit() -> dict[str, Any]:
    ...
    try:
        ...
        receipt = {
            "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2r1-terminal-audit.v3",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
        ...
        write_json(stage / "M2R1_TERMINAL_AUDIT_RECEIPT.json", receipt)
        ...
        return {**receipt, "receipt_sha256": sha256_file(RESULT / "M2R1_TERMINAL_AUDIT_RECEIPT.json")}
