#!/usr/bin/env python3
"""V3 independent read-only audit of the single M2 diagnostic ELF."""
...
def self_check() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2-build-audit-self-check.v3",
        "task_id": TASK_ID,
...
def audit() -> dict[str, Any]:
    ...
    try:
        ...
        receipt = {
            "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2-build-audit.v3",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
            "verdict": verdict,
