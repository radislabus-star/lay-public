...
LOCAL_CONTROLLER = ROOT / "scripts/lay-v10-e1-traversal-w1-dafsa-typed-view-m3-v10r2.py"
...
CONTROLLER_IMPLEMENTATION = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_REMOTE_CONTROLLER_V1_2026-08-27/IMPLEMENTATION_RECEIPT.json"

RECEIPTS = ROOT / "docs/structural_gates/receipts"
ADMISSION_ROOT = RECEIPTS / "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_EXECUTION_ADMISSION_V1_2026-08-27"
BOOTSTRAP_AUDIT_ROOT = RECEIPTS / "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_BOOTSTRAP_AUDIT_V1_2026-08-27"
BUILD_AUDIT_ROOT = RECEIPTS / "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_BUILD_AUDIT_V1_2026-08-27"
QUIET_ROOT = RECEIPTS / "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_QUIET_ADMISSION_V1_2026-08-27"
TERMINAL_ROOT = RECEIPTS / "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_TERMINAL_AUDIT_V1_2026-08-27"
...
def fixed_local() -> dict[str, Any]:
    expected = {
        ...
        V10R1_IMPLEMENTATION: "d9b91168dbaa850ba5901c1b2f65f7119b3591be7918cd6a7126fad6f06451d4",
        V10R1_JOURNAL_MANIFEST: "ff91735880941eea9c382d10d953e2e2fee1f9cd2a13b0db366716a96a58be7f",
        V10R1_BUILD_AUDIT: "73ca7d3c5c678d3056cb74048e005d6edde81b72386324fdcbd08ca2ac0e39d9",
        V10R1_BUILD_DIAGNOSIS: "998ea221e3f024f80eef29dceabc72d9e6d7a72ac5e85648cd831b547891fbe7",
        V10R2_CORRECTION: "341c0e5df06bb7c7e3571b437b2e9b7f63c9a598733186a9b7a7a4efcd986826",
        V10R2_STRUCTURAL_RECEIPT: "b0910602c12db13759e3917a108da9b94cfc49ec2f85e38be4a31020b49f9bbf",
        ...
        CONTROLLER_PREFLIGHT: "469c7f23e725b1352c399bd0b4221efd668637d4c76dd33694af5f8dbcfca86d",
        V13_SOURCE: EXPECTED_SOURCE_SHA,
        LIVE_SOURCE: "36aeddd5e605e67377f99343f9937606ac774d9ba4bb5710152de060bc9d183b",
        ADMISSION_SOURCE: "6169e6d89a06c9ad3d7aefd467a8147f6d094b962faa25c739ad6d94a364b3dd",
    ...
    implementation = load_sealed_receipt(
        ...
        ("V10R2_REMOTE_CONTROLLERS_VERIFIED_UNRUN",),
    )
    for key, path in {
...
def live_admission() -> dict[str, Any]:
    ...
    probe_path = f"/home/e/.cache/lay-m3-v10r2-admission-{TRANSACTION_ID}"
    ...
    receipt = {
        "schema": "lay.v10r2-execution-admission.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "V10R2_EXECUTION_ADMITTED",
...
def bootstrap_audit() -> dict[str, Any]:
    local = fixed_local()
    admission = load_sealed_receipt(ADMISSION_ROOT, ADMISSION_RECEIPT, ("V10R2_EXECUTION_ADMITTED",))
    ...
    need(receipt.get("verdict") == "V10R2_BOOTSTRAP_CREATED_UNAUDITED", "remote bootstrap producer verdict drift")
    ...
    receipt_out = {
        "schema": "lay.v10r2-bootstrap-audit.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "V10R2_BOOTSTRAP_AUDIT_PASS_MARKERS_ADMITTED",
...
def build_audit() -> dict[str, Any]:
    ...
    bootstrap = load_sealed_receipt(
        ...
        ("V10R2_BOOTSTRAP_AUDIT_PASS_MARKERS_ADMITTED",),
    )
    snapshot = remote_snapshot()
    validate_host(snapshot)
    ...
    temporary = pathlib.Path(tempfile.mkdtemp(prefix="lay-m3-v10r2-build-audit-"))
    try:
        if build_state == "BLOCKED_BUILD":
            ...
            need(failure.get("schema") == "lay.v10r2-build-failure.v1", "build failure schema drift")
            ...
            receipt = {
                "schema": "lay.v10r2-build-audit.v1",
                "task_id": TASK_ID,
                "transaction_id": TRANSACTION_ID,
        ...
        need(provenance.get("verdict") == "V10R2_BUILD_CREATED_UNAUDITED", "build producer verdict drift")
        ...
        receipt = {
            ...
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
            "verdict": "V10R2_BUILD_AUDIT_PASS_TRACE_ADMITTED",
            "local_controller_sha256": bootstrap["local_controller_sha256"],
            "remote_controller_sha256": bootstrap["remote_controller_sha256"],
            "auditor_sha256": bootstrap["auditor_sha256"],
            "bootstrap_audit_sha256": sha256_file(BOOTSTRAP_AUDIT_RECEIPT),
...
def quiet_admission() -> dict[str, Any]:
    ...
    build = load_sealed_receipt(
        BUILD_AUDIT_ROOT,
        BUILD_AUDIT_RECEIPT,
        ("V10R2_BUILD_AUDIT_PASS_TRACE_ADMITTED",),
    )
    before = remote_snapshot()
    validate_host(before)
    ...
    receipt = {
        "schema": "lay.v10r2-quiet-admission.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "V10R2_QUIET_HOST_TRACE_ADMITTED",
...
def summarize_trace(rows: Sequence[Mapping[str, Any]], semantic_failures: Sequence[str]) -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10r2-admission-substage-trace.v1",
        "trace_rows": len(rows),
...
def marker_payload(route: str, authority: Mapping[str, Any]) -> bytes:
    ...
    return canonical({
        "schema": "lay.v10r2-one-shot-marker.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "route": route,
...
def terminal_decision(
    ...
    if wrapper.get("schema") != "lay.v10r2-trace-wrapper.v1" or wrapper.get("task_id") != TASK_ID or wrapper.get("transaction_id") != TRANSACTION_ID:
    ...
    if wrapper.get("verdict") not in {"V10R2_TRACE_CREATED_UNAUDITED", "BLOCKED_PROVENANCE"}:
    ...
    if build.get("verdict") != "V10R2_BUILD_AUDIT_PASS_TRACE_ADMITTED":
...
def terminal_audit() -> dict[str, Any]:
    ...
    quiet = load_sealed_receipt(QUIET_ROOT, QUIET_RECEIPT, ("V10R2_QUIET_HOST_TRACE_ADMITTED",))
    snapshot = remote_snapshot()
    validate_host(snapshot)
    ...
    temporary = pathlib.Path(tempfile.mkdtemp(prefix="lay-m3-v10r2-terminal-"))
    try:
        ...
        write_new(derived / "TRACE_SUMMARY.json", canonical({
            "schema": "lay.v10r2-admission-substage-derived.v1",
            "parse_failures": trace_failures,
            "summary": summary,
        }))
        receipt = {
            "schema": "lay.v10r2-terminal-audit.v1",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
            "verdict": verdict,
...
def self_check() -> dict[str, Any]:
    ...
    wrapper = {
        ...
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "V10R2_TRACE_CREATED_UNAUDITED",
    ...
    build = {"verdict": "V10R2_BUILD_AUDIT_PASS_TRACE_ADMITTED", "elf_sha256": "a" * 64}
    verdict, failures = terminal_decision(subject, wrapper, build, rows, trace_failures, summary)
    ...
    return {
        "schema": "lay.v10r2-independent-auditor-self-check.v1",
        "verdict": "V10R2_INDEPENDENT_AUDITOR_STATIC_PASS",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "auditor_sha256": sha256_file(AUDITOR),
...
def status() -> dict[str, Any]:
    return {
        "schema": "lay.v10r2-auditor-status.v1",
        "verdict": "V10R2_AUDITOR_STATUS",
        "receipts": {
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({
            "schema": "lay.v10r2-auditor-error.v1",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
