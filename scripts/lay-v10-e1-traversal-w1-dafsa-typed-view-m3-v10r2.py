...
TASK_ID = "slice8b-v10-e1-traversal-w1-dafsa-typed-view-m3-admission-substage-v10r2-20260827"
TRANSACTION_ID = "fe5b4741c5d5711b48f356569f3be32a87142edd78979edf0aeb72a9616de7e6"
...
REMOTE_CACHE = pathlib.PurePosixPath("/home/e/.cache") / f"lay-m3-v10r2-{TRANSACTION_ID}"

CONTROLLER = pathlib.Path(__file__).resolve()
REMOTE_CONTROLLER = ROOT / "scripts/lay-v10-e1-traversal-w1-dafsa-typed-view-m3-v10r2-remote.py"
AUDITOR = ROOT / "scripts/lay-v10-e1-traversal-w1-dafsa-typed-view-m3-v10r2-audit.py"
...
V10R1_IMPLEMENTATION = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R1_REMOTE_CONTROLLER_V1_2026-08-27/IMPLEMENTATION_RECEIPT.json"
V10R1_JOURNAL_MANIFEST = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R1_EXECUTION_JOURNAL_V1_2026-08-27/SHA256SUMS"
V10R1_BUILD_AUDIT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R1_BUILD_AUDIT_V1_2026-08-27/BUILD_AUDIT.json"
V10R1_BUILD_DIAGNOSIS = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R1_BUILD_FAILURE_DIAGNOSIS_2026-08-27.json"
V10R2_CORRECTION = ROOT / "docs/structural_gates/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_EXPLICIT_ARRAY_DEFAULT_CORRECTION_V1_2026-08-27.md"
V10R2_STRUCTURAL_RECEIPT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_EXPLICIT_ARRAY_DEFAULT_CORRECTION_V1_ROUTE_RECEIPT_2026-08-27.json"
...
CONTROLLER_PREFLIGHT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_REMOTE_CONTROLLER_V2_PREFLIGHT_2026-08-27.json"
CONTROLLER_EVIDENCE = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_REMOTE_CONTROLLER_V1_2026-08-27"
CONTROLLER_IMPLEMENTATION = CONTROLLER_EVIDENCE / "IMPLEMENTATION_RECEIPT.json"
EXECUTION_JOURNAL = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_EXECUTION_JOURNAL_V1_2026-08-27"

ADMISSION_RECEIPT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_EXECUTION_ADMISSION_V1_2026-08-27/EXECUTION_ADMISSION.json"
BOOTSTRAP_AUDIT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_BOOTSTRAP_AUDIT_V1_2026-08-27/BOOTSTRAP_AUDIT.json"
BUILD_AUDIT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_BUILD_AUDIT_V1_2026-08-27/BUILD_AUDIT.json"
QUIET_ADMISSION = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_QUIET_ADMISSION_V1_2026-08-27/QUIET_ADMISSION.json"
TERMINAL_AUDIT = ROOT / "docs/structural_gates/receipts/LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_DAFSA_TYPED_VIEW_M3_ADMISSION_SUBSTAGE_DIAGNOSTIC_V10R2_TERMINAL_AUDIT_V1_2026-08-27/TERMINAL_AUDIT.json"
...
def verify_controller_preflight() -> dict[str, Any]:
    ...
    need(value.get("manifest_sha256") == "9df378729935b12a60120cea8a2feb863dc0d8fe480c797b81fb5f0d38481de0", "controller preflight manifest identity drift")
    return value
...
def verify_fixed_inputs() -> dict[str, Any]:
    expected = {
        ...
        V10R1_CORRECTION: (5_756, "262f8ab7609218de41c364ba91688ec88b9a3cf4b3e32bd5f170d214ba7d805e"),
        V10R1_IMPLEMENTATION: (12_761, "d9b91168dbaa850ba5901c1b2f65f7119b3591be7918cd6a7126fad6f06451d4"),
        V10R1_JOURNAL_MANIFEST: (1_927, "ff91735880941eea9c382d10d953e2e2fee1f9cd2a13b0db366716a96a58be7f"),
        V10R1_BUILD_AUDIT: (253_276, "73ca7d3c5c678d3056cb74048e005d6edde81b72386324fdcbd08ca2ac0e39d9"),
        V10R1_BUILD_DIAGNOSIS: (2_625, "998ea221e3f024f80eef29dceabc72d9e6d7a72ac5e85648cd831b547891fbe7"),
        V10R2_CORRECTION: (5_373, "341c0e5df06bb7c7e3571b437b2e9b7f63c9a598733186a9b7a7a4efcd986826"),
        V10R2_STRUCTURAL_RECEIPT: (23_516, "b0910602c12db13759e3917a108da9b94cfc49ec2f85e38be4a31020b49f9bbf"),
        V10_V1_DIAGNOSIS: (2_349, "4935b5501eacc4d67ea404b4edd3ca1455dfe336a2c20f9ab050fa4d7672ec25"),
        V10_V1_IMPLEMENTATION: (10_804, "3b750bd1ec66d67c6d7e1dbe306b0c04a02b7ab9a839ec07bad0d7397b8652a8"),
        V10_V1_JOURNAL_MANIFEST: (265, "099d3c8334b11c98c3e7f0893a11d1347648aed1746cfcc1e466a166d818f12b"),
        ...
        ADMISSION_SOURCE: (88_326, "6169e6d89a06c9ad3d7aefd467a8147f6d094b962faa25c739ad6d94a364b3dd"),
...
def error_payload_fault() -> dict[str, Any]:
    ...
    except V10ControllerError as error:
        message = str(error)
    ...
    raise V10ControllerError("error payload fault injection did not fail")
...
def self_check() -> dict[str, Any]:
    ...
    need(remote.get("verdict") == "V10R2_REMOTE_CONTROLLER_STATIC_PASS", "remote self-check failed")
    need(auditor.get("verdict") == "V10R2_INDEPENDENT_AUDITOR_STATIC_PASS", "auditor self-check failed")
    faults = fault_model()
    payload_fault = error_payload_fault()
    source_closure = source_closure_snapshot()
    return {
        "schema": "lay.v10r2-controller-self-check.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "V10R2_CONTROLLER_STATIC_SELF_CHECK_PASS",
...
def seal_self_check() -> dict[str, Any]:
    ...
    receipt = {
        "schema": "lay.v10r2-controller-implementation.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "V10R2_REMOTE_CONTROLLERS_VERIFIED_UNRUN",
...
def build_source_closure(destination: pathlib.Path) -> dict[str, Any]:
    ...
    need(len(rows) >= 700, "source closure unexpectedly small")
    manifest = {
        "schema": "lay.v10r2-source-closure.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "files": rows,
        "files_count": len(rows),
...
def prepare_bootstrap(admission: Mapping[str, Any]) -> pathlib.Path:
    staging = pathlib.Path(tempfile.mkdtemp(prefix="lay-m3-v10r2-bootstrap-"))
    try:
        ...
        payload = {
            "schema": "lay.v10r2-bootstrap-payload.v1",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
...
def initialize_journal() -> pathlib.Path:
    ...
    metadata = {
        "schema": "lay.v10r2-execution-journal.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
...
def append_intent(root: pathlib.Path, sequence: int, action: str) -> pathlib.Path:
    ...
    write_new(path, canonical({
        "schema": "lay.v10r2-external-intent.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "sequence": sequence,
        "action": action,
...
def append_completion(root: pathlib.Path, sequence: int, action: str, response: Mapping[str, Any]) -> pathlib.Path:
    ...
    write_new(path, canonical({
        "schema": "lay.v10r2-external-completion.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "sequence": sequence,
        "action": action,
...
def create_remote_cache() -> dict[str, Any]:
    ...
    return {"verdict": "V10R2_REMOTE_CACHE_CREATED", "stdout_sha256": sha256_bytes(output)}
...
def upload_bootstrap(staging: pathlib.Path) -> dict[str, Any]:
    ...
    return {"verdict": "V10R2_BOOTSTRAP_UPLOADED", "payload_sha256": sha256_file(staging / "PAYLOAD.json")}
...
def verify_implementation() -> dict[str, Any]:
    ...
    need(value.get("verdict") == "V10R2_REMOTE_CONTROLLERS_VERIFIED_UNRUN", "controller implementation verdict drift")
    for key, path in {
...
def finish_journal(journal: pathlib.Path, verdict: str, *, terminal_audit: pathlib.Path | None = None) -> None:
    terminal = {
        "schema": "lay.v10r2-controller-terminal.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": verdict,
...
def execute() -> dict[str, Any]:
    ...
    try:
        admission = journaled(journal, sequence, "live-admission", lambda: auditor_call("live-admission"), ["V10R2_EXECUTION_ADMITTED"])
        sequence += 1
        staging = prepare_bootstrap(admission)
        journaled(journal, sequence, "remote-cache-create", create_remote_cache, ["V10R2_REMOTE_CACHE_CREATED"])
        sequence += 1
        journaled(journal, sequence, "bootstrap-upload", lambda: upload_bootstrap(staging), ["V10R2_BOOTSTRAP_UPLOADED"])
        sequence += 1
        journaled(
            journal,
            sequence,
            ...
            ["V10R2_BOOTSTRAP_CREATED_UNAUDITED"],
        )
        sequence += 1
        journaled(journal, sequence, "bootstrap-audit", lambda: auditor_call("bootstrap"), ["V10R2_BOOTSTRAP_AUDIT_PASS_MARKERS_ADMITTED"])
        sequence += 1
        journaled(
            journal,
            sequence,
            "bootstrap-audit-upload",
            lambda: upload_audit(BOOTSTRAP_AUDIT, "BOOTSTRAP_AUDIT.json", "V10R2_BOOTSTRAP_AUDIT_UPLOADED"),
            ["V10R2_BOOTSTRAP_AUDIT_UPLOADED"],
        )
        sequence += 1
        ...
        build = journaled(
            ...
            ["V10R2_BUILD_CREATED_UNAUDITED", "BLOCKED_BUILD"],
        )
        sequence += 1
        build_audit = journaled(
            ...
            ["V10R2_BUILD_AUDIT_PASS_TRACE_ADMITTED", "BLOCKED_BUILD"],
        )
        sequence += 1
        if build.get("verdict") == "BLOCKED_BUILD" or build_audit.get("verdict") == "BLOCKED_BUILD":
            ...
            return build_audit
        need(build.get("verdict") == "V10R2_BUILD_CREATED_UNAUDITED", "build producer verdict drift")
        journaled(
            journal,
            sequence,
            "build-audit-upload",
            lambda: upload_audit(BUILD_AUDIT, "BUILD_AUDIT.json", "V10R2_BUILD_AUDIT_UPLOADED"),
            ["V10R2_BUILD_AUDIT_UPLOADED"],
        )
        sequence += 1
        journaled(journal, sequence, "quiet-audit", lambda: auditor_call("quiet"), ["V10R2_QUIET_HOST_TRACE_ADMITTED"])
        sequence += 1
        journaled(
            journal,
            sequence,
            "quiet-audit-upload",
            lambda: upload_audit(QUIET_ADMISSION, "QUIET_ADMISSION.json", "V10R2_QUIET_ADMISSION_UPLOADED"),
            ["V10R2_QUIET_ADMISSION_UPLOADED"],
        )
        sequence += 1
        ...
        journaled(
            ...
            ["V10R2_TRACE_CREATED_UNAUDITED", "BLOCKED_PROVENANCE"],
        )
        sequence += 1
        terminal = journaled(
            journal,
        ...
        failure = {
            "schema": "lay.v10r2-controller-failure.v1",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
...
def status() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10r2-controller-status.v1",
        "verdict": "V10R2_CONTROLLER_STATUS",
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({
            "schema": "lay.v10r2-controller-error.v1",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
            "verdict": "BLOCKED_PROVENANCE",
            "error": f"{type(error).__name__}: {error}",
