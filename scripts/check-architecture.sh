...
assert_single_owner "fn strong_ascii_to_ru_layout_candidate" "src/typing_context/layout_signal.rs"
assert_single_owner "fn clean_ascii_to_ru_layout_candidate" "src/typing_context/layout_signal.rs"
