...
report_line_budget() {
  ...
  count="$(wc -l < "$file")"
  if (( count > max )); then
    # Lines are a navigation signal, not a structural verdict. Route/owner and
    # mutation checks below decide correctness; this report prevents size-only
    # splits that would create adapter junk drawers.
    printf 'architecture budget: %s has %s lines; reference %s\n' "$file" "$count" "$max" >&2
  fi
}
...
report_line_budget src/bin/lay_daemon.rs 245
report_line_budget src/bin/lay_daemon/action_log_runtime.rs 40
report_line_budget src/candidate_explanation.rs 280
report_line_budget src/bin/lay_daemon/config_runtime.rs 292
report_line_budget src/bin/lay_daemon/daemon_state.rs 200
report_line_budget src/bin/lay_daemon/log_runtime.rs 40
report_line_budget src/bin/lay_daemon/startup_runtime.rs 190
report_line_budget src/typing_assist.rs 80
report_line_budget src/config.rs 40
report_line_budget src/config/active.rs 70
report_line_budget src/config/defaults.rs 90
report_line_budget src/config/load.rs 25
report_line_budget src/config/pipeline.rs 100
report_line_budget src/config/types.rs 91
report_line_budget src/llm.rs 60
report_line_budget src/llm/consensus.rs 90
report_line_budget src/llm/hybrid.rs 50
report_line_budget src/llm/token_choice.rs 110
report_line_budget src/llm/tokenwise.rs 120
report_line_budget src/llm_backend.rs 160
report_line_budget src/llm_backend/direct.rs 280
report_line_budget src/llm_backend/http.rs 220
report_line_budget src/layout_autoswitch/ascii.rs 40
report_line_budget src/layout_autoswitch/ascii/candidate.rs 90
report_line_budget src/layout_autoswitch/ascii/phrase.rs 140
report_line_budget src/layout_autoswitch/ascii/symbols.rs 70
report_line_budget src/layout_autoswitch/ascii/word.rs 180
report_line_budget src/decoder.rs 60
report_line_budget src/decoder/edit_contract.rs 30
report_line_budget src/decoder/edit_plan.rs 168
report_line_budget src/decoder/manual.rs 160
report_line_budget src/decoder/types.rs 70
report_line_budget src/decoder/typing_tail.rs 120
report_line_budget src/decoder/punctuation.rs 90
report_line_budget src/typing_pipeline/candidates.rs 120
report_line_budget src/typing_rule_graph.rs 50
report_line_budget src/typing_rule_graph/builders.rs 160
report_line_budget src/typing_rule_graph/definitions.rs 180
report_line_budget src/typing_rule_graph/ids.rs 40
report_line_budget src/typing_rule_graph/registry.rs 60
report_line_budget src/typing_rule_graph/rules.rs 180
report_line_budget src/typing_rule_graph/types.rs 40
report_line_budget src/typing_rule_graph/weights.rs 50
report_line_budget src/ru_typo.rs 80
report_line_budget src/ru_typo/case_rule.rs 60
report_line_budget src/ru_typo/coverage.rs 80
report_line_budget src/ru_typo/extra.rs 80
report_line_budget src/ru_typo/guards.rs 130
report_line_budget src/ru_typo/hard_sign.rs 40
report_line_budget src/ru_typo/keyboard.rs 40
report_line_budget src/ru_typo/missing.rs 120
report_line_budget src/ru_typo/repeated.rs 110
report_line_budget src/ru_typo/substitution.rs 90
report_line_budget src/ru_typo/thresholds.rs 30
report_line_budget src/ru_typo/transposition.rs 80
report_line_budget src/ru_typo/verb.rs 80
report_line_budget src/ru_typo/vowel.rs 50
report_line_budget src/phrase_reader.rs 60
report_line_budget src/phrase_reader/contextual_tail.rs 100
report_line_budget src/phrase_reader/glued_phrase.rs 180
report_line_budget src/phrase_reader/guards.rs 180
report_line_budget src/phrase_reader/moved_prefix.rs 130
report_line_budget src/phrase_reader/split_pair.rs 96
report_line_budget src/russian_lexicon.rs 200
report_line_budget src/russian_lexicon/forms.rs 277
report_line_budget src/russian_lexicon/hunspell.rs 220
report_line_budget src/scoped_tail.rs 259
report_line_budget src/scoped_tail/completed_word.rs 185
report_line_budget src/scoped_tail/scope_policy.rs 60
report_line_budget src/scoped_tail/word_flip.rs 140
report_line_budget src/ngram.rs 30
report_line_budget src/ngram/cache.rs 60
report_line_budget src/ngram/model.rs 120
report_line_budget src/ngram/sources.rs 70
report_line_budget src/ngram/static_models.rs 60
report_line_budget src/ngram/tokenize.rs 50
report_line_budget src/keyboard.rs 80
report_line_budget src/keyboard/keymap.rs 30
report_line_budget src/keyboard/keymap/ru_char.rs 130
report_line_budget src/keyboard/keymap/typing_key.rs 70
report_line_budget src/keyboard/keymap/us_char.rs 130
report_line_budget src/keyboard/text_input.rs 30
report_line_budget src/keyboard/text_input/ru_emit.rs 100
report_line_budget src/keyboard/text_input/runs.rs 70
report_line_budget src/keyboard/text_input/script.rs 40
report_line_budget src/bin/lay_daemon/typing_assist_runtime/decoder.rs 90
report_line_budget src/bin/lay_daemon/tests/field_context.rs 120
report_line_budget src/keyboard/text_input/us_emit.rs 100
report_line_budget src/keyboard/event_words.rs 30
report_line_budget src/keyboard/event_words/decision.rs 60
report_line_budget src/keyboard/event_words/mapping.rs 70
report_line_budget src/keyboard/event_words/visual_latin.rs 70
report_line_budget src/keyboard/event_words/word_split.rs 70
report_line_budget src/word_buffer.rs 182
report_line_budget src/word_buffer/learning.rs 180
report_line_budget src/word_buffer/replay_memory.rs 280
report_line_budget src/word_buffer/replay_scope.rs 160
report_line_budget src/word_recognizer.rs 60
report_line_budget src/word_recognizer/identity.rs 160
report_line_budget src/word_recognizer/lexicon.rs 90
report_line_budget src/word_recognizer/risk.rs 60
report_line_budget src/word_recognizer/script.rs 80
report_line_budget src/word_recognizer/technical.rs 180
report_line_budget src/typing_candidate.rs 50
report_line_budget src/typing_candidate/confidence.rs 50
report_line_budget src/typing_candidate/ranking.rs 90
report_line_budget src/typing_candidate/scoring.rs 210
report_line_budget src/typing_candidate/types.rs 70
report_line_budget src/typing_pipeline.rs 40
report_line_budget src/typing_pipeline/engine.rs 140
report_line_budget src/typing_pipeline/rule_order.rs 40
report_line_budget src/typing_pipeline/types.rs 120
report_line_budget src/typing_pipeline/warmup.rs 20
report_line_budget src/typing_context.rs 50
report_line_budget src/typing_context/context_window.rs 50
report_line_budget src/typing_context/layout_signal.rs 160
report_line_budget src/typing_context/pipeline.rs 90
report_line_budget src/typing_context/tokens.rs 110
report_line_budget src/bin/lay_daemon/daemon_runtime.rs 500
report_line_budget src/bin/lay_daemon/trigger_dispatch.rs 160
report_line_budget src/bin/lay_daemon/manual_trigger_runtime.rs 60
report_line_budget src/bin/lay_daemon/manual_trigger_runtime/context.rs 120
report_line_budget src/bin/lay_daemon/manual_trigger_runtime/event.rs 280
report_line_budget src/bin/lay_daemon/manual_trigger_runtime/fire.rs 70
report_line_budget src/bin/lay_daemon/manual_trigger_runtime/timeout.rs 60
report_line_budget src/bin/lay_daemon/boundary_runtime.rs 40
report_line_budget src/bin/lay_daemon/boundary_runtime/deferred.rs 85
report_line_budget src/bin/lay_daemon/boundary_runtime/enter.rs 80
report_line_budget src/bin/lay_daemon/boundary_runtime/hard.rs 90
report_line_budget src/bin/lay_daemon/boundary_runtime/space.rs 120
report_line_budget src/bin/lay_daemon/typing_key_runtime.rs 120
report_line_budget src/bin/lay_daemon/text_output.rs 40
report_line_budget src/bin/lay_daemon/text_output/device.rs 90
report_line_budget src/bin/lay_daemon/text_output/key_emit.rs 200
report_line_budget src/bin/lay_daemon/text_output/modifiers.rs 70
report_line_budget src/bin/lay_daemon/text_output/replacement.rs 251
report_line_budget src/bin/lay_daemon/text_output/replacement/error.rs 30
report_line_budget src/bin/lay_daemon/typing_assist_runtime.rs 80
report_line_budget src/bin/lay_daemon/typing_assist_runtime/candidate.rs 67
report_line_budget src/bin/lay_daemon/typing_assist_runtime/output.rs 140
report_line_budget src/bin/lay_daemon/typing_assist_runtime/output/defer.rs 30
report_line_budget src/bin/lay_daemon/typing_assist_runtime/output/ime.rs 130
report_line_budget src/bin/lay_daemon/typing_assist_runtime/output/memory.rs 80
report_line_budget src/bin/lay_daemon/typing_assist_runtime/output/minimal.rs 130
report_line_budget src/bin/lay_daemon/typing_assist_runtime/output/nanda_trace.rs 40
report_line_budget src/bin/lay_daemon/buffer_filter_runtime.rs 90
report_line_budget src/bin/lay_daemon/manual_trigger_diagnostics.rs 50
report_line_budget src/bin/lay_daemon/command_runtime.rs 80
report_line_budget src/bin/lay_daemon/force_layout_hotkeys.rs 170
report_line_budget src/bin/lay_daemon/correction_runtime.rs 198
report_line_budget src/bin/lay_daemon/correction_runtime/memory.rs 63
report_line_budget src/bin/lay_daemon/correction_runtime/output.rs 96
report_line_budget src/bin/lay_daemon/correction_runtime/output/context.rs 70
report_line_budget src/bin/lay_daemon/correction_runtime/output/native.rs 267
report_line_budget src/bin/lay_daemon/correction_runtime/output/replay.rs 145
report_line_budget src/bin/lay_daemon/correction_runtime/output/text_replace.rs 199
report_line_budget src/bin/lay_daemon/auto_undo_runtime.rs 163
report_line_budget src/bin/lay_daemon/layout_controller.rs 283
report_line_budget src/bin/lay_daemon/layout_controller/reconcile.rs 90
report_line_budget src/bin/lay_daemon/layout_controller/verify.rs 70
report_line_budget src/bin/lay_daemon/layout_controller/gnome_dbus.rs 360
report_line_budget src/bin/lay_daemon/layout_controller/ibus_bridge.rs 100
report_line_budget src/bin/lay_daemon/layout_controller/ime_bridge.rs 140
report_line_budget src/bin/lay_daemon/layout_kde.rs 180
report_line_budget src/bin/lay_daemon/layout_x11.rs 100
report_line_budget src/bin/lay_daemon/learning_runtime.rs 88
report_line_budget src/bin/lay_daemon/learning_runtime/log_file.rs 145
report_line_budget src/bin/lay_daemon/learning_runtime/promotion.rs 190
report_line_budget src/bin/lay_daemon/tests.rs 350
report_line_budget src/bin/lay_daemon/tests/config_contract.rs 110
report_line_budget src/bin/lay_daemon/tests/enter_autocorrect.rs 70
report_line_budget src/bin/lay_daemon/tests/layout_backend.rs 140
report_line_budget src/bin/lay_daemon/tests/learning_log.rs 20
report_line_budget src/bin/lay_daemon/tests/runtime_state.rs 300
report_line_budget src/bin/lay_daemon/tests/text_output_contract.rs 160
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules.rs 30
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/exact_layout.rs 200
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/pipeline.rs 110
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/safety_regression.rs 130
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/typo_families.rs 30
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/typo_families/missing_case.rs 130
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/typo_families/phrase_spacing.rs 80
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/typo_families/repeated_extra.rs 70
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/typo_families/technical_prefix.rs 80
report_line_budget src/bin/lay_daemon/tests/typing_assist_rules/typo_families/transposition.rs 30
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen.rs 30
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen/matrix_visual.rs 150
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen/mixed_prefix.rs 150
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen/replacement_memory.rs 40
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen/short_tail.rs 90
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen/token_layout.rs 100
report_line_budget src/bin/lay_daemon/tests/scoped_tail/technical_hyphen/typing_assist.rs 50
report_line_budget src/bin/lay_daemon/tests/scoped_tail/mixed_context.rs 30
report_line_budget src/bin/lay_daemon/tests/scoped_tail/mixed_context/current_tail.rs 170
report_line_budget src/bin/lay_daemon/tests/scoped_tail/mixed_context/stale_layout.rs 70
report_line_budget src/bin/lay_daemon/tests/scoped_tail/mixed_context/trailing_space.rs 90
report_line_budget src/bin/lay_test_input.rs 120
report_line_budget src/bin/lay_test_input/desktop_probe.rs 320
report_line_budget src/bin/lay_test_input/input_device.rs 180
report_line_budget src/bin/lay_test_input/scenarios.rs 480
report_line_budget scripts/run_runtime_smoke.py 450
report_line_budget scripts/runtime_smoke/cases.py 180
report_line_budget scripts/runtime_smoke/ime.py 130
report_line_budget src/bin/lay_ibus_engine.rs 63
report_line_budget src/bin/lay_ibus_engine/args.rs 30
report_line_budget src/bin/lay_ibus_engine/bridge.rs 130
report_line_budget src/bin/lay_ibus_engine/engine.rs 250
report_line_budget src/bin/lay_ibus_engine/engine/types.rs 90
report_line_budget src/bin/lay_ibus_engine/factory.rs 90
report_line_budget src/bin/lay_ibus_engine/managed.rs 160
report_line_budget src/bin/lay_ibus_engine/protocol.rs 40
report_line_budget src/bin/lay_ibus_engine/server.rs 80
report_line_budget src/bin/lay_ibus_engine/text.rs 30
report_line_budget src/bin/lay_ibus_engine/xml.rs 60
report_line_budget extension/lay@radislabus-star.github.io/lay-impl.js 1800
report_line_budget src/typing_candidate.rs 280
report_line_budget src/text_edit.rs 61
report_line_budget src/text_edit/committed_tail.rs 221
report_line_budget src/text_edit/cursor.rs 40
report_line_budget src/text_edit/diff_plan.rs 94
report_line_budget src/text_edit/types.rs 20
