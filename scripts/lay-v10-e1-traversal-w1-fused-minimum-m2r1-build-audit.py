#!/usr/bin/env python3
"""Independent read-only audit of the single M2R1 diagnostic ELF."""
...
EXPECTED_ASSEMBLED = "b2b44ed1b42e79dcdb9b7dcfb2753eec547fa7d1e26b5fb63772a706f786ccd5"
...
def self_check() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2r1-build-audit-self-check.v3",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "M2R1_BUILD_AUDITOR_VERIFIED_UNRUN",
        **values,
        "elf_executions": 0,
        "remote_writes": 0,
...
def audit() -> dict[str, Any]:
    ...
    try:
        ...
        receipt = {
            "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2r1-build-audit.v3",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
            "verdict": verdict,
        ...
        write_json(stage / "M2R1_BUILD_AUDIT_RECEIPT.json", receipt)
        ...
        return {**receipt, "receipt_sha256": sha256_file(RESULT / "M2R1_BUILD_AUDIT_RECEIPT.json")}
