#!/usr/bin/env python3
"""Independent live-state producer for M2 execution admission V2."""
...
PROBE_PATH = pathlib.PurePosixPath("/home/e/.cache") / (
    "lay-m2-execution-admission-v2-" + TRANSACTION_ID
)

CONTRACT = ROOT / (
    "docs/structural_gates/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_V2_CONTRACT_2026-08-27.md"
)
ROUTE = ROOT / (
    "docs/structural_gates/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_V2_ROUTE_2026-08-27.md"
)
STRUCTURAL_RECEIPT = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_V2_STRUCTURAL_REVIEW_2026-08-27.json"
)
IMPLEMENTATION_PREFLIGHT = ROOT / (
    "docs/structural_gates/preflights/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_V2_IMPLEMENTATION_V1_2026-08-27.json"
)
IMPLEMENTATION_PREFLIGHT_RECEIPT = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_V2_IMPLEMENTATION_V1_PREFLIGHT_2026-08-27.json"
)
IMPLEMENTATION_RECEIPT = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_V2_IMPLEMENTATION_SELF_CHECK_V1_2026-08-27.json"
)
M2_IMPLEMENTATION_RECEIPT = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_IMPLEMENTATION_SELF_CHECK_V3_2026-08-26.json"
)
RESULT = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_LIVE_PREFLIGHT_V1_2026-08-27"
)
AUDIT_RESULT = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_ADMISSION_AUDIT_V1_2026-08-27"
)
AUDITOR = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2-admission-audit.py"
PRODUCER = pathlib.Path(__file__).resolve()

M2_CONTROLLER = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2-v3.py"
M2_REMOTE_CONTROLLER = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2-remote.py"
M2_BOOTSTRAP_AUDITOR = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2-bootstrap-audit-v3.py"
M2_BUILD_AUDITOR = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2-build-audit-v3.py"
M2_TERMINAL_AUDITOR = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2-terminal-audit-v3.py"
M2_FRAGMENT = ROOT / "scripts/lay_v10_e1_traversal_w1_fused_minimum_m2_test_module.rs.inc"
M2_JOURNAL = ROOT / (
    "docs/structural_gates/receipts/"
    "LAY_IME_TARGET_AUTHORITY_SLICE8B_V10_E1_TRAVERSAL_W1_FUSED_MINIMUM_"
    "M2_EXECUTION_JOURNAL_V1_2026-08-26"
)

PINNED = {
    CONTRACT: ("c7316ae70472451f1ccbdc2b10be6b04f30995d94530c3b2f83c751f8857b49e", 7888, "0444"),
    ROUTE: ("9f1768fc8d5d678b14a344ad447890cc82247a47a2e5c527c776a404da6a889f", 5184, "0444"),
    STRUCTURAL_RECEIPT: ("e430e62849bbe2024fa49afef8a5dd147f27312c30e526c95fb77e1777851cc3", 28213, "0444"),
    IMPLEMENTATION_PREFLIGHT: ("2b06aa2f5736bb67a517982208cc1fa3b7e04d9a5ef6f94ebb23c4421dc7725c", 15997, "0444"),
    IMPLEMENTATION_PREFLIGHT_RECEIPT: ("e674514de342fd38c49b68287b0881952865c6753dbafcd6c9f4b86e334942cf", 11091, "0444"),
    M2_CONTROLLER: ("4f2f6484d7ada483688b59a2403354548d4aaffdc594074c4447326c7b8c1f7f", 65528, "0555"),
    M2_REMOTE_CONTROLLER: ("14c7c60814927a8f3bcfc607a391d78552fdf8cdd51253eccd429d1f40c50dd6", 40111, "0555"),
    M2_BOOTSTRAP_AUDITOR: ("30da6d116df0fa5d5372dc8718c86bb3e46c4cb59edcc918429cceb523959869", 11644, "0555"),
    M2_BUILD_AUDITOR: ("091e97c8aa0e1d8a7455fefba0fb038ea04566996b149d4a10feaad0e1d5030e", 18914, "0555"),
    M2_TERMINAL_AUDITOR: ("1656e3a2fa8b772a5ef8c01daab7daf03b751c73fc2ac4bbda02a1ed6520b92b", 33296, "0555"),
    M2_FRAGMENT: ("b0a775420edf9e9d6e7f0b59f9ad840e4822cd0fdd0adc2429ea22a3e9e3a175", 155810, "0444"),
    M2_IMPLEMENTATION_RECEIPT: ("55b938ef7851bcf560c1e165e0ebe3c1c5906df6f8c9c5a76559488f0ab35f0a", 23876, "0444"),
}
...
def verify_pinned() -> dict[str, Any]:
    ...
    m2 = json.loads(M2_IMPLEMENTATION_RECEIPT.read_text())
    need(m2.get("verdict") == "M2_CONTROLLER_V3_VERIFIED_UNRUN", "M2 V3 receipt verdict drift")
    need(m2.get("task_id") == TASK_ID and m2.get("transaction_id") == TRANSACTION_ID, "M2 namespace drift")
    return rows
...
task='slice8b-v10-e1-traversal-w1-fused-minimum-m2-v1-20260826'
tx='c760eea52b6416b3529f9d684c315147b5a1140522114642c417d7db4065102c'
parent=pathlib.Path('/home/e/.local/share/lay/provenance')/task
state=pathlib.Path('/home/e/.local/state/lay')/task
cache=pathlib.Path('/home/e/.cache')/('lay-m2-'+tx)
probe=pathlib.Path('/home/e/.cache')/('lay-m2-execution-admission-v2-'+tx)
...
print(json.dumps({
 'schema':'lay.m2-execution-admission-live-snapshot.v2',
 ...
 'm2_paths':{'parent':parent.exists(),'state':state.exists(),'cache':cache.exists()},
...
p=pathlib.Path(sys.argv[1]); parent=p.parent; payload=b'm2-admission-uid-proof-v2\n'
...
def validate_snapshot(value: Mapping[str, Any], *, require_clean: bool) -> list[str]:
    need(value.get("schema") == "lay.m2-execution-admission-live-snapshot.v2", "snapshot schema drift")
    ...
    need(value.get("m2_paths") == {"parent": False, "state": False, "cache": False}, "M2 remote namespace exists")
...
def validate_uid_proof(value: Mapping[str, Any]) -> None:
    ...
    need(value.get("payload_sha256") == "6245ab0ebee6664a2af02e92d1a0259292399df4a19ead2a6a2fe6fd1f37c39a", "UID capability payload drift")


def admission_candidates() -> list[pathlib.Path]:
    root = ROOT / "docs/structural_gates/preflights"
    return sorted(root.glob("*FUSED_MINIMUM_M2_EXECUTION_ADMISSION_V?_2026-08-26.json"))
...
def verify_unrun() -> None:
    ...
    need(not M2_JOURNAL.exists(), "M2 execution journal exists")
    need(not admission_candidates(), "M2 execution admission already exists")
    for token in ("BOOTSTRAP_AUDIT_V2", "BUILD_AUDIT_V2", "TERMINAL_AUDIT_V2", "CONTROLLER_FAILURE_V1"):
        matches = list((ROOT / "docs/structural_gates/receipts").glob(f"*FUSED_MINIMUM_M2*{token}*"))
        need(not matches, f"M2 execution evidence exists: {token}")
...
def implementation_receipt() -> dict[str, Any]:
    ...
    need(value.get("verdict") == "M2_ADMISSION_CONTROLLER_VERIFIED_UNRUN", "admission implementation verdict drift")
...
def synthetic_snapshot() -> dict[str, Any]:
    ...
    return {
        ...
        **{key: value for key, value in REMOTE_EXPECTED.items() if key != "rustc_tokens"},
        ...
        "rustc_rc": 0,
        "perf_version_rc": 0,
        "m2_paths": {"parent": False, "state": False, "cache": False},
        "probe_exists": False,
        "inputs": inputs,
...
def self_check() -> dict[str, Any]:
    ...
    mutations = (
        ...
        ("probe_exists", True),
        ("m2_paths", {"parent": True, "state": False, "cache": False}),
    ...
    proof = {
        ...
        "payload_sha256": "6245ab0ebee6664a2af02e92d1a0259292399df4a19ead2a6a2fe6fd1f37c39a",
        "error": None,
    }
    ...
    with tempfile.TemporaryDirectory(prefix="m2-admission-self-check-") as raw:
    ...
    return {
        "schema": "lay.m2-execution-admission-implementation-self-check.v1",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "M2_ADMISSION_CONTROLLER_VERIFIED_UNRUN",
        "pinned": pinned,
        "source": source,
        "fault_injection": {
    ...
    receipt.update(
        {
            ...
            "next_action_admitted": "live preflight producer only; M2 execution remains forbidden",
        }
    )
...
def produce() -> dict[str, Any]:
    ...
    need(not RESULT.exists() and not AUDIT_RESULT.exists() and not M2_JOURNAL.exists(), "M2 admission or execution evidence exists")
    need(not admission_candidates(), "M2 execution admission already exists")
    ...
    try:
        ...
        receipt = {
            "schema": "lay.m2-live-execution-preflight.v2",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
            "verdict": "M2_LIVE_PREFLIGHT_PASS_UNADMITTED",
            "safe_to_execute": False,
            "producer_sha256": sha256_file(PRODUCER),
            "auditor_sha256": sha256_file(AUDITOR),
            "implementation_receipt_sha256": sha256_file(IMPLEMENTATION_RECEIPT),
            "m2_implementation_receipt_sha256": sha256_file(M2_IMPLEMENTATION_RECEIPT),
            ...
            "m2_remote_parent_state_cache": 0,
            ...
            "next_action_admitted": "independent admission audit only; M2 execution remains forbidden",
        }
        write_new(stage / "M2_LIVE_PREFLIGHT_RECEIPT.json", canonical(receipt))
        publish_tree(stage, RESULT)
        return {**receipt, "receipt": file_row(RESULT / "M2_LIVE_PREFLIGHT_RECEIPT.json")}
...
def main() -> int:
    ...
    try:
        ...
        print(f"M2 LIVE PREFLIGHT ERROR: {type(error).__name__}: {error}", file=sys.stderr)
        return 1
