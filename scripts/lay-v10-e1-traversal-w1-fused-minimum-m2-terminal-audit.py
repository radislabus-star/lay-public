#!/usr/bin/env python3
"""Independent terminal scientific audit for W1 fused-minimum M2."""
...
def self_check() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2-terminal-audit-self-check.v2",
        "task_id": TASK_ID,
...
def audit() -> dict[str, Any]:
    ...
    try:
        ...
        receipt = {
            "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2-terminal-audit.v2",
            "task_id": TASK_ID,
            "transaction_id": TRANSACTION_ID,
