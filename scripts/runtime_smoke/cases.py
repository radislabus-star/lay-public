...
CASES = {
    ...
    "ime_short_alt_all_wrong_enter": Case(
        "ime_short_alt_all_wrong_enter", SHORT_ALT_50_EXPECTED
    ),
    ...
    "ime_file_ghjdthrf_alt_enter": Case(
        "ime_file_ghjdthrf_alt_enter", "file проверка"
    ),
    ...
    "ime_raw_ghjdthrf_alt_enter": Case(
        "ime_raw_ghjdthrf_alt_enter", "проверка"
    ),
