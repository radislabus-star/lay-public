#!/usr/bin/env python3
"""Independent bootstrap audit for the M2R1 fused-minimum repair experiment."""
...
LOCAL_CONTROLLER = ROOT / "scripts/lay-v10-e1-traversal-w1-fused-minimum-m2r1-v1.py"
...
EXPECTED_FRAGMENT = "a6ea388d5d76f8223511fd4822cff2df9fd0c3394fc200f4fc52db956522ce5b"
...
def fixed_inputs() -> dict[str, Any]:
    ...
    need(implementation.get("verdict") == "M2R1_CONTROLLER_VERIFIED_UNRUN", "implementation verdict drift")
...
def self_check() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2r1-bootstrap-audit-self-check.v3",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
        "verdict": "M2R1_BOOTSTRAP_AUDITOR_VERIFIED_UNRUN",
...
def audit() -> dict[str, Any]:
    ...
    need(admission.get("verdict") == "M2R1_EXECUTION_ADMITTED", "execution admission verdict drift")
    ...
    receipt = {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2r1-bootstrap-audit.v3",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
    ...
    try:
        write_json(stage / "M2R1_BOOTSTRAP_AUDIT_RECEIPT.json", receipt)
        ...
        if stage.exists():
            shutil.rmtree(stage)
        raise
    return {**receipt, "receipt_sha256": sha256_file(RESULT / "M2R1_BOOTSTRAP_AUDIT_RECEIPT.json")}
