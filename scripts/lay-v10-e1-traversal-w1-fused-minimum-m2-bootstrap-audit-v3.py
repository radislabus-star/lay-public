#!/usr/bin/env python3
"""V3 independent bootstrap audit for the M2 fused-minimum experiment."""
...
def self_check() -> dict[str, Any]:
    ...
    return {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2-bootstrap-audit-self-check.v3",
        "task_id": TASK_ID,
...
def audit() -> dict[str, Any]:
    ...
    receipt = {
        "schema": "lay.v10.e1-traversal-w1-fused-minimum-m2-bootstrap-audit.v3",
        "task_id": TASK_ID,
        "transaction_id": TRANSACTION_ID,
