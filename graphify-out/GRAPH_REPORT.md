# Graph Report - lay  (2026-08-09)

## Corpus Check
- 908 files · ~3,981,700 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11708 nodes · 29992 edges · 496 communities (439 shown, 57 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2965 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1768a655`
...
## Communities (496 total, 57 thin omitted)
...
Cohesion: 0.08
Nodes (44): does_not_glue_long_latin_tail_to_russian_word(), hybrid_keeps_domain_and_converts_neighbor_word(), hybrid_keeps_mixed_case_ascii_brand_and_converts_neighbor_letter(), hybrid_keeps_valid_russian_phrase_without_partial_single_letter_flip(), plan_committed_tail_replacement(), plan_committed_whitespace_insertions(), Vec, offset_replacement_plan_for_cursor() (+36 more)
...
Cohesion: 0.09
Nodes (54): is_ru_short_function_word(), is_ru_short_preposition(), is_ru_short_pronoun(), is_common_be_verb_form(), is_common_short_russian_preposition(), is_common_short_russian_pronoun(), is_known_russian_phrase_part(), is_one_letter_russian_function_word() (+46 more)
...
Cohesion: 0.06
Nodes (53): decode_fixture_field(), fixture_data_lines(), fixture_lines(), fixture_lines_from_str(), fixture_path(), fixture_rows(), fixture_rows_from_str(), fixture_text() (+45 more)
...
Cohesion: 0.05
Nodes (90): LayConfig, Option, String, Vec, TypingAssistRuleConfig, boundary_shift_source_keeps_tail_pair_eligible(), boundary_shift_transition_candidate(), canonical_l2_field_keeps_nonleader_neighbor_regressions_unselected() (+82 more)
...
Cohesion: 0.08
Nodes (40): KeyCode, try_handle_enter_autocorrect(), active_auto_replace(), active_auto_switch_layout(), active_correction_safety(), active_enter_autocorrect(), active_enter_autocorrect_from_env(), active_learning_log() (+32 more)
...
Cohesion: 0.09
Nodes (45): OsString, actions_path(), CandidateBeforeApplyRecord, compact_action_log(), correction_source_name(), DirtyTaskRecord, EditPlanRecord, gate_action_name() (+37 more)
...
Cohesion: 0.06
Nodes (36): 0. Canonical Live Owner Closure, 2026-08-01, 10. Forbidden Behaviors, 11. Canonical Summary, 12. 2026-07-27 Local Readout Safety Tightening, 13.1 Release cutover 0.2.333, 13. 2026-07-27 Canonical Noun Package Full Safety Proof, 13. 2026-07-27 Full Russian Package And Live Lattice Boundary, 13. 2026-07-28 IBus L2 Cache Budget (+28 more)
...
Cohesion: 0.08
Nodes (40): AnchorSequence, apply_geometry_certificate_interference(), apply_settlement_mode(), base_settled_energy(), bounded_tail_does_not_evict_operator_evidence_already_inside_limit(), bounded_tail_keeps_the_strongest_operator_evidence(), candidate_order(), damerau_distance() (+32 more)

### Community 42 - "safe_extra_letter_candidates"
Cohesion: 0.08
Nodes (44): CachedLexicalCandidates, LexicalReadoutCache, lexical_candidate(), l2_surface_memory_status(), L2SurfaceMemoryStatus, warm_up_ime_word_candidate_memory(), warm_up_prefixes(), warm_up_surface_motif_memory() (+36 more)
...
Cohesion: 0.05
Nodes (69): first_fixture_row(), fixture_row_by_id(), assert_smart_pair(), layout_from_fixture(), typed_tail(), current_tail_case(), String, Vec (+61 more)

### Community 48 - ".commit_active_composition_with_suffix"
Cohesion: 0.05
Nodes (105): CorrectionSourceRole, CandidateExplanation, BayesCandidateScore, CandidateEvidence, CorrectionCandidateScoreTrace, CorrectionDecisionSource, explanation_for_candidate(), Into (+97 more)
...
Cohesion: 0.14
Nodes (21): BoundarySlot, encode_boundary_atom(), encode_short_token_identity_atom(), EncodedSurfaceField, encoder_owns_symbols_and_atoms_together(), lower_token_chars(), normalize_surface_token(), FnMut (+13 more)
...
Cohesion: 0.11
Nodes (52): add_phase_birth_delta(), annotate_typed_damage_support(), apply_learned_transition_pressure(), candidate(), form_attractor_has_authority(), form_attractor_word_candidates(), has_adjacent_repeated_char(), internal_extra_fragment() (+44 more)
...
Cohesion: 0.10
Nodes (36): accepted_fix_creates_negative_trace_for_corrected_away_word_only(), add_usage_event_counts(), automatic_apply_is_not_positive_feedback(), compile_usage_feedback_snapshot(), compiled_feedback_snapshot_accepts_auto_undo_correction_receipt(), compiled_feedback_snapshot_restores_exact_negative_transition(), context_ngram_prior_scores_partial_context_match(), context_rejection_does_not_leak_into_empty_context_transition() (+28 more)
...
Cohesion: 0.10
Nodes (46): committed_tail_autocorrect_decision_is_authorized(), active_composition_autocorrect_can_use_nanda_fallback(), active_composition_autocorrect_uses_unified_input_gate(), active_composition_context_replacement_keeps_previous_words_out_of_commit(), active_composition_decision_returns_only_live_text_replacement(), active_composition_gate_text(), active_composition_gate_text_preserves_committed_prefix_for_decision_only(), active_english_layout_does_not_protect_internal_layout_letter_symbol() (+38 more)
...
### Community 69 - "String"
Cohesion: 0.03
Nodes (94): ProbeJob, ProbeReceipt, canonical_scene_wave_scaled(), merge_pair_bank(), semantic_relation_weights(), BoundedFrequencySketch, ClusterUpdate, CompetitionCalibrationCase (+86 more)
...
Cohesion: 0.16
Nodes (21): Debug, typo_tolerant_completion_candidates(), atom_center_keys(), normalize_surface(), phase_coherence_milli(), read_terminal(), streaming_surface_summary_matches_materialized_atoms(), surface_phase() (+13 more)

### Community 72 - "TypingAssistRuleConfig"
Cohesion: 0.08
Nodes (18): typing_assist_auto_replace_off_keeps_layout_only_rules(), LayConfig, Vec, apply_auto_replace_policy(), normalize_typing_assist_pipeline(), Vec, rule_allowed_by_safety(), sort_typing_assist_pipeline() (+10 more)
...
Cohesion: 0.15
Nodes (19): ambiguity_geometry_link(), expanded_pair_residual_wave(), is_anchor_channel(), max_subcenter_coherence(), BTreeSet, compile_basis(), complex_coherence_milli(), expand_atom() (+11 more)
...
### Community 79 - "mod.rs"
Cohesion: 0.19
Nodes (33): HeldoutReservoir, corpus_words(), corpus_words_from_lines(), crystallize_l1_lexical_grokking(), crystallize_l1_lexical_grokking_with_rss_budget(), crystallize_l1_lexical_grokking_with_surface_policy(), export_l1_fixed_latency_surfaces(), measure_hot_readout() (+25 more)
...
Cohesion: 0.08
Nodes (31): Formatter, ArtifactBytes, decoder_reconstructs_training_form_absent_from_terminal_graph(), decoder_recovers_adjacent_transposition_as_typed_operator(), default_artifact_candidates(), default_artifact_path(), default_memory(), graph_reconstructs_surface_without_raw_word_table() (+23 more)
...
Cohesion: 0.10
Nodes (28): Deref, normalize_lexical_surface(), String, AmbiguityObservation, anchor_sequence_hash(), apply_sequence_certificate_interference(), CouplingView, ForwardActivation (+20 more)
...
Cohesion: 0.10
Nodes (34): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), causal_feedback_summary(), compact_usage_events_if_needed(), correction_feedback_receipts_from_jsonl(), CorrectionFeedbackReceipt, enqueue_usage_persist() (+26 more)
...
Cohesion: 0.08
Nodes (30): AtomicBool, Args, handle_force_layout_hotkey(), Option, VirtualDevice, WordBuffer, prepare_uinput_output(), VirtualDevice (+22 more)
...
Cohesion: 0.16
Nodes (9): benchmark_host_once(), L1OverlayMemory, L1RestorationHost, lattice_seed_score(), LatticeSeedRow, memory_seed_rows(), Option, PathBuf (+1 more)
...
Cohesion: 0.08
Nodes (51): is_common_en_technical_word(), apply_l2_weight(), candidate_support(), grammar_agreement_candidates(), Vec, hot_layout_candidate(), hot_layout_candidate_with_noisy_projection(), hot_short_layout_candidates() (+43 more)
...
Cohesion: 0.11
Nodes (38): InputGateCandidateScoreTrace, InputGateScoreboard, CorrectionResolution, decide_input_gate(), decide_space_autocorrect(), disabled_sources_keep_original_on_boundary(), double_shift_is_visible_as_manual_toggle_operator(), InputGateAction (+30 more)
...
Cohesion: 0.06
Nodes (36): EnterAutocorrectContext, Arc, Device, Instant, Mutex, Option, VirtualDevice, WordBuffer (+28 more)
...
Cohesion: 0.09
Nodes (19): candidate_index_for_target(), elapsed_us(), is_hard_precognition_boundary(), is_ime_candidate_russian_word(), is_ime_complete_russian_word(), LayIbusEngine, PreeditFastState, push_unique_ru_known_suffix() (+11 more)

### Community 154 - "layout_sync.rs"
Cohesion: 0.12
Nodes (19): Self, correction_gate_runtime_stats(), correction_gate_stats(), correction_gate_stats_json(), CorrectionDecision, CorrectionGateAtomicStats, CorrectionGateRuntimeStats, CorrectionMode (+11 more)
...
Cohesion: 0.12
Nodes (33): previous_word_segment(), apply_phrase_case(), capitalize_first(), String, apply_auto_replace(), apply_auto_replace_with_visual_b(), apply_manual_replay_auto_replace(), builtin_replacement_rules() (+25 more)
...
Cohesion: 0.17
Nodes (19): agree_adjective_like_tail(), clean_ru_token(), has_russian_verb_tail(), looks_like_plural_anchor(), looks_like_singular_anchor(), preposition_case_completion(), Option, String (+11 more)
...
Cohesion: 0.06
Nodes (42): active_nanda_wave_options(), TypingCpuOptions, emit_forwarded_key_tap(), ForwardedTyping, PhysicalInputGrab, PhysicalInputGrab<'a>, Device, Drop (+34 more)

### Community 178 - "preedit.rs"
Cohesion: 0.14
Nodes (33): apply_layout_replay(), Option, VirtualDevice, emit_backspaces(), emit_backspaces_fast(), emit_backspaces_for_text_replace(), emit_backspaces_for_text_replace_fast(), emit_key_taps() (+25 more)
...
Cohesion: 0.17
Nodes (24): token_role(), augmentation_pair_hash(), DamageExample, extend_training_damages(), hybrid_policy_preserves_layout_lane_before_refilling_easy_classes(), push(), push_training_unique(), remove_positions() (+16 more)
...
Cohesion: 0.16
Nodes (19): contextual_priority(), push_contextual_rule(), Vec, typing_assist_pipeline_for_context(), user_config_allows_rule(), completed_tail_context_keeps_left_russian_context(), completed_tail_context_keeps_sentence_sized_window_for_l3(), explicit_user_disabled_rule_stays_disabled() (+11 more)
...
Cohesion: 0.23
Nodes (15): add_legacy_usage_counts(), compact_usage_counts_for_persist(), load_usage_counts(), load_usage_counts_snapshot(), load_usage_event_counts(), load_usage_feedback_counts(), merge_usage_counts(), persist_usage_counts_snapshot() (+7 more)
...
Cohesion: 0.05
Nodes (64): correct_contextual_ascii_conjunction_i(), has_hard_ascii_separator(), immediate_right_has_russian_phrase_support(), is_ascii_b_conjunction_candidate(), is_hard_context_barrier(), is_russian_phrase_support(), I, Option (+56 more)
...
Cohesion: 0.17
Nodes (29): is_common_ru_word(), is_ru_live_protected_word(), is_user_protected_word(), fuzzy_surface_candidate_blocked(), looks_like_live_russian_it_verb(), surface_motif_known_surface(), surface_motif_runtime_known_surface(), surface_motif_stable_existing_word() (+21 more)
...
Cohesion: 0.08
Nodes (25): Bazzite / Fedora Atomic, CLI, English, Ensemble Mode, lay, License, NANDA Wave: текущий runtime, Быстрый старт (+17 more)
...
Cohesion: 0.09
Nodes (24): LayoutReplayMemory, manual_toggle_gate_trace(), remember_layout_replay_success(), Option, WordBuffer, append_learning_log(), config_path(), default_typing_assist_rules() (+16 more)
...
Cohesion: 0.17
Nodes (11): glued_part_fixes(), glued_phrase_part_candidates(), push_glued_phrase_part_candidate(), Item, Iterator, String, Vec, center_memory_recovers_typical_dirty_surfaces() (+3 more)
...
Cohesion: 0.09
Nodes (39): RecentActionRecord, record_recent_action(), Instant, Option, apply_manual_correction_output(), ManualCorrectionOutputContext, ManualOutputCommon, OutputFlow (+31 more)
...
## Knowledge Gaps
- **741 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+736 more)
...
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `ManualOutputCommon`, `transition.rs`, `main.rs`, `l2_candidate_phase.rs`, `TypingErrorClass`, `candidate_sources.rs`, `TypingAssistExplanation`, `correction_core.rs`, `layout_sync.rs`, `journal_record.rs`, `phase_proof_json`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `WaveOptions` connect `PhysicalInputGrab` to `L3Feedback`, `main.rs`, `candidate.rs`, `apply_text_replacement_pipeline`, `candidate_sources.rs`, `l3.rs`, `LayIbusEngine`, `replacement_tests.rs`, `surface.rs`, `.ru_l2_word_attractor_candidates`, `status.rs`, `phase_proof_json`, `transition.rs`, `LayImeBridge`, `tests.rs`, `apply_l2_phase_shadow`, `hunspell.rs`, `eval.rs`, `ManualCorrectionOutputContext`, `text_metrics.rs`, `l4_goal_state.rs`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `KeyEvent` connect `KeyEvent` to `Vec`, `correction_memory_runtime.rs`, `LayConfig`, `LexicalPhaseMemory`, `CharNgramModel`, `LayImeBridge`, `WaveTrace`, `gnome_dbus.rs`, `decide_scoped_tail_correction`, `.from_bytes`, `preedit.rs`, `tail_memory.rs`, `apply_short_left_word_rule`, `layout_controller.rs`, `profile_tests.rs`, `lay-kde-tray.py`, `types.rs`, `runtime_warmup_plan`, `ManifestWriteLock`?**
...
- **Should `default_typing_assist_pipeline` be split into smaller, more focused modules?**
  _Cohesion score 0.08663224325874928 - nodes in this community are weakly interconnected._