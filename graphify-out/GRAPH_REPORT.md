...
## Corpus Check
- 1039 files · ~4,544,470 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22100 nodes · 58631 edges · 835 communities (749 shown, 86 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 4080 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94bfdd68`
...
- LexicalPairReport
- 5. Frozen-H Manifest
- record_typing_memory_episode_if_enabled
...
- CanonicalFieldCacheDisposition
- apply_l2_phase_shadow
...
- test_release_live_install_controller.py
- AtomLaneAccumulatorV1
- config.rs
- .new
- OnceLock
...
- Migration Slices
- Final Completion Package Review V1
- TD-120 O6 full-frame proof plan
- assert_hyphen_case_keeps_undo
- td120-runtime-sol-task.md
- td120-tdd-sol-task.md
- CorrectionMode
- Slice 8B V8 Typed Contour Material Paper Contract, 2026-08-24
- Migration Slices
- ingest_clean_corpus_text
- static_models.rs
...
- TD-123: live autocorrection failure, 2026-09-08
- server.rs
...
1. `UnifiedCorrectionCandidate` - 162 edges
2. `default_typing_assist_pipeline()` - 150 edges
3. `StandaloneL2Field` - 131 edges
4. `WordCandidate` - 115 edges
5. `KeyEvent` - 111 edges
6. `TypingErrorClass` - 107 edges
7. `PackagedProductiveRuntimeV1` - 98 edges
8. `CandidateOrigin` - 96 edges
9. `L2 Canonical Architecture Above L1.1` - 93 edges
10. `resolve_text_correction()` - 92 edges
...
## Communities (835 total, 86 thin omitted)
...
Cohesion: 0.04
Nodes (61): ManualToggleReplay, ManualCorrectionRequest, Option, WordBuffer, ScopedManualCorrectionRequest, should_try_ime_text_backend(), ForwardedTyping, PhysicalInputGrab (+53 more)
...
Cohesion: 0.07
Nodes (40): ActiveBindingV1, BindingCandidateFrontierV1, BindingSlotFrontierV1, ColdBindingDerivationDiagnosticsV1, ColdLemmaBindingV1, ColdLemmaSourceV1, decode_anchor(), dense_execution_lane_clears_only_classes_touched_by_the_previous_source() (+32 more)
...
### Community 23 - "l3.rs"
Cohesion: 0.05
Nodes (59): ProductiveSourceCell, scene_wave(), birth_surfaces(), MorphBinding, ProductiveBirthStatus, CanonicalL1AnchorReplayContextV1<'a>, attach_productive_context_pair_evidence(), CanonicalL1LexicalAnchorV1 (+51 more)
...
Cohesion: 0.07
Nodes (68): active_layout_backend(), active_text_backend(), activate_gnome_layout_once(), activate_target_layout_once_for_exact_replay(), detect_auto_layout_backend_hint(), Option, call_focused_window_info(), call_focused_window_info_once() (+60 more)
...
Cohesion: 0.08
Nodes (47): add_relation(), bucket_position_coherence_upper(), build_atom_descriptors(), ClassMetrics, complete_forward_posting_batch_matches_scalar_access(), epoch_posting_order_cannot_change_closure_or_field(), epoch_repeated_query_does_not_revive_stale_activation(), epoch_shards_match_dense_field_and_complete_relation_decode() (+39 more)

### Community 34 - "TextReplacement"
Cohesion: 0.02
Nodes (7): measured_precognition_stages(), percentile(), precognition_candidate_generation_stays_under_budget(), LayIbusEngine, Vec, russian_single_letter_case_suffix_can_complete_unknown_prefix(), tail_buffer_stays_bounded()

### Community 35 - "verifier.rs"
Cohesion: 0.06
Nodes (49): CandidateRankOriginV1, absorb_shared_recovered_identities(), base_surface_projection_allows_new_nodes_but_rejects_old_identity_loss(), base_surface_projection_preserved_v1(), bounded_frontier_matches_eager_sort_for_every_input_permutation(), coalesce_surface_projection_v1(), cross_lane_order(), decode_prepared_section() (+41 more)

### Community 36 - "ManualTriggerEventContext"
Cohesion: 0.11
Nodes (50): AsRef, correction_prefetch_timing_line(), correction_prefetch_trace_separates_intervals_without_text(), debug_enabled_cached(), enabled(), identity(), json_string(), manual_toggle_route() (+42 more)
...
Cohesion: 0.05
Nodes (99): CorrectionSourceRole, explanation_for_candidate(), TypingErrorEvent, UnifiedCorrectionCandidate, admit_evaluated_hidden_transition(), alias_required_safety(), ambiguous_l2_surface_repair_requires_context(), assert_profile_matrix() (+91 more)

### Community 40 - "LayIbusEngine"
Cohesion: 0.08
Nodes (52): bounded_projection(), build_objectives(), candidate_evidence(), clean_terminal_ids(), configured_workers(), diagnose_l1_typed_basin_quality_class(), direct_v9_support_matches_rebuild(), elapsed_us() (+44 more)

### Community 41 - "data_lines"
Cohesion: 0.07
Nodes (69): CachedLexicalCandidates, LexicalReadoutCache, boundary_readout_cache_hit_rejects_generation_turnover(), boundary_readout_cache_is_lru_bounded_and_generation_scoped(), boundary_readout_cache_key_binds_context_token_case_and_limit(), boundary_readout_cache_reuses_positive_and_empty_material(), BoundaryReadoutCacheEntry, cached_boundary_candidates() (+61 more)

### Community 42 - "safe_extra_letter_candidates"
Cohesion: 0.10
Nodes (45): ActivationKey, activation_for_state(), activation_histogram(), activation_key(), align8(), atom_channel_from_id(), atom_channels(), AtomCover (+37 more)

### Community 43 - "RecentActionGateTrace"
Cohesion: 0.08
Nodes (65): is_ru_short_function_word(), is_ru_short_pronoun(), glued_part_fixes(), glued_phrase_part_candidates(), push_glued_phrase_part_candidate(), Item, Iterator, String (+57 more)
...
Cohesion: 0.09
Nodes (51): accepted_word_usage_count_cached(), append_usage_event(), apply_usage_event_to_cache(), cached_usage_hot_state(), cached_usage_prior_snapshot(), compact_usage_events_if_needed(), context_word_usage_prior_cached(), enqueue_usage_persist() (+43 more)
...
Cohesion: 0.07
Nodes (79): CandidateOrigin, TypingErrorClass, inserted_char_position_for_missing_letter(), Option, AdmissionLexicalFacts, candidate_admission_with_facts(), CandidateGateDecision, fixture_origin() (+71 more)
...
### Community 57 - "lay"
Cohesion: 0.05
Nodes (89): handle_force_layout_hotkey(), Option, WordBuffer, prepare_uinput_output(), settle_after_physical_trigger_release(), emit_forwarded_key_tap(), KeyCode, Result (+81 more)
...
Cohesion: 0.04
Nodes (52): candidate_source_label(), Self, CandidateAuthorityEvidence, CandidateAuthorityLaneIdentityV1, CandidateEvidence, CanonicalL2PartitionMembershipV1, common_correction_target_evidence(), correction_candidate_merges_producer_aliases_without_extra_votes() (+44 more)
...
Cohesion: 0.08
Nodes (37): authority_terminal(), edit_position_buckets(), first_loss_boundary(), FrequencyEntry, FrequencyProfile, is_single_adjacent_transposition(), is_single_non_adjacent_transposition(), is_subsequence() (+29 more)
...
Cohesion: 0.08
Nodes (48): merge_pair_bank(), update_bounded_cluster(), phase_margin_micro_for_centers(), center(), incremental_merge_keeps_old_and_new_signed_evidence(), invalid_data(), merge_bank(), merge_package_delta() (+40 more)
...
Cohesion: 0.04
Nodes (89): apply_manual_correction_output(), ManualCorrectionOutputContext, ManualOutputCommon, OutputFlow, Instant, Option, WordBuffer, execute() (+81 more)
...
Cohesion: 0.06
Nodes (37): PendingImeAutoUndo, active_path_preserve_handoff_is_shared_between_engine_objects(), advance_suppression_revision(), backspace_turns_tab_completion_into_an_edit_trajectory(), close_committed_tail_field_clears_shared_tail_and_preserve_window(), committed_space_keeps_next_word_separated_in_tail_memory(), committed_tail_range_keeps_separator_outside_token(), early_stale_postcondition_waits_for_committed_surrounding_text() (+29 more)
...
Cohesion: 0.09
Nodes (49): PurePosixPath, _absolute_path(), build_command(), Dependency, _embedded_directory_args(), _exact_hash(), _exact_keys(), execute() (+41 more)
...
Cohesion: 0.17
Nodes (38): bootstrap_harness(), bootstrap_harness_with_profile_and_budget(), complete_native_activation(), context(), controlled_p2p_bootstrap_and_compatibility_get_marker_are_real_zbus(), controlled_p2p_bounded_callback_burst_is_drained_without_loss(), controlled_p2p_callback_rendezvous_stamps_factory_before_path_binding(), controlled_p2p_native_marker_has_zero_get_and_ping_echo_returns_token() (+30 more)

### Community 89 - "String"
Cohesion: 0.10
Nodes (59): ascii_words_from_iter(), common_en_guard_prefixes(), common_en_technical_words(), common_ru_words(), common_ru_words_iter(), common_ru_words_ordered(), extend_common_ru_words(), extend_ru_technical_loanwords() (+51 more)
...
Cohesion: 0.05
Nodes (113): candidate(), boundary_birth(), boundary_enumeration(), boundary_reserve_is_two_surfaces_and_overflow_is_whole_field(), bounded_common_exact_view_preserves_raw_identity_without_proof_authority(), build_relation_partition_proof(), candidate(), canonical_anchor_contour_enumeration() (+105 more)
...
Cohesion: 0.05
Nodes (46): ActivationGeneration, ActivationGrant, AdmissionStatus, AdmissionToken, bounded_identifier(), CanonicalContextPath, ContextAdmissionReducer, ContextAdmissionReducer<P> (+38 more)
...
Cohesion: 0.10
Nodes (33): exact_contribution(), assert_same_closure(), delta_varint_bytes(), elapsed_us(), equality_at_unseen_threshold_cannot_certify(), exact_posting_replay_preserves_all_activation_fields_and_state_resets(), impact_cell_heads_descend_for_every_observed_position(), impact_cells_account_for_every_relation_once() (+25 more)
...
Cohesion: 0.08
Nodes (39): ArtifactBytes, assert_reconstruction_cache_bounds(), decoder_reconstruction_work_is_shared_across_surface_limits(), decoder_reconstructs_training_form_absent_from_terminal_graph(), decoder_recovers_adjacent_transposition_as_typed_operator(), default_artifact_candidates(), default_artifact_path(), default_memory() (+31 more)
...
Cohesion: 0.09
Nodes (51): active_english_layout_preserves_known_ascii_token_from_layout_projection(), assert_exact_us_layout_replacement(), assert_frameless_abstains(), assert_replacement(), bound_lexical_frame(), boundary_split_survives_live_l2_phase_apply(), closed_exact_layout_handles_autozamena_word(), closed_exact_layout_handles_plain_us_to_ru_word() (+43 more)
...
### Community 130 - "Vec"
Cohesion: 0.07
Nodes (54): actions_path(), CandidateBeforeApplyRecord, compact_action_log(), correction_source_name(), DirtyTaskRecord, EditPlanRecord, gate_action_name(), home_relative_path() (+46 more)
...
Cohesion: 0.03
Nodes (116): decide_physical_layout_replay(), handle_double_shift(), ordinary_double_shift_is_exact_replay_without_smart_replacement(), Option, run_manual_correction_with_scope(), map_target_events(), single_currency_tail_replays_ru_semicolon_as_us_dollar(), smart_decision_replays_single_cyrillic_acronym_as_manual_toggle() (+108 more)
...
Cohesion: 0.08
Nodes (76): Data, OrderedStream, PollResult, BarrierNonce, ConnectionGeneration, LineageGeneration, abandoned_key_requires_exact_owner_and_header_and_invalidates_sealed_transfer(), acquisition_timeout_revokes_and_cannot_be_rearmed_by_late_reply() (+68 more)

### Community 145 - "debug_log.rs"
Cohesion: 0.10
Nodes (39): predicted_state_id(), score_to_milli(), candidate_decision_signals_from_readouts(), CandidateDecisionContext, CandidateDecisionSignals, FnOnce, certified_operator_consensus(), is_precise_lexical_operator() (+31 more)
...
Cohesion: 0.14
Nodes (34): CandidateReadoutRoute, Self, active_typing_safety(), Args, candidate_summary_json(), CandidateRouteArg, compare_candidate_routes(), compare_candidate_routes_for_input() (+26 more)
...
Cohesion: 0.09
Nodes (51): capture_exact_v13_sidecar_admission(), capture_installed_recovery_fingerprints(), current_ibus_engine(), exact_v13_file_identity(), exact_v13_read_receipt(), exact_v13_receipt_bytes_are_text(), exact_v13_sidecar_sources_unchanged(), global_ibus_unchanged() (+43 more)
...
Cohesion: 0.17
Nodes (32): residual_atomic_unsubmitted_input_revokes_an_already_observed_prefix(), residual_first_word_observation_waits_for_atomic_submission_receipt(), assert_literal_commit(), atomic_callback(), AtomicDriver, AtomicDriver<'a>, bounded(), c20_source_free_boundary_rearms_only_the_next_word() (+24 more)

### Community 152 - "EnterAutocorrectContext"
Cohesion: 0.19
Nodes (11): cancel_exact_manual_toggle_handoff_state(), LayImeBridge, manual_toggle_outcome_for_authority(), LayIbusEngine, Option, Result, String, VisibleTailSource (+3 more)
...
Cohesion: 0.05
Nodes (106): enumerate_typed_contour_births_with_l11(), ProductiveEvaluationTelemetryV1, b_to_s0_mechanism(), BoundedRecoveryTotalsV1, build_groundings(), candidate_is_target(), case_targets_and_frozen_entry(), CaseResultV1 (+98 more)
...
Cohesion: 0.11
Nodes (20): deferring_committed_tail_toggle_suppresses_next_boundary_autocorrect(), LayIbusEngine, Option, Result, terminal_committed_tail_double_shift_round_trips_and_preserves_boundary(), terminal_committed_tail_double_shift_uses_one_ime_output_frame(), authorize_backend_edit(), safe_plan_without_transition_proof_cannot_create_capability() (+12 more)
...
Cohesion: 0.06
Nodes (32): 1.0.62 release completion, Acceptance Criteria, Aggregate Log Audit, Candidate and selection matrix, Compiling red baseline, Cross-class refinement after the complete six-case red test, Evidence To Produce, Executable implementation-scope gate (+24 more)
...
Cohesion: 0.06
Nodes (34): LayConfig, Vec, apply_auto_replace_policy(), normalize_typing_assist_pipeline(), Vec, rule_allowed_by_safety(), sort_typing_assist_pipeline(), typing_assist_pipeline_for_auto_replace() (+26 more)

### Community 173 - "UsageEvent"
Cohesion: 0.09
Nodes (21): acquired_atomic_route_blocks_legacy_key_mutation_for_focus(), auto_backend_enables_live_composition_for_running_ibus_engine(), client_capabilities_control_surrounding_text_authority(), engine(), handled_press_owns_its_matching_release(), ime_backend_enables_live_composition_independently_from_gray_precognition(), ime_backend_enables_live_composition_without_precognition(), LayIbusEngine (+13 more)
...
Cohesion: 0.07
Nodes (26): is_completion_learning_boundary(), LayIbusEngine, Result, EngineOutput, ascii_layout_symbol_continues_token(), candidate_index_for_target(), fast_token_boundary(), is_ascii_layout_token_char() (+18 more)

### Community 179 - "experiment.py"
Cohesion: 0.14
Nodes (33): add_legacy_usage_counts(), add_rejected_fix_sources(), add_rejected_word_state(), add_state_authority_repel(), add_transition_counts(), add_usage_event_count(), compact_usage_counts_for_persist(), context_ngram_keys() (+25 more)
...
Cohesion: 0.08
Nodes (51): TransitionAdmission, admission_truth_table_uses_verifier_latent_invariants_and_signed_l4_memory(), admit(), admit_with_l4_signal(), bound_lexical_advisory_fixture(), candidate(), closed_exact_taxonomy_is_exhaustive_and_fail_closed(), complete_context_competitors_and_clean_sources_keep_consumer_authority_closed() (+43 more)
...
Cohesion: 0.12
Nodes (41): InputGateCandidateScoreTrace, InputGateScoreboard, correction_boundary_preserves_frame_presence_and_identity(), correction_request_from_input_gate(), decide_closed_exact_input_gate_observed(), decide_input_gate(), decide_input_gate_observed(), decide_input_gate_observed_with_exact() (+33 more)
...
Cohesion: 0.07
Nodes (29): Bayes / Usage Route, Candidate Sources, Commit Route, Completion Is Not Autocorrect, Core Law, Current Cutover Law, Current Progress Matrix, Debt Queue (+21 more)
...
Cohesion: 0.28
Nodes (25): has_forbidden_y_spelling(), is_backed_adjective_form(), is_backed_clean_reference_form(), is_backed_ka_declension_form(), is_backed_possessive_iy_adjective_form(), is_backed_regular_a_ya_noun_form(), is_backed_regular_o_e_noun_form(), is_backed_russian_ch_verb_present_form() (+17 more)
...
Cohesion: 0.23
Nodes (26): actual_manual_toggle(), assert_complete_current_frame(), assert_space_applies_exact_correction(), bound_engine(), clean_us_frame(), committed_texts(), current_word_protected_us_handoff(), deleted_ranges() (+18 more)
...
Cohesion: 0.12
Nodes (28): closed_exact_candidate_is_verified(), closed_exact_readout_route_preserves_retained_target(), exact_action_operator(), exact_action_proof(), exact_candidate_authority(), exact_completeness_scope_kind(), exact_enumeration_state(), exact_error_class() (+20 more)
...
Cohesion: 0.12
Nodes (17): Bazzite / Fedora Atomic, CLI, English, lay, License, Быстрый старт, Возможности, Данные и lifetime (+9 more)

### Community 206 - "Форма Хабра"
Cohesion: 0.08
Nodes (42): has_known_cyrillic_hyphen_fragment(), is_cyrillic_hyphenated_word_for_layout(), is_known_cyrillic_hyphenated_word(), is_plain_cyrillic_technical_source(), is_plausible_cyrillic_hyphenated_word(), is_russian_hyphen_particle(), is_vowel_bearing_cyrillic_hyphen_token(), empty_word_set() (+34 more)
...
Cohesion: 0.06
Nodes (61): accumulate_binding_support(), calibrate_from_evidence(), compile_competition_edges(), compile_context_modes(), compile_l2_package(), compile_lemma_centers(), compile_neighbor_couplings(), compile_slot_centers() (+53 more)
...
Cohesion: 0.04
Nodes (59): DeferredTypingAssistContext, Arc, Device, Instant, Mutex, Option, WordBuffer, try_handle_deferred_typing_assist() (+51 more)

### Community 219 - "correct_wrong_layout_ascii_phrase"
Cohesion: 0.08
Nodes (36): add_usage_event_counts(), keep_jsonl_tail_bytes(), load_persisted_usage_counts(), snapshot_from_usage_events_for_tests(), accepted_fix_creates_negative_trace_for_corrected_away_word_only(), automatic_apply_is_not_positive_feedback(), compiled_feedback_snapshot_recovers_reverted_auto_undo_receipt(), compiled_feedback_snapshot_restores_exact_negative_transition() (+28 more)
...
Cohesion: 0.04
Nodes (83): BufferFilterContext, log_ignored_key(), KeyCode, should_skip_buffer_input(), ForceLayoutHotkeyContext, ForceLayoutHotkeys, Arc, Duration (+75 more)
...
Cohesion: 0.08
Nodes (31): apply_authority_to_candidate_lattice(), bounded_surface_candidates_with_sparse_reserve(), canonical_text_candidates(), canonical_text_readout(), CanonicalCohortReadout, demote_canonical_local_surface_cohort(), has_independent_apply_evidence(), l2_surface_unified_candidates() (+23 more)

### Community 229 - "correction_memory_runtime.rs"
Cohesion: 0.05
Nodes (72): gate_action_label(), context_or_typo_operator(), is_context_origin(), LanguageActionOperator, LanguageActionProof, operator_for_origin(), proof_for_origin(), TransitionOperator (+64 more)

### Community 230 - "action.rs"
Cohesion: 0.16
Nodes (20): bounded_systemctl(), CARGO_BUILD_JOBS, cleanup_scope(), float_greater_than(), group_alive(), handle_signal(), LAY_RESOURCE_GUARD_ACTIVE, LAY_RESOURCE_IO_PRIORITY (+12 more)

### Community 231 - "factory.rs"
Cohesion: 0.12
Nodes (11): L4PhaseWitnessReadout, l4_signed_memory_signal_from_parts(), l4_signed_memory_signal_from_readout(), cached_usage_prior_snapshot(), FnMut, Vec, UsageContextCandidate, UsageHotContext (+3 more)
...
Cohesion: 0.13
Nodes (31): append_atom_family(), atom_profile_similarity_milli(), atom_weight(), damerau_levenshtein_bounded(), damerau_levenshtein_bounded_rows(), damerau_levenshtein_rows(), hash_atom(), keyboard_typed_atoms_are_layout_invariant() (+23 more)
...
Cohesion: 0.09
Nodes (23): print_typing_explanation(), classify_typing_confidence(), Option, TypingCandidateDecision, TypingDecisionConfidence, CandidateEvaluation, evaluate_rule_candidates(), fast_en_to_ru_allowed() (+15 more)
...
Cohesion: 0.05
Nodes (68): RawFd, alt_shift_target_layout(), apply_focus_state(), listen_pointer(), Arc, AtomicU64, InputEvent, Option (+60 more)
...
Cohesion: 0.20
Nodes (21): atom_center_keys(), normalize_surface(), phase_coherence_milli(), streaming_surface_summary_matches_materialized_atoms(), surface_phase(), CachedReconstruction, completion_score(), concurrent_surface_readers_preserve_fields_during_reconstruction_eviction() (+13 more)
...
Cohesion: 0.04
Nodes (71): layout_from_fixture(), typed_tail(), expected_correction_action(), manual_decision_case(), String, Vec, single_word_wrong_layout_replay_target_is_opposite_layout(), smart_decision_converts_mixed_layout_neighbor_only() (+63 more)
...
Cohesion: 0.07
Nodes (70): TypedContourBirthV1, candidate_has_live_authority(), canonical_live_scene_bytes(), CanonicalContourProvenance, CanonicalContourRelation, CanonicalContourSeed, CanonicalFormGrounding, CanonicalSurfaceGrounding (+62 more)
...
Cohesion: 0.12
Nodes (15): Cache, package, delta, and learning identity, Candidate retention, ranking, and false authority, Concurrency and stale-result races, Consequences and invariants, Designs considered, Failure and rollback, IME/daemon compatibility and second-order effects, Independent rejection and bounded repair (+7 more)

### Community 275 - "grammar_agreement_candidates"
Cohesion: 0.12
Nodes (24): batch_context_readout_matches_individual_scores(), derive_llmwave_feedback(), l3_candidate_scoring_uses_long_phrase_context(), learning_deltas(), learning_deltas_show_live_phrase_becoming_l3_route(), llmwave_apply_feedback_is_main_l3_signal(), LlmWaveLearningDelta, LlmWaveNextTokenScore (+16 more)
...
Cohesion: 0.19
Nodes (13): global_ibus_unchanged(), is_supported_lay_engine(), reload_lay_extension(), restore_tree_atomic(), rollback_files(), self_test(), install-live-release-1.0.62.sh script, usage() (+5 more)
...
Cohesion: 0.06
Nodes (34): 1.0.34 Double-Shift Delegation Regression, 1.0.35 Physical False-Handled Finding, 1.0.35 Release And Runtime Installation, 1.0.36 Delegated Output Re-entry Finding, 1.0.37 Installed Live Verdict, 1.0.38 Deterministic Double Shift Repair, 1.0.39 Ordered Double Shift Authority, 1.0.44 IME Suggestion Shape And Window Latency (+26 more)
...
Cohesion: 0.12
Nodes (6): Harness, digest(), Fixture, function_digest(), ImeClientHarnessTest, Path
...
Cohesion: 0.17
Nodes (16): pid_t, arm_ibus_parent_death(), arm_ibus_parent_death_with(), ibus_mode_accepts_the_same_positive_parent_across_arm(), ibus_mode_propagates_prctl_failure(), ibus_mode_rejects_a_parent_change_during_arm(), ibus_mode_rejects_init_before_arm(), manual_mode_does_not_observe_or_arm_parent_lifecycle() (+8 more)
...
Cohesion: 0.10
Nodes (39): assert_no_edits(), await_barrier(), barrier_checkpoint(), bridge_snapshot(), candidate_pids(), Client, client_snapshot(), current_context_path() (+31 more)

### Community 307 - "extraction-spec.md"
Cohesion: 0.09
Nodes (35): coupling_order(), Ordering, WaveCoupling, analyze_package(), canonical_relations(), decode_posting(), encode_posting(), EncodedPosting (+27 more)
...
Cohesion: 0.08
Nodes (37): ContextToken, exact_ascii_protected_if_warm(), exact_english_word_if_warm(), empty_identity(), recognize_token(), word_kind(), word_language(), WordIdentity (+29 more)
...
Cohesion: 0.07
Nodes (21): config(), engine(), envelope(), ibus_text_value_to_string(), LayIbusEngine, parses_ibus_text_surrounding_text(), prepare_atomic_space(), LayConfig (+13 more)
...
Cohesion: 0.29
Nodes (23): canonical(), compare_inventory(), diagnostic_code(), diagnostic_location(), diagnostic_locations(), diagnostic_subjects(), load_baseline(), logical_inventory() (+15 more)
...
Cohesion: 0.12
Nodes (12): DerefMut, KeyCallback, ContextBridgeOutput, LayIbusEngine, observed_tail_append_length(), Deref, Drop, Instant (+4 more)
...
Cohesion: 0.07
Nodes (69): CandidateValidityShadowV1, complete_namespace_can_reject_only_after_all_geometry_is_accounted(), derive_candidate_validity_shadow(), derive_original_preservation_shadow(), digest128(), frame(), frame_identity_bytes(), incomplete_namespace_remains_born_and_blocks_authority() (+61 more)
...
Cohesion: 0.14
Nodes (26): band_candidate_lemmas(), band_probes_cover_every_center_inside_their_exact_hamming_radius(), banded_ranking_is_identical_to_exhaustive_ranking(), build_band_postings(), consensus_code(), find_atom_key(), hamming_masks(), lemma_wave_index_keeps_multimodal_exact_variants() (+18 more)
...
Cohesion: 0.18
Nodes (15): direct_typed_certificates(), direct_typed_oracle(), L1TypedEditTraversal<'a>, L1TypedQueryField, LayoutDirection, LexicalEditState, OperatorProgram, Box (+7 more)
...
Cohesion: 0.14
Nodes (17): DecoderEditPlan, Option, Self, String, unsealed_last_token_replacement_has_no_apply_authority(), committed_separator_is_preserved(), ensure_committed_tail_spacing(), last_token_start_byte() (+9 more)
...
Cohesion: 0.17
Nodes (20): acquire_single_instance_lock(), action_kind_label(), daemon_active(), input_mode_label(), lay_version(), load_config(), load_recent_actions(), main() (+12 more)
...
Cohesion: 0.21
Nodes (6): CARGO_BUILD_JOBS, CARGO_INCREMENTAL, check_budget(), monitor_budget(), resource_failure(), cargo-guard.sh script
...
Cohesion: 0.14
Nodes (18): committed_tail_space_autocorrect_keeps_decision_core_authority(), Option, active_layout_preserves_known_token(), ActiveCompositionAutocorrectDecision, ActiveCompositionAutocorrectRequest, ActiveCompositionAutocorrectTelemetry, ActiveCompositionEvidence, ActiveCompositionGateConfig (+10 more)
...
Cohesion: 0.08
Nodes (37): InputConfigIdentity, AtomicRouteState, ClientContextState, CommittedTailState, CompositionState, LayoutGestureState, Arc, BTreeSet (+29 more)
...
Cohesion: 0.36
Nodes (11): AutocorrectSuppression, CurrentWordSuppression, ExactManualToggleSuppression, PendingImeAutoUndoRetry, Instant, Option, String, SharedState (+3 more)
...
Cohesion: 0.14
Nodes (13): Adapter implementation and controlled proof (2026-09-06), Authority and ownership consequences, Exact dependency and registration handoff, Guarded pure-helper proof, Implementation and verification record, Measured facts and receipt, Planned staged module surface, Pre-code adapter addendum (2026-09-06) (+5 more)

### Community 437 - "print_json"
Cohesion: 0.23
Nodes (19): baseline_metrics(), best_threshold_profile(), build_personal_candidate_counts(), current_rule_baseline(), default_group_weight(), evaluate(), evaluate_personal_frequency_circuit(), evaluate_with_threshold() (+11 more)
...
### Community 472 - "prove_l1_typed_edit_phase"
Cohesion: 0.27
...
Cohesion: 0.18
Nodes (20): Protocol, td120_test_atomic_capability(), engine(), envelope(), isolated_p2p_bridge(), IsolatedBridge, prepare_atomic_space(), register_engine() (+12 more)
...
Cohesion: 0.19
Nodes (30): ForwardChild, is_boundary_punctuation(), L1TypedEditTraversal, operator_program_key(), ordered_children(), permutation_key(), phase7a_schedule_cannot_change_terminal_or_metric_bytes(), phase7a_traversal_matches_independent_dense_oracle_exhaustively() (+22 more)
...
### Community 509 - "static_models.rs"
Cohesion: 0.13
Nodes (21): AtomPostingSections, build_atom_postings(), build_lemma_wave_row(), decode_delta_postings(), delta_postings_roundtrip_strictly_ordered_lemma_ids(), L2FieldPackage, LemmaWaveBuildRow, LemmaWaveSource (+13 more)

### Community 510 - "normalize_ngram_word"
Cohesion: 0.22
...
Cohesion: 0.12
Nodes (13): BinaryHeap, CompletionFrontier, default_memory_if_warm(), LexicalPhaseMemory, ArtifactBytes, AtomicU64, AtomicUsize, Debug (+5 more)
...
### Community 517 - ".score_next_tokens_report"
Cohesion: 0.08
...
### Community 527 - "score"
Cohesion: 0.13
Nodes (15): Cache and package identity, Candidate quality, Concurrency and stale state, Consequence Analysis, Correction-safety profiles, Final latency owner after the proposal-only authority cap, Final paired-lane root cause after the comparator-key hoist, Latency, CPU, RSS, and allocation (+7 more)
...
### Community 544 - ".default"
Cohesion: 0.29
Nodes (7): Consumer candidate result and independent review, Full module and isolated window result, Missing typed suggestions restored by arrows, 2026-09-09, Normal Kitty installation after the repeated report, Original consumer proof and consequence analysis before patch, Private shared-library build preparation, User acceptance and publication, 2026-09-09

### Community 546 - "cache.rs"
Cohesion: 0.83
Nodes (3): cold_compiler_writes_a_loadable_artifact_and_matching_manifest(), PathBuf, unique_temp_dir()

### Community 549 - "gate_candidate_with_source"
Cohesion: 0.53
Nodes (5): current(), publish_runtime_config(), LayConfig, runtime_debug_action_log(), runtime_usage_learning_enabled()

### Community 550 - "debug_log.rs"
Cohesion: 0.33
...
### Community 551 - "handle_double_shift"
Cohesion: 0.38
...
### Community 579 - "Two-word model evaluation"
Cohesion: 0.33
...
### Community 599 - "record_typing_memory_episode_if_enabled"
Cohesion: 0.10
...
### Community 605 - "auto_undo.rs"
Cohesion: 0.17
Nodes (17): future_auxiliary_allows_candidate(), is_future_auxiliary(), looks_like_infinitive_like_tail(), Option, two_word_tail(), collect_segmentations(), cyrillic_word_segmentations(), cyrillic_word_splits() (+9 more)
...
Cohesion: 0.08
Nodes (38): correct_common_layout_extra_letter(), correct_layout_missing_initial_letter(), correct_layout_vowel_confusion(), is_known_russian_layout_autoswitch_word(), is_russian_layout_surface_authority_word(), is_strong_layout_polish_word(), layout_phase_surface_authority(), layout_polish_replacement_allowed() (+30 more)

### Community 618 - "convert_hybrid"
Cohesion: 0.52
...
### Community 621 - "ContextBridgeOutput"
Cohesion: 0.21
Nodes (14): next_peer_message(), bridge(), bridge_fence(), bridge_toggle_terminal(), consume_detached_callback_reply(), manual_toggle_bridge_round_trips(), repeated_terminal_metadata(), residual_first_numeric_word_bridge_refuses_without_delegation_or_output() (+6 more)

### Community 622 - ".traverse"
Cohesion: 0.33
...
Cohesion: 0.67
Nodes (3): Coverage correction — additional receiver keyboard endpoint, Cross-app spontaneous input — 2026-09-09, User-confirmed episode and sender attribution — 2026-09-09 01:46 UTC

### Community 628 - "architecture_contract.rs"
Cohesion: 0.67
Nodes (3): Daemon Decision Owners, Decision Owners Today, IME Decision Owners

### Community 629 - "run_command_capture"
Cohesion: 0.20
...
### Community 640 - "decode_typing_assist_tail"
Cohesion: 0.15
Nodes (23): decode_enter_autocorrect_tail(), decode_typing_assist_current_tail(), DecoderEditPlan, Option, CorrectionSource, CorrectionTrigger, changed_committed_tail_plan(), changed_committed_tail_plan_from_gate() (+15 more)
...
### Community 643 - "posting_codec.rs"
Cohesion: 0.28
...
### Community 648 - "cached_usage_hot_state"
Cohesion: 0.36
Nodes (8): en_model(), en_score(), ru_candidate_is_better(), ru_candidate_margin(), ru_model(), ru_score(), warm_up(), warm_up_ru()

### Community 649 - "typing_context_tests.rs"
Cohesion: 0.07
Nodes (59): is_common_en_technical_word(), apply_l2_weight(), candidate_support(), correction_l2_peak_candidates(), hot_layout_candidate(), hot_layout_candidate_with_noisy_projection(), ime_l2_boundary_candidates(), ime_l2_boundary_candidates_uncached() (+51 more)
...
### Community 651 - "TypingTransition"
Cohesion: 0.35
...
### Community 655 - "TD-123: Wave 1.0.67 — повысить качество восстановления в целом"
Cohesion: 0.17
...
### Community 656 - "ImeManualToggleOutcome"
Cohesion: 0.25
Nodes (7): Accepted development simplification — 2026-09-07, Architecture evidence discipline, Cargo disk budget, Consequence analysis before code changes, graphify, Protected Double Shift route, Systemic wave-contour fixes

### Community 657 - "CharNgramModel"
Cohesion: 0.05
Nodes (30): Accepted settings inventory, Accepted tray inventory, Gates, Lay menu and settings architecture, Ownership, Removed surfaces, Verdict scope, Dead-Code Ledger (+22 more)

### Community 660 - "TD-124 execution evidence"
Cohesion: 0.22
...
### Community 661 - "typing_assist_short_alternating.rs"
Cohesion: 0.25
Nodes (6): OsString, EnvGuard, Drop, Option, Path, Self

### Community 662 - ".from_parts"
Cohesion: 0.19
...
### Community 664 - ".new"
Cohesion: 0.18
Nodes (10): Alternatives considered, Chosen route and exact semantic delta, Consequence analysis recorded before script editing, Facts, Hypotheses, estimates, and unverified assumptions, Invariants and second-order consequences, Lay 1.0.66 live-install controller preparation, Parent remote execution — 2026-09-06 (+2 more)

### Community 665 - "mix64_golden"
Cohesion: 0.32
Nodes (4): Option, WordBuffer, slow_no_correction(), slow_started_no_correction()

### Community 666 - "record_typing_memory_episode_if_enabled"
Cohesion: 0.25
Nodes (8): C01–C30 closure worklist, Compiled candidate checkpoint, 2026-09-07 local time, Current actual/source mapping, 2026-09-07, Denominators and source identity, Final acceptance packet, H01–H16 expansion worklist, Recovery checkpoint, 2026-09-06 21:19 UTC, TD-121 promotion coverage ledger

### Community 667 - "add_group"
Cohesion: 0.29
Nodes (7): Consequence analysis and repair boundary, Exact release candidate and delivery, First broken mechanism, Lay 1.0.66: live context observer failure, 2026-09-07, Measured incident, Options and decision, Verification and authority
...
### Community 671 - "load_plain_words"
Cohesion: 0.23
Nodes (15): bounded(), establish_known_source(), factory_message(), focus_out_id_message(), forward_exact_marker(), pending_transfer_focus_in_then_focus_in_id_enriches_one_prearm_request(), pending_transfer_late_native_case(), Arc (+7 more)

### Community 672 - "OnceLock"
Cohesion: 0.23
...
### Community 678 - "load_plain_words"
Cohesion: 0.28
Nodes (8): PendingSystemOutcomeFeedback, VisibleTailSource, Instant, Option, String, Vec, take_accepted_completion_feedback(), visible_completion_suffix()

### Community 679 - "runtime_warmup_plan"
Cohesion: 0.29
...
### Community 680 - "select_repeated_letter_candidate"
Cohesion: 0.23
...
### Community 702 - "choose_token_consensus_with_chooser"
Cohesion: 0.42
...
### Community 705 - "executor_contract.rs"
Cohesion: 0.60
...
### Community 707 - "choose_best_with_gap"
Cohesion: 0.07
Nodes (43): extra_letter_rule_defers_to_missing_letter_candidates(), typing_assist_fixes_extra_repeated_letter(), candidate_beats(), choose_best_with_gap(), rank_best_two(), RankedPair, B, F (+35 more)
...
### Community 709 - "admit_l3_context_delta_with_full_proof"
Cohesion: 0.24
...
### Community 712 - "Очистка новой рабочей ветки — 2026-09-08"
Cohesion: 0.22
...
### Community 713 - "TD-123 preflight: observe the existing correction worker queue"
Cohesion: 0.10
Nodes (20): Bounded current-context recurrence: implementation preflight, Bounded recurrence native verdict, Complete loaded L1.1 terminal coverage: measured result, Current fixed89 consumer audit and full acceptance preflight, Exact capacity native verdict and next missing mechanism, Measured diagnostic result and capacity-scope repair preflight, Remaining quality: terminal coverage diagnostic preflight, Sep 8 TD123: bounded authority transfer native result (+12 more)

### Community 714 - "Option"
Cohesion: 0.20
...
### Community 715 - "auto_undo.rs"
Cohesion: 0.15
Nodes (3): Option, typing_correction_should_skip_auto_undo(), unsafe_word_count_shrink()

### Community 716 - "static_models.rs"
Cohesion: 0.16
Nodes (8): configured_atomic_double_shift_key(), physical_double_shift_owner_legacy_route_is_observation_only(), Result, SignalEmitter, is_accept_completion_with_space_key(), is_key_press(), is_shift_key(), has_command_modifier()

### Community 717 - "normalize_ngram_word"
Cohesion: 0.33
...
### Community 723 - ".process_atomic_key_event_with_context_tail"
Cohesion: 0.31
...
### Community 724 - ".from_words"
Cohesion: 0.19
Nodes (14): active_composition_gate_text(), active_composition_gate_text_preserves_committed_prefix_for_decision_only(), assert_exact_ru_layout_replacement(), closed_exact_layout_handles_ru_to_en_word_and_case(), closed_reverse_layout_covers_the_existing_ru_to_en_corpus(), closed_reverse_layout_keeps_known_russian_collision(), decide_active_composition_autocorrect_observed_with_exact(), exact_layout_scope_preserves_full_route_authority_and_proof() (+6 more)
...
Cohesion: 0.14
Nodes (14): Consequence analysis, TD-121: Сохранять целое слово при смене экземпляра IME, Варианты решения и рейтинг, Выбранный маршрут и текущая транспортная проверка, Канонический источник identity и ограничение hot upgrade, Матрица TDD и доказательств, Обязательные gate до production-кода, Отложено во второй этап (+6 more)

### Community 727 - ".run"
Cohesion: 0.24
Nodes (4): force_target_layout_for_replacement(), script_signal(), ScriptSignal, target_layout_for_replacement()

### Community 728 - "gate_candidate"
Cohesion: 0.25
...
### Community 730 - "fuzzy_known_word_candidates"
Cohesion: 0.25
...
### Community 731 - "TD-120 bounded repair pass 2 — consequence addendum"
Cohesion: 0.25
...
### Community 734 - "Text Mutation Monopoly Plan"
Cohesion: 0.33
...
### Community 736 - "21. Exact User Rollback Feedback And Standard Publication, 2026-08-10"
Cohesion: 0.15
Nodes (13): TD-123: Wave 1.0.67 — повысить качество восстановления в целом, Границы реализации и приёмка, Дополнение 1.0.70 по public issues 42–44, Исторический порядок работы, Исторический результат 1.0.67, 2026-09-09, История поручения 2026-09-08, Как доказать «стала лучше», Первый шаг после1.0.66 (+5 more)
...
### Community 738 - "SampledProofEventV1"
Cohesion: 0.33
...
### Community 741 - "l2_transition_phase_shadow_readout"
Cohesion: 0.60
...
Cohesion: 0.20
Nodes (10): Выбор границы, Итоговый review и correctness/package proof, Независимый preflight review, Очистка новой рабочей ветки — 2026-09-08, Поручение и исходная точка, Последствия до изменений, Применённое удаление, Приёмка очистки (+2 more)

### Community 746 - "choose_token_consensus_with_chooser"
Cohesion: 0.11
Nodes (22): Kernel, BuilderState, compile_sidecar(), edge_slice(), encode_sidecar(), enumerate_lane_with_kernel(), MinimalDafsaBuilder, PackedDafsa (+14 more)
...
### Community 748 - "ExactPostingResult"
Cohesion: 0.33
Nodes (6): DecoderSubtreeQueryMetrics, DecoderSubtreeQueryProjection, retained_equality_materialization_is_part_of_the_projection_gate(), Value, summarize_queries(), ExactPostingResult
...
### Community 750 - "Compact standalone L2 runtime indexes, 2026-08-03"
Cohesion: 0.40
...
### Community 754 - "Process-local manifest refresh, 2026-08-10"
Cohesion: 0.40
Nodes (5): Measured facts, Process-local manifest refresh, 2026-08-10, Verdict scope, What was not tested, What was tested

### Community 755 - "WeChat report and first-word admission, 2026-09-09"
Cohesion: 0.12
Nodes (17): Automatic layout correction after deleting a boundary, 2026-09-09, Consequence analysis before retained-boundary implementation, Exact installed-byte native diagnostic, Final 1.0.69 build accepted, private client gates pending, Final private-client acceptance and installation, 1.0.69, First candidate measurements and retained failure, First-word display repair preflight, 2026-09-09 13:33 UTC, GitHub issues 42–44 supplement to 1.0.70, 2026-09-10 (+9 more)

### Community 756 - "Supervised sentence online delta closure, 2026-08-10"
Cohesion: 0.40
...
### Community 757 - "Proof pipeline revision and first live admission, 2026-08-10"
Cohesion: 0.40
...
### Community 758 - "21. Exact User Rollback Feedback And Standard Publication, 2026-08-10"
Cohesion: 0.40
...
### Community 759 - "search_scratch_bytes"
Cohesion: 0.50
Nodes (5): Row, RowTraversalKernel, PhantomData, search_scratch_bytes(), SearchNode

### Community 760 - "TD-121 — deployed IBus private transport baseline"
Cohesion: 0.33
...
### Community 765 - "apply_l2_phase_shadow"
Cohesion: 0.50
...
### Community 766 - "19. TREE / SCOREBOARD / DEBT QUEUE"
Cohesion: 0.50
Nodes (4): 19. TREE / SCOREBOARD / DEBT QUEUE, DEBT QUEUE, SCOREBOARD, TREE

### Community 767 - ".run_wrapper"
Cohesion: 0.48
Nodes (3): ArchitectureRefreshWrapperTest, Path, write_executable()

### Community 768 - "Causal live-feedback reducer and mandatory full gate, 2026-07-31"
Cohesion: 0.67
...
### Community 769 - "Proof And Publication"
Cohesion: 0.67
Nodes (3): Fixed Coverage Denominator, Pairwise Full-Winner Certificate, Proof And Publication

### Community 770 - "load_personal_correction_events"
Cohesion: 0.67
Nodes (3): load_personal_correction_events(), Path, read_rows()

### Community 772 - "TD-118 Process-Cold Package Identity Reuse, 2026-09-05"
Cohesion: 0.40
Nodes (5): Measured Facts, TD-118 Process-Cold Package Identity Reuse, 2026-09-05, Verdict Scope, What Was Not Tested, What Was Tested
...
### Community 817 - "TD-120 scoped runtime implementation evidence"
Cohesion: 0.20
Nodes (8): Expanded intermediate v3, Intermediate v4 and full-bin regression, Parent intermediate remote checks — not final review, Frozen focused test manifest before production edits, Implemented mechanisms, Known residuals, TD-120 scoped runtime implementation evidence, Verification status

### Community 821 - "dict_tests.rs"
Cohesion: 0.38
...
### Community 822 - "gate_candidate_with_source"
Cohesion: 0.12
Nodes (53): bootstrap_harness_with_budget(), actual_disable(), actual_focus_out(), actual_pending_early_key(), actual_pending_word_reset(), empty_factory_stale_focus_case(), factory_message(), global_engine_changed() (+45 more)
...
### Community 856 - "Minimal Design Contract"
Cohesion: 0.64
Nodes (7): main(), prune(), prune_report(), Path, read_json(), self_test(), write_json()

### Community 869 - "test_release_live_install_controller.py"
Cohesion: 0.09
Nodes (21): command_output(), controller_delta(), create_exact_v13_fixture(), create_isolated_live_snapshot(), file_sha256(), forward_rollback_function(), forward_transaction_dispatch(), installed_exact_v13_verifier() (+13 more)

### Community 870 - "AtomLaneAccumulatorV1"
Cohesion: 0.07
Nodes (43): BandedLevenshteinRow, BuilderEdge, compile_exact_sidecar_file(), dla_builder_scratch_bytes(), DlaBuildFailure, DlaTraversalKernel, elapsed_us(), enumerate_dla_lane() (+35 more)

### Community 874 - "config.rs"
Cohesion: 0.13
Nodes (32): active_completion(), atomic_envelope(), bridge_output_scope_clears_its_witness_on_success_and_cancellation(), committed_texts(), config(), first_word_refuses_unobserved_sensitive_missing_snapshot_and_replacement_paths(), first_word_repeated_surrounding_ack_keeps_visible_tab_completion(), first_word_snapshot_contradictions_refuse_display_and_tab_without_text_effects() (+24 more)
...
### Community 879 - "OnceLock"
Cohesion: 0.25
Nodes (7): 1. High — A bridge fence still certifies an owner with earlier unresolved ingress, 2. High — Native re-focus is mistaken for delayed native enrichment, 3. High — A revoked ready transfer can reinstall KnownStart from the old grant, 4. High — Enter erases the evidence needed to revoke completeness on Backspace, Confirmed improvements and evidence limits, Findings, TD-121 independent final code review — pass 2

### Community 880 - "Lay 1.0.66 controller adaptation: independent bounded review"
Cohesion: 0.33
Nodes (5): Exact scope and artifact binding, Findings and reasoning, Independently inspected remote proof, Lay 1.0.66 controller adaptation: independent bounded review, Limits and authority

### Community 882 - "Lay 1.0.66 — resumed execution, 2026-09-06"
Cohesion: 0.12
Nodes (17): Accepted sequence and current owners, Connection-recovery checkpoint, Current accepted development route — 2026-09-07, Current action — user-directed installation, 2026-09-07, Earlier evidence checkpoints (superseded where stated below), Execution-boundary deviation: premature local graph checks, Final release sequencing constraints, Historical checkpoint — final-pass repair, 2026-09-07 (+9 more)

### Community 883 - "Migration Slices"
Cohesion: 0.22
...
### Community 884 - "Final Completion Package Review V1"
Cohesion: 0.11
...
### Community 885 - "TD-120 O6 full-frame proof plan"
Cohesion: 0.40
Nodes (4): Deliberate non-claims, Exact test manifest, Route and prerequisites, TD-120 O6 full-frame proof plan

### Community 886 - "assert_hyphen_case_keeps_undo"
Cohesion: 0.31
Nodes (17): assert_remote(), changed_paths(), digest(), file_list(), git(), load_config(), main(), plan() (+9 more)

### Community 899 - "CorrectionMode"
Cohesion: 0.43
...
### Community 906 - "Slice 8B V8 Typed Contour Material Paper Contract, 2026-08-24"
Cohesion: 0.29
...
### Community 917 - "static_models.rs"
Cohesion: 0.05
Nodes (32): История и восстановление проекта, Kitty: подсказки при наборе приняты пользователем, Lay 1.0.68 принят пользователем, Lay 1.0.69: подсказки приняты, публикация разрешена, Lay 1.0.70: GitHub fixes и установленный runtime, WeChat: пользователь подтвердил работу и разрешил публикацию, Завершённая проверка установки до сообщения о старом сбое, История до исправления подсказок 1.0.68 (+24 more)

### Community 919 - "Slice 8B V9 Measured A/B/C Result, 2026-08-24"
Cohesion: 0.40
...
Cohesion: 0.04
Nodes (56): NonZeroU32, set_original_status_for_test(), AuthorityCertificateCoreV1, AuthorityCertificateV1, BoundedTargetSetV1, CanonicalL1AnchorKindV1, CanonicalL1AnchorProofV1, CohortAbstainReasonV1 (+48 more)

### Community 938 - "TD-121 — final engine wiring handoff"
Cohesion: 0.29
...
### Community 940 - "add_group"
Cohesion: 0.05
Nodes (34): Bounded mechanism and consequence analysis — 2026-09-07, Immediate work, in order, Regression matrix and pitfalls, Required behavior, Scope and stop conditions, TD-125 — Preserve the preceding word and separator during autocorrection, Admitted source and artifacts, Executed transaction (+26 more)

### Community 942 - "types.rs"
Cohesion: 0.50
Nodes (3): OnlineContextPhaseLearner, String, Vec

### Community 947 - "1.0.66 final client route — explicit bounded continuation"
Cohesion: 0.12
...
### Community 949 - "Short maintenance loop"
Cohesion: 0.10
Nodes (18): Acceptance and evidence, Completion, Consequences and boundaries before code, Options, Ordered deliverables, Root cause and current baseline, Specification review, TD-124 — Воспроизводимый короткий цикл сопровождения (+10 more)

### Community 953 - "TD-121: repeated Double Shift loses the committed tail, 2026-09-08"
Cohesion: 0.12
...
### Community 954 - "TD-123: live autocorrection failure, 2026-09-08"
Cohesion: 0.08
...
### Community 957 - "Lay 1.0.66 remote sidecar: independent review, pass 1"
Cohesion: 0.29
...
### Community 961 - "l2_transition_phase_shadow_readout"
Cohesion: 0.67
...
### Community 962 - "TD-121 layout intent repair — bounded consequence (2026-09-06)"
Cohesion: 0.50
Nodes (3): Confirmed repair route and bounds (2026-09-06), Reopened parent-design finding (2026-09-06, subsequently confirmed below), TD-121 layout intent repair — bounded consequence (2026-09-06)

### Community 1037 - "compiler.rs"
Cohesion: 0.05
Nodes (31): compile_context_phase(), compiler_learns_context_centers_and_destructive_competitors(), ContextPhaseCompileInput, package_roundtrip_keeps_compact_centers_without_words(), read_package(), pair_view_hash(), balanced_exact_profiles_leave_a_one_token_scene_unresolved(), compiled_hot_context_readout_stays_inside_microsecond_budget() (+23 more)
...
Cohesion: 0.07
Nodes (77): MorphologySlotEvidence, admitted_ascii_projection(), admitted_contextual_short_layout_surface(), admitted_mixed_layout_surface(), admitted_physical_layout_surface(), append_exact_morphology_evidence(), append_productive_surface_candidates(), apply_standalone_l2_field() (+69 more)
...
Cohesion: 0.07
Nodes (42): LayoutIntentToken, activate_gnome_layout_for_ime(), current_active_ime_layout_is_ru(), dispatch_direct_layout_switch(), dispatch_layout_switch(), ime_engine_for_layout(), LayIbusEngine, layout_request_is_current() (+34 more)
...
## Knowledge Gaps
- **2500 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `app` (+2495 more)
...
- **Why does `StandaloneL2Field` connect `l3.rs` to `text_edit_tests.rs`, `LLMWave Production Contour`, `LlmWaveMemory`, `fixture_row_by_id`, `typing_assist_deferred.rs`, `LayIbusEngine`, `.commit_active_composition_with_suffix`, `tproger-pitch-ru.md`, `eval.rs`, `completed_word.rs`, `LlmWaveMemory`, `lay-kde-tray.py`, `format.rs`, `transition_relation.rs`, `ForceLayoutHotkeyContext`, `handle_double_shift`, `AtomLaneAccumulatorV1`, `CandidateOrigin`, `LayIbusEngine`, `apply_standalone_l2_field`, `ManualCorrectionOutputContext`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `KeyEvent` connect `IME / Daemon Route Map` to `decode_typing_assist_tail`, `Vec`, `lay_nanda_wave_eval.rs`, `posting_codec.rs`, `.score_next_tokens_report`, `install-l2-lexical-phase.sh`, `TD-007: Reconcile Superseded Semantic Contract Tests`, `LlmWaveMemory`, `time.rs`, `Row`, `lay`, `WaveOptions`, `replay_layout_decision`, `record_typing_memory_episode_if_enabled`, `canonical_l1_l2.rs`, `.default`, `run_command_capture`, `preedit_readout.rs`, `config_contract.rs`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `PackageBytes` connect `Result` to `agree_adjective_like_tail`, `AtomLaneAccumulatorV1`, `gate_candidate_with_source`, `choose_token_consensus_with_chooser`, `gnome_dbus.rs`, `Namespace`, `apply_standalone_l2_field`, `typing_candidate_tests.rs`, `static_models.rs`, `llm_tests.rs`?**
...
- **Should `learning_loop.rs` be split into smaller, more focused modules?**
  _Cohesion score 0.08473748473748474 - nodes in this community are weakly interconnected._
