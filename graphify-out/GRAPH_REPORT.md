...
## Corpus Check
- 889 files · ~3,967,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11570 nodes · 29692 edges · 487 communities (430 shown, 57 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2937 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f23906f5`
...
Cohesion: 0.08
Nodes (41): Eq, merge_pair_bank(), strongest_center(), strongest_center_with_min_support(), OnlineContextPhaseLearner, String, Vec, max_random_center_coherence() (+33 more)

### Community 17 - "word_reader.rs"
Cohesion: 0.09
Nodes (59): is_common_ru_word(), is_ru_short_function_word(), is_ru_short_pronoun(), is_common_be_verb_form(), is_common_short_russian_preposition(), is_common_short_russian_pronoun(), is_known_russian_phrase_part(), is_one_letter_russian_function_word() (+51 more)
...
Cohesion: 0.08
Nodes (31): text_field_context_keeps_unfinished_words_separate_inside_same_window(), text_field_context_prunes_old_saved_slots(), text_field_context_separates_fields_without_window_identity(), window_input_state_keeps_separate_word_buffers(), push_text_as_layout(), text_replacement_from_fixture(), typed_buffer_from_semicolon_fixture(), edit_navigation_boundaries_reset_word_buffer_before_next_autocorrect() (+23 more)
...
Cohesion: 0.11
Nodes (32): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), causal_feedback_summary(), correction_feedback_events_from_jsonl(), correction_feedback_receipts_from_jsonl(), CorrectionFeedbackReceipt, increment_optional_count() (+24 more)
...
Cohesion: 0.05
Nodes (72): B, extra_letter_rule_defers_to_missing_letter_candidates(), candidate_beats(), choose_best_with_gap(), rank_best_two(), RankedPair, F, I (+64 more)
...
Cohesion: 0.05
Nodes (98): CorrectionSourceRole, CandidateExplanation, explanation_for_candidate(), Self, Vec, TypingErrorEvent, UnifiedCorrectionCandidate, predicted_state_id() (+90 more)
...
Cohesion: 0.13
Nodes (19): should_try_ime_text_backend(), ImeTypingReplacementContext, DecoderEditPlan, Option, VirtualDevice, WordBuffer, daemon_may_dispatch_ime_replace(), ImeTypingApplyReceipt (+11 more)
...
Cohesion: 0.15
Nodes (27): is_cyrillic_letter(), is_plain_cyrillic_layout_token(), is_long_upper_ascii_word(), is_single_ascii_letter(), is_single_cyrillic_letter(), obvious_quality_choice(), obvious_token_choice(), Option (+19 more)
...
Cohesion: 0.07
Nodes (60): active_learning_log(), append_learning_log(), append_user_correction_learning_log(), append_learning_entry_to_path(), append_learning_log_to_path(), append_user_correction_learning_log_to_path(), compact_learning_log_if_needed(), keep_jsonl_tail_bytes() (+52 more)
...
Cohesion: 0.07
Nodes (43): AmbiguityObservation, AnchorSequence, apply_geometry_certificate_interference(), apply_position_certificate_interference(), apply_settlement_mode(), apply_structural_interference(), base_settled_energy(), bounded_tail_does_not_evict_operator_evidence_already_inside_limit() (+35 more)
...
Cohesion: 0.21
Nodes (16): benchmark_diverse_restoration(), benchmark_package(), candidate_fingerprint(), candidate_json(), compile_surface_indices(), inspect_package_header(), query_package(), restoration_candidate_json() (+8 more)
...
Cohesion: 0.09
Nodes (52): broad_user_rewrite_is_review_not_positive_training(), candidate_source_label(), classify_operation(), collect_corrections_text(), collects_user_accepted_and_rejected_pairs(), contains_unsafe_training_text(), corrections_log_layout_replay_reaches_the_same_transition_memory(), full_user_target() (+44 more)
...
Cohesion: 0.13
Nodes (34): apply_layout_replay(), Option, target_layout_for_replacement(), emit_backspaces(), emit_backspaces_fast(), emit_backspaces_for_text_replace(), emit_backspaces_for_text_replace_fast(), emit_key_taps() (+26 more)
...
Cohesion: 0.15
Nodes (20): CleanCorpusIngestReport, decode_memory(), decode_record(), decode_vocabulary(), default_memory_path(), default_phrase_experience_path(), encode_memory(), encode_record() (+12 more)
...
Cohesion: 0.10
Nodes (28): classify_local(), coherence_milli(), compact_runtime_indexes_preserve_terminal_form_and_lemma_bindings(), contextual_multi_lemma_birth_can_select_a_weaker_seeded_lemma(), cross_lemma_authority_safety_verdict(), inverse_length_lane_finds_package_forms_without_scanning_the_field(), L2LexicalSeed, L2LocalCandidate (+20 more)
...
Cohesion: 0.12
Nodes (29): ComplexBasisWave, Default, apply_pairwise_field(), apply_restoration_dominance_certificate(), contains_cycle(), direction_coherence(), EdgeOutcome, evaluate_edge() (+21 more)
...
Cohesion: 0.15
Nodes (21): add_phase_replay(), canonical_replay_resolution(), collect_phase_examples(), collect_replay_examples(), decision_label(), DirtyLogPair, phase_evidence_role(), PhaseEvidenceRole (+13 more)
...
Cohesion: 0.12
Nodes (19): first_fixture_row(), manual_decoder_keeps_completed_russian_preposition_before_completed_ascii_tail(), replacement_memory_can_update_completed_words_without_dropping_current_word(), replacement_memory_keeps_space_boundary_after_i_autofix(), replacement_memory_preserves_current_after_deferred_completed_tail(), replacement_memory_sequence(), replacement_memory_stays_synced_after_html_autofix_and_next_word(), replacement_memory_synthesizes_last_word_after_glued_phrase_split() (+11 more)
...
Cohesion: 0.07
Nodes (89): AntiRelation, PhaseMass, accumulate_forward_scores(), AmbiguityCalibrationSamples, anchor_sequence(), anti_relation_order(), atom_couplings(), average_position() (+81 more)
...
Cohesion: 0.16
Nodes (28): accepted_usage_events(), arg_value(), bounded_tail_lines(), candidate_short(), changed_word_indexes(), collect(), correction_layout_evidence_binds_to_layout_operator(), evidence_operator_metadata() (+20 more)

### Community 225 - "recognize_token"
Cohesion: 0.10
Nodes (22): config_path(), LayConfig, Self, PathBuf, CandidateEvidence, correction_gate_runtime_stats(), correction_gate_stats(), correction_gate_stats_json() (+14 more)
...
Cohesion: 0.30
Nodes (10): AntiSearchStats, block_end_terminal(), build_wand_cursors(), exact_terminal_score(), Option, skip_terminal_block(), wand_collect_top(), wand_top_competitors() (+2 more)
...
Cohesion: 0.23
Nodes (16): candidate_prefix_and_next(), combined_phrase_score(), encode_vocabulary(), LlmWaveCandidateScore, LlmWavePhrasePrediction, LlmWavePreviousTokenCandidate, LlmWaveReport, near_previous_token_surface() (+8 more)
...
Cohesion: 0.10
Nodes (26): Deref, anchor_sequence_hash(), apply_sequence_certificate_interference(), CouplingView, ForwardActivation, ForwardScratch, geometry_reserve_keeps_the_nearest_basin_and_ambiguity_shell(), is_keyboard_channel() (+18 more)
...
Cohesion: 0.14
Nodes (11): normalize_lexical_surface(), String, benchmark_host_once(), L1OverlayMemory, L1RestorationHost, lattice_seed_score(), LatticeSeedRow, memory_seed_rows() (+3 more)
...
Cohesion: 0.20
Nodes (6): L2CandidateLattice, IntoIterator, Item, Option, Self, Vec
...
Cohesion: 0.15
Nodes (17): batch_context_readout_matches_individual_scores(), LlmWaveMemory, LlmWaveNextTokenScore, LlmWaveRecord, load_default_memory(), load_default_memory_uncached(), prior_from_energy(), record_energy() (+9 more)
...
Cohesion: 0.31
Nodes (8): apply_manual_correction_output(), ManualCorrectionOutputContext, OutputFlow, Instant, Option, VirtualDevice, WordBuffer, Option
...
Cohesion: 0.36
Nodes (5): hash32(), phase_for(), prefix_hash(), route_hash_for(), Self
...
Cohesion: 0.14
Nodes (20): derive_llmwave_feedback(), l3_candidate_scoring_uses_long_phrase_context(), learning_deltas(), learning_deltas_show_live_phrase_becoming_l3_route(), llmwave_apply_feedback_is_main_l3_signal(), LlmWaveLearningDelta, longer_phrase_context_suppresses_short_wrong_association(), next_token_score_backs_off_to_recent_phrase_modes() (+12 more)
...
Cohesion: 0.12
Nodes (28): alpha_quality_is_low(), build_phrase_experience(), contract(), ends_with_unfinished_short_word(), has_dirty_layout_fragment(), has_low_language_quality(), has_repeated_letter_run(), has_repeated_vowel() (+20 more)
...
Cohesion: 0.12
Nodes (22): DirtyTaskRecord, RecentActionCandidateScore, RecentActionGateTrace, String, Vec, RecentActionRecord, record_recent_action(), Instant (+14 more)
...
### Community 494 - "runtime_flags.rs"
Cohesion: 0.53
...
## Knowledge Gaps
- **703 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+698 more)
...
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `profile_tests.rs`, `transition.rs`, `recognize_token`, `ManualOutputCommon`, `l2_candidate_phase.rs`, `correction_core.rs`, `.from_bytes`, `candidate_explanation.rs`, `.forward_queued_typing`, `TypingErrorClass`, `candidate_sources.rs`, `TypingAssistExplanation`, `journal_record.rs`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `WaveOptions` connect `PhysicalInputGrab` to `L3Feedback`, `main.rs`, `collect_recent_text`, `candidate_sources.rs`, `l3.rs`, `.run`, `state.rs`, `text_edit_gate_contract.rs`, `replacement_tests.rs`, `.from_bytes`, `surface.rs`, `status.rs`, `.score_next_tokens_report`, `input_gate.rs`, `profile_tests.rs`, `.run`, `LayImeBridge`, `pattern_wave.rs`, `correction_core.rs`, `canonical_l1_l2.rs`, `ManualCorrectionOutputContext`, `l4_goal_state.rs`?**
