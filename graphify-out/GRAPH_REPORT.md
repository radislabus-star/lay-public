...
## Corpus Check
- 886 files · ~3,964,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11541 nodes · 29630 edges · 479 communities (424 shown, 55 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2935 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1bef4875`
...
Cohesion: 0.07
Nodes (54): does_not_glue_long_latin_tail_to_russian_word(), hybrid_keeps_domain_and_converts_neighbor_word(), hybrid_keeps_mixed_case_ascii_brand_and_converts_neighbor_letter(), hybrid_keeps_valid_russian_phrase_without_partial_single_letter_flip(), plan_committed_tail_replacement(), plan_committed_whitespace_insertions(), Vec, offset_replacement_plan_for_cursor() (+46 more)
...
Cohesion: 0.08
Nodes (42): Eq, canonical_scene_wave_scaled(), merge_pair_bank(), semantic_relation_weights(), OnlineContextPhaseLearner, String, Vec, max_random_center_coherence() (+34 more)
...
Cohesion: 0.08
Nodes (32): fixture_lines(), fixture_rows(), opposite_events_flip_each_key_own_layout_for_smart_mixed_tail(), pending_auto_undo_restores_full_original_text(), replacement_plan_fixture_cases_match_minimal_edits(), smart_insert_layout_follows_result_text_tail(), target_layout_matches_cache_contract(), typing_assist_keeps_natural_cyrillic_hyphen_words() (+24 more)

### Community 20 - "LexicalPhaseMemory"
Cohesion: 0.10
Nodes (35): fixture_row_by_id(), apply_typing_assist_to_text_tail_with(), F, Into, Option, String, text_replacement(), text_replacement_from_fixture() (+27 more)
...
Cohesion: 0.09
Nodes (43): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), causal_feedback_summary(), compact_usage_events_if_needed(), correction_feedback_events_from_jsonl(), correction_feedback_receipts_from_jsonl(), CorrectionFeedbackReceipt (+35 more)

### Community 25 - "config_runtime.rs"
Cohesion: 0.06
Nodes (45): KeyCode, try_handle_enter_autocorrect(), active_auto_replace(), active_auto_switch_layout(), active_correction_engine(), active_correction_safety(), active_enter_autocorrect(), active_enter_autocorrect_from_env() (+37 more)
...
Cohesion: 0.06
Nodes (89): CorrectionSourceRole, BayesCandidateScore, Self, Vec, TypingErrorEvent, UnifiedCorrectionCandidate, predicted_state_id(), admit_evaluated_hidden_transition() (+81 more)
...
Cohesion: 0.06
Nodes (63): AsRef, LayImeBridge, Option, Result, String, VisibleTailSource, tail_source_for_authority(), debug_enabled_cached() (+55 more)

### Community 55 - "surface.rs"
Cohesion: 0.09
Nodes (64): is_user_protected_word(), l2_center_contains_surface(), l2_center_near_surfaces(), add_phase_birth_delta(), annotate_typed_damage_support(), apply_learned_transition_pressure(), candidate(), form_attractor_has_authority() (+56 more)
...
Cohesion: 0.08
Nodes (53): print_failures(), print_reason_breakdown(), print_worsened(), ablation_json(), build_status_json(), candidate_stats_json(), CandidateSourceStats, EvalResult (+45 more)
...
Cohesion: 0.08
Nodes (34): replacement_last_word_memory_ignores_middle_insert_plan(), DecoderEditPlan, Option, Self, String, CorrectionTrigger, committed_separator_is_preserved(), ensure_committed_tail_spacing() (+26 more)
...
Cohesion: 0.06
Nodes (71): bank_support(), candidate_l2_signature(), candidate_l2_signature_for_schema(), candidate_semantic_relation_weight(), candidate_token_hash(), canonical_relation_scene_wave(), canonical_scene_wave(), compact_surface_phase_class() (+63 more)
...
Cohesion: 0.08
Nodes (46): correction_source_name(), candidate_source_label(), canonical_replay_resolution(), decision_label(), arg_value(), candidate_summary_json(), full_user_target(), input_path() (+38 more)

### Community 98 - "log"
Cohesion: 0.12
Nodes (27): EncodedL4Scene, L4CrossSceneContextSignal, L4CrossSceneDisposition, L4CrossSceneInput, L4CrossSceneL2Signal, L4CrossSceneObservation, L4CrossSceneReadout, L4CrossSceneRecommendation (+19 more)
...
Cohesion: 0.23
Nodes (20): is_ru_live_protected_word(), surface_motif_known_surface(), surface_motif_strict_known_surface(), boundary_replacement_for_word(), boundary_scan_candidates(), boundary_split_candidates(), boundary_split_score(), contextual_boundary_replacement_for_word() (+12 more)
...
Cohesion: 0.06
Nodes (49): apply_feedback_overlay(), build_feedback_corpus(), compile_context_phase(), compile_context_phase_delta_reader_with_projection_base(), compile_context_phase_reader(), compile_context_phase_reader_with_projection_base(), compile_context_phase_reader_with_surface_field(), compile_context_phase_reader_with_surface_field_and_schema() (+41 more)
...
Cohesion: 0.14
Nodes (28): calibrate_pair_threshold(), calibrate_profile_threshold(), causal_only_compiler_excludes_orphans_and_censored_centers(), compile_observations(), compiled_package_is_already_runtime_canonical(), ConsolidatedScene, contradictory_receipts_form_ambiguity_instead_of_authority(), CrossSceneCompileConfig (+20 more)
...
Cohesion: 0.11
Nodes (22): is_cyrillic_letter(), contract(), ends_with_unfinished_short_word(), has_dirty_layout_fragment(), has_low_language_quality(), has_repeated_letter_run(), has_repeated_vowel(), has_short_known_insertion_neighbor() (+14 more)
...
Cohesion: 0.06
Nodes (50): should_try_ime_text_backend(), apply_prepared_typing_assist_after_space(), apply_typing_assist_correction(), defer_complex_edit(), DecoderEditPlan, should_defer_immediate_typing_edit(), ImeTypingReplacementContext, DecoderEditPlan (+42 more)

### Community 155 - ".run"
Cohesion: 0.07
Nodes (21): is_ascii_context_word(), next_word_segment(), Option, should_keep_latin_b_context(), future_auxiliary_allows_candidate(), is_future_auxiliary(), looks_like_infinitive_like_tail(), Option (+13 more)
...
### Community 218 - "Sync"
Cohesion: 0.25
Nodes (12): append_learning_entry_to_path(), append_learning_log_to_path(), append_user_correction_learning_log_to_path(), compact_learning_log_if_needed(), keep_jsonl_tail_bytes(), keep_last_jsonl_lines(), LearningEntry, Option (+4 more)
...
Cohesion: 0.29
Nodes (11): decode_fixture_field(), fixture_data_lines(), fixture_lines_from_str(), fixture_path(), fixture_rows_from_str(), fixture_text(), Item, Iterator (+3 more)
...
Cohesion: 0.08
Nodes (40): correct_common_layout_extra_letter(), correct_layout_missing_initial_letter(), correct_layout_vowel_confusion(), is_known_russian_layout_autoswitch_word(), is_russian_layout_surface_authority_word(), is_strong_layout_polish_word(), layout_phase_surface_authority(), layout_polish_replacement_allowed() (+32 more)
...
Cohesion: 0.17
Nodes (14): batch_context_readout_matches_individual_scores(), hash32(), LlmWaveMemory, LlmWaveNextTokenScore, LlmWaveRecord, LlmWaveRuntimeIndex, prefix_hash(), record_energy() (+6 more)
...
Cohesion: 0.40
Nodes (5): load_default_memory(), load_default_memory_uncached(), FnOnce, T, with_default_memory()

### Community 387 - "String"
Cohesion: 0.29
Nodes (7): decode_memory(), decode_record(), decode_vocabulary(), encode_memory(), encode_record(), memory_packet_roundtrip_uses_32_byte_records(), write_memory_packet()
...
Cohesion: 0.08
Nodes (36): handle_double_shift(), ManualCorrectionRequest, Option, VirtualDevice, WordBuffer, ScopedManualCorrectionRequest, Option, run_manual_correction_with_scope() (+28 more)
...
Cohesion: 0.15
Nodes (28): candidate_prefix_and_next(), combined_phrase_score(), derive_llmwave_feedback(), encode_vocabulary(), l3_candidate_scoring_uses_long_phrase_context(), llmwave_apply_feedback_is_main_l3_signal(), LlmWaveCandidateScore, LlmWavePhrasePrediction (+20 more)
...
Cohesion: 0.15
Nodes (25): alpha_quality_is_low(), build_phrase_experience(), CleanCorpusIngestReport, default_memory_path(), default_phrase_experience_path(), ingest_clean_corpus_path(), ingest_clean_corpus_text(), is_unstable_or_noisy_phrase() (+17 more)
...
Cohesion: 0.08
Nodes (31): RecentActionRecord, record_recent_action(), Instant, Option, Args, handle_force_layout_hotkey(), Option, VirtualDevice (+23 more)

## Knowledge Gaps
- **692 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+687 more)
...
- **Why does `WaveOptions` connect `WaveOptions` to `canonical_l2_recent.rs`, `main.rs`, `apply_text_replacement_pipeline`, `candidate_sources.rs`, `l3.rs`, `EnterAutocorrectContext`, `text_edit_gate_contract.rs`, `replacement_tests.rs`, `UsageEvent`, `surface.rs`, `status.rs`, `input_gate.rs`, `transition.rs`, `.run`, `recognize_token`, `LayImeBridge`, `pattern_wave.rs`, `canonical_l1_l2.rs`, `ManualCorrectionOutputContext`, `l4_goal_state.rs`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `KeyEvent` connect `KeyEvent` to `map_original_events`, `Vec`, `tail_memory.rs`, `apply_short_left_word_rule`, `layout_sync.rs`, `run_command_capture`, `correction_memory_runtime.rs`, `gnome_dbus.rs`, `LayConfig`, `decide_scoped_tail_correction`, `layout_controller.rs`, `packet.rs`, `experiment.py`, `LexicalPhaseMemory`, `correction_core.rs`, `record_recent_action`, `cyrillic.rs`, `fixture_row_by_id`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `ManualOutputCommon`, `transition.rs`, `recognize_token`, `add_group`, `l2_candidate_phase.rs`, `TypingErrorClass`, `candidate_sources.rs`, `canonical_l1_l2.rs`, `TypingAssistExplanation`, `hard_structural_veto.rs`, `journal_record.rs`, `tests.rs`?**
