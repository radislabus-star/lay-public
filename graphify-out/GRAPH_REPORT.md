...
## Corpus Check
- 909 files · ~3,983,547 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11730 nodes · 30078 edges · 473 communities (417 shown, 56 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2976 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92f91edd`
...
## Communities (473 total, 56 thin omitted)
...
Cohesion: 0.08
Nodes (40): Eq, canonical_scene_wave_scaled(), merge_pair_bank(), semantic_relation_weights(), OnlineContextPhaseLearner, String, Vec, update_bounded_cluster() (+32 more)
...
Cohesion: 0.06
Nodes (40): text_field_context_keeps_unfinished_words_separate_inside_same_window(), text_field_context_prunes_old_saved_slots(), text_field_context_separates_fields_without_window_identity(), window_input_state_keeps_separate_word_buffers(), push_text_as_layout(), Into, String, text_replacement() (+32 more)
...
Cohesion: 0.06
Nodes (48): KeyCode, try_handle_enter_autocorrect(), active_auto_switch_layout(), active_correction_safety(), active_enter_autocorrect(), active_enter_autocorrect_from_env(), active_nanda_autocorrect(), active_nanda_precognition() (+40 more)
...
Cohesion: 0.06
Nodes (33): 0. Canonical Live Owner Closure, 2026-08-01, 10. Forbidden Behaviors, 11. Canonical Summary, 12. 2026-07-27 Local Readout Safety Tightening, 13. 2026-07-27 Canonical Noun Package Full Safety Proof, 13. 2026-07-27 Full Russian Package And Live Lattice Boundary, 13. 2026-07-28 IBus L2 Cache Budget, 13. 2026-08-04 Internal Layout-Key Projection Contract (+25 more)
...
Cohesion: 0.11
Nodes (40): authority_proposal(), clear_last_live_completion_timing(), common_completion_outranks_rare_long_surface(), common_english_completion_survives_shared_gate(), fuzzy_l2_axis_keeps_missing_letter_prediction_basin_for_l3(), is_live_lexical_surface(), l2_known_state_completion_keeps_a_valid_instrumental_form_first(), l2_lattice_births_decoded_morphology_from_prefix() (+32 more)
...
Cohesion: 0.08
Nodes (45): CachedLexicalCandidates, LexicalReadoutCache, lexical_candidate(), l2_surface_memory_status(), L2SurfaceMemoryStatus, warm_up_ime_word_candidate_memory(), warm_up_prefixes(), warm_up_surface_motif_memory() (+37 more)
...
Cohesion: 0.06
Nodes (45): enter_autocorrect_candidate_keeps_normal_english_word(), enter_autocorrect_candidate_rejects_multiword_scope(), enter_autocorrect_candidate_rejects_plain_layout_word_guess(), ascii_hyphen_token_keycodes(), key_event(), key_event_with_shift(), key_events(), push_key_events() (+37 more)
...
Cohesion: 0.06
Nodes (90): CorrectionSourceRole, CandidateExplanation, BayesCandidateScore, explanation_for_candidate(), Self, Vec, TypingErrorEvent, UnifiedCorrectionCandidate (+82 more)
...
Cohesion: 0.12
Nodes (41): J, ArtifactParts, assign_best_terminals(), bounded_postings_put_stronger_corpus_support_first(), compile_centers(), compile_decoder(), compile_words(), compile_words_with_training() (+33 more)
...
Cohesion: 0.08
Nodes (71): ascii_layout_prefix_can_be_letter(), Option, String, TypingCandidate, TypingCandidateDecision, TypingCandidateFamily, TypingCandidateScore, contextual_layout_rule() (+63 more)

### Community 61 - "decode_completed_tail"
Cohesion: 0.08
Nodes (47): CompletionEditTrace, accepted_fix_creates_negative_trace_for_corrected_away_word_only(), add_usage_event_count(), add_usage_event_counts(), adjacent_usage_event_is_duplicate(), append_usage_event(), context_ngram_prior_scores_partial_context_match(), correction_feedback_events_from_jsonl() (+39 more)
...
Cohesion: 0.31
Nodes (12): atom_center_keys(), normalize_surface(), phase_coherence_milli(), surface_phase(), completion_score(), corpus_rank_boost(), lexical_score(), LexicalPhaseCandidate (+4 more)
...
Cohesion: 0.12
Nodes (38): PhaseOperator, PhaseProofReports, append_lexical_authority_atoms(), append_projection_atoms(), candidate_matches_operator(), collect_lexical_pair_reports(), collect_lexical_pair_wrong_examples(), collect_lexical_proof_reports() (+30 more)

### Community 78 - "format.rs"
Cohesion: 0.26
Nodes (14): atom_key(), put_u16(), put_u32(), put_u64(), read_center(), read_header(), read_u16(), read_u32() (+6 more)
...
Cohesion: 0.08
Nodes (32): Formatter, ArtifactBytes, decoder_reconstructs_training_form_absent_from_terminal_graph(), decoder_recovers_adjacent_transposition_as_typed_operator(), default_artifact_candidates(), default_artifact_path(), default_memory(), graph_reconstructs_surface_without_raw_word_table() (+24 more)
...
Cohesion: 0.12
Nodes (31): causal_feedback_summary(), compact_usage_events_if_needed(), flush_usage_persist(), legacy_usage_prior_path(), load_usage_counts(), load_usage_counts_snapshot(), load_usage_event_counts(), load_usage_feedback_counts() (+23 more)
...
Cohesion: 0.08
Nodes (44): K, RejectedStateEvidence, add_hot_context_counts(), add_hot_state_authority_repel(), add_hot_transition_counts(), context_ngram_ids(), context_ngram_prior_from_hot(), parse_context_word_key() (+36 more)
...
Cohesion: 0.13
Nodes (32): add_legacy_usage_counts(), add_rejected_fix_sources(), add_rejected_word_state(), add_state_authority_repel(), add_transition_counts(), compact_usage_counts_for_persist(), context_ngram_keys(), context_ngram_prior_from_counts() (+24 more)
...
Cohesion: 0.12
Nodes (19): handle_force_layout_hotkey(), Option, VirtualDevice, WordBuffer, prepare_uinput_output(), VirtualDevice, ForceLayoutHotkeyContext, ForceLayoutHotkeys (+11 more)
...
Cohesion: 0.10
Nodes (41): InputGateCandidateScoreTrace, InputGateScoreboard, decision_label(), CorrectionResolution, CorrectionScoreboard, Option, decide_input_gate(), decide_space_autocorrect() (+33 more)

### Community 140 - "llmwave.rs"
Cohesion: 0.13
Nodes (27): correct_ascii_prefix_with_ru_layout_tail(), correct_duplicate_layout_prefix_on_ascii_token(), correct_wrong_layout_ascii_technical_token(), has_clear_ascii_technical_layout_signal(), is_ascii_layout_anchor(), Option, String, should_keep_plain_cyrillic_before_ascii_technical() (+19 more)
...
Cohesion: 0.06
Nodes (35): EnterAutocorrectContext, Arc, Device, Instant, Mutex, Option, VirtualDevice, WordBuffer (+27 more)
...
Cohesion: 0.08
Nodes (22): correction_source_name(), candidate_source_label(), CandidateEvidence, correction_gate_runtime_stats(), correction_gate_stats(), correction_gate_stats_json(), CorrectionCandidateScoreTrace, CorrectionDecision (+14 more)
...
Cohesion: 0.22
Nodes (15): geometry_alone_cannot_authorize_an_unbound_single_letter_suffix(), known_complete_word_needs_context_evidence_before_extension(), live_admission_reason(), live_candidate_field_has_authority(), live_field_admission_is_owned_by_decision_core(), live_field_score_combines_l2_l3_l4_inside_decision_core(), live_l4_signed_bias(), live_suffix_field_has_display_authority() (+7 more)
...
Cohesion: 0.05
Nodes (60): ManualCorrectionRequest, Option, VirtualDevice, WordBuffer, ScopedManualCorrectionRequest, emit_forwarded_key_tap(), ForwardedTyping, PhysicalInputGrab (+52 more)

### Community 178 - "preedit.rs"
Cohesion: 0.09
Nodes (49): apply_layout_replay(), Option, VirtualDevice, enter_autocorrect_candidate(), handle_enter_autocorrect(), DecoderEditPlan, Option, Vec (+41 more)

### Community 179 - "experiment.py"
Cohesion: 0.11
Nodes (31): replacement_last_word_memory_ignores_middle_insert_plan(), DecoderEditPlan, Option, String, offset_replacement_plan_for_cursor(), apply_replacement_plan_to_text(), checked_cursor(), plan_text_replacement() (+23 more)
...
Cohesion: 0.10
Nodes (43): anti_center_repels_same_operator_near_miss(), causal_phase_atom(), compiled_phase_package_contains_no_training_words(), concrete_surface_id(), default_phase_memory_path(), entry(), is_local_lexical_candidate(), is_trainable_pair() (+35 more)
...
Cohesion: 0.40
Nodes (3): lexical_projection(), PhaseProfileBuilder, BTreeSet
...
Cohesion: 0.05
Nodes (71): ascii_to_russian_layout_candidate(), AsciiToRussianLayoutCandidate, exact_known_projection_is_not_moved_to_a_morphological_neighbour(), l2_phase_covers_raw_projection(), Option, String, ascii_alpha_count(), ascii_segment_is_known_english_word() (+63 more)
...
Cohesion: 0.19
Nodes (28): is_known_non_russian_to_english_layout_candidate(), is_common_ru_word(), is_ru_one_letter_function_word(), surface_motif_known_surface(), surface_motif_strict_known_surface(), boundary_replacement_beats_known_whole(), boundary_replacement_for_word(), boundary_scan_candidates() (+20 more)
...
Cohesion: 0.26
Nodes (14): candidate_prefix_and_next(), combined_phrase_score(), encode_vocabulary(), LlmWavePhrasePrediction, LlmWavePreviousTokenCandidate, near_previous_token_surface(), phrase_forecast_candidates(), phrase_prediction_to_candidate() (+6 more)
...
Cohesion: 0.16
Nodes (22): active_auto_replace(), lock_virtual_keyboard(), Arc, Mutex, MutexGuard, Option, VirtualDevice, apply_manual_correction_result() (+14 more)
...
Cohesion: 0.11
Nodes (23): has_safe_adjacent_transposition_candidate(), looks_like_present_tail(), looks_like_unsafe_chsh_deletion(), looks_like_unsafe_final_letter_deletion(), looks_like_unsafe_first_letter_deletion(), looks_like_unsafe_internal_y_deletion(), looks_like_unsafe_leading_pair_deletion(), looks_like_unsafe_vowel_join_deletion() (+15 more)
...
Cohesion: 0.06
Nodes (49): has_generated_russian_typo_candidate(), has_plausible_russian_typo_candidate(), is_pattern_term_stem(), looks_like_plausible_russian_past_tense(), looks_like_prefix_plus_known_russian_word(), looks_like_present_or_reflexive_verb(), rewrites_protected_pattern_term_stem(), correct_hard_sign_typo() (+41 more)
...
Cohesion: 0.17
Nodes (14): decode_memory(), decode_record(), decode_vocabulary(), LlmWaveMemory, LlmWaveRecord, LlmWaveRuntimeIndex, load_default_memory_uncached(), phase_for() (+6 more)
...
Cohesion: 0.20
Nodes (12): authorized_l2_single_letter_suffix_reaches_ime_readout(), completion(), decision_core_does_not_emit_a_candidate_rejected_by_live_admission(), decision_core_is_the_live_completion_sort_owner(), ime_projection_preserves_single_core_order_and_deduplicates(), live_completion_has_authority(), live_suffix_has_display_authority(), String (+4 more)
...
Cohesion: 0.07
Nodes (45): active_correction_engine(), handle_double_shift(), Option, run_manual_correction_with_scope(), CorrectionEngine, Correction, String, correction_to_action() (+37 more)
...
Cohesion: 0.11
Nodes (42): active_layout_backend(), active_text_backend(), call_focused_window_info(), call_ime_ping(), call_ping(), call_replace_text(), detect_auto_layout_backend_hint(), read_current_gnome_shell_layout_is_ru() (+34 more)
...
Cohesion: 0.11
Nodes (25): contract(), encode_memory(), encode_record(), ends_with_unfinished_short_word(), has_low_language_quality(), has_repeated_letter_run(), has_repeated_vowel(), has_short_known_insertion_neighbor() (+17 more)
...
Cohesion: 0.05
Nodes (81): actions_path(), CandidateBeforeApplyRecord, compact_action_log(), DirtyTaskRecord, EditPlanRecord, gate_action_name(), home_relative_path(), input_gate_outcome_name() (+73 more)
...
## Knowledge Gaps
- **745 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+740 more)
...
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `ManualOutputCommon`, `transition.rs`, `previous_token_allows_layout_tail`, `Sync`, `WaveOptions`, `main.rs`, `l2_candidate_phase.rs`, `.forward_queued_typing`, `TypingErrorClass`, `candidate_sources.rs`, `TypingAssistExplanation`, `journal_record.rs`, `.from_bytes`, `layout_sync.rs`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `WaveOptions` connect `PhysicalInputGrab` to `main.rs`, `candidate.rs`, `apply_text_replacement_pipeline`, `candidate_sources.rs`, `l3.rs`, `LayIbusEngine`, `replacement_tests.rs`, `correct_wrong_layout_ascii_word`, `surface.rs`, `.ru_l2_word_attractor_candidates`, `status.rs`, `WaveOptions`, `desktop.rs`, `phase_proof_json`, `transition.rs`, `LayImeBridge`, `tests.rs`, `correct_vowel_confusion_impl`, `structural_relation.rs`, `hunspell.rs`, `eval.rs`, `ManualCorrectionOutputContext`, `l4_goal_state.rs`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `KeyEvent` connect `KeyEvent` to `WaveTrace`, `Vec`, `apply_short_left_word_rule`, `TypingAssistRuleConfig`, `correction_memory_runtime.rs`, `committed_tail.rs`, `gnome_dbus.rs`, `types.rs`, `decide_scoped_tail_correction`, `layout_controller.rs`, `.from_bytes`, `preedit.rs`, `LayConfig`, `LexicalPhaseMemory`, `CharNgramModel`, `runtime_warmup_plan`, `tail_memory.rs`, `LayImeBridge`?**
