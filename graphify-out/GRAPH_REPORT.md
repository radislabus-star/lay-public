...
## Corpus Check
- 905 files · ~3,978,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11681 nodes · 29931 edges · 504 communities (449 shown, 55 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2955 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `64b6e2d1`
...
6. `resolve_text_correction()` - 82 edges
7. `request()` - 77 edges
8. `run_l1()` - 76 edges
...
Cohesion: 0.13
Nodes (33): ascii_technical_score(), candidate_map(), changed_token_count(), choose_oracle(), convert(), Decision, detect_direction(), edit_distance() (+25 more)
...
Cohesion: 0.08
Nodes (46): Eq, canonical_relation_scene_wave(), canonical_scene_wave(), canonical_scene_wave_scaled(), merge_pair_bank(), F, semantic_relation_weights(), incompatible_mode_never_blurs_a_full_bank() (+38 more)

### Community 17 - "word_reader.rs"
Cohesion: 0.08
Nodes (61): is_ru_short_function_word(), is_ru_short_preposition(), is_ru_short_pronoun(), glued_part_fixes(), glued_phrase_part_candidates(), push_glued_phrase_part_candidate(), Item, Iterator (+53 more)
...
Cohesion: 0.09
Nodes (28): Into, String, text_replacement(), text_replacement_from_fixture(), text_replacement_zero_edges(), typed_buffer_from_semicolon_fixture(), failed_manual_replay_keeps_already_pending_typing_assist(), marks_current_word_after_replay_for_next_toggle() (+20 more)

### Community 21 - "TypingErrorClass"
Cohesion: 0.08
Nodes (75): CandidateOrigin, l2_surface_candidate_cannot_apply_left_context_rewrite(), l2_surface_missing_letter_repair_from_dirty_surface_can_apply(), l2_surface_single_letter_repair_from_dirty_surface_can_apply(), TypingErrorClass, inserted_char_position_for_missing_letter(), Option, damerau_levenshtein() (+67 more)

### Community 22 - "candidate_sources.rs"
Cohesion: 0.05
Nodes (100): LayConfig, Option, String, Vec, TypingAssistRuleConfig, boundary_shift_source_keeps_tail_pair_eligible(), boundary_shift_transition_candidate(), canonical_l2_field_keeps_nonleader_neighbor_regressions_unselected() (+92 more)

### Community 23 - "l3.rs"
Cohesion: 0.04
Nodes (40): applies_boundary_candidate(), applies_confident_layout_candidate(), applies_split_memory_candidate(), applies_verified_single_word_layout_candidate(), ascii_layout_target_has_authority(), bounded_l2_surface_frame_repair_has_authority(), chars_are_subsequence(), direct_layout_projection_supported() (+32 more)
...
Cohesion: 0.06
Nodes (30): 0. Canonical Live Owner Closure, 2026-08-01, 10. Forbidden Behaviors, 11. Canonical Summary, 12. 2026-07-27 Local Readout Safety Tightening, 13. 2026-07-27 Canonical Noun Package Full Safety Proof, 13. 2026-07-27 Full Russian Package And Live Lattice Boundary, 13. 2026-07-28 IBus L2 Cache Budget, 13. 2026-08-04 Internal Layout-Key Projection Contract (+22 more)
...
Cohesion: 0.13
Nodes (35): clear_last_live_completion_timing(), common_completion_outranks_rare_long_surface(), common_english_completion_survives_shared_gate(), is_live_lexical_surface(), l2_known_state_completion_keeps_a_valid_instrumental_form_first(), l2_lattice_births_decoded_morphology_from_prefix(), last_live_completion_timing(), live_completion_candidates() (+27 more)
...
Cohesion: 0.09
Nodes (30): should_try_ime_text_backend(), PhysicalInputGrab, Drop, ImeTypingReplacementContext, DecoderEditPlan, Option, VirtualDevice, WordBuffer (+22 more)

### Community 42 - "safe_extra_letter_candidates"
Cohesion: 0.13
Nodes (33): CachedLexicalCandidates, LexicalReadoutCache, cached_lexical_candidates(), candidate(), correction_l2_word_candidates_impl(), ime_l2_completion_candidates_impl(), ime_l2_word_candidates_impl(), is_supported_lexical_surface() (+25 more)
...
Cohesion: 0.06
Nodes (95): CorrectionSourceRole, BayesCandidateScore, TypingErrorEvent, UnifiedCorrectionCandidate, predicted_state_id(), score_to_milli(), admit_evaluated_hidden_transition(), ambiguous_l2_surface_repair_requires_context() (+87 more)
...
Cohesion: 0.18
Nodes (28): AsRef, debug_enabled_cached(), enabled(), json_string(), manual_toggle_route(), record(), record_capabilities(), record_committed_tail_replace() (+20 more)

### Community 55 - "surface.rs"
Cohesion: 0.09
Nodes (60): is_ru_live_protected_word(), is_user_protected_word(), Vec, TailContext, add_phase_birth_delta(), annotate_typed_damage_support(), apply_learned_transition_pressure(), candidate() (+52 more)
...
Cohesion: 0.08
Nodes (33): apply_geometry_certificate_interference(), bounded_tail_does_not_evict_operator_evidence_already_inside_limit(), bounded_tail_keeps_the_strongest_operator_evidence(), candidate_order(), damerau_distance(), damerau_distance_heap(), deletion_transposition_operator_outranks_cross_script_keyboard_projection(), direct_surface_operator_outranks_cross_script_keyboard_projection() (+25 more)
...
Cohesion: 0.08
Nodes (17): active_correction_safety(), active_correction_safety_for_gate(), LayConfig, Vec, apply_auto_replace_policy(), normalize_typing_assist_pipeline(), Vec, rule_allowed_by_safety() (+9 more)
...
Cohesion: 0.08
Nodes (15): balanced_l2_surface_words(), build_l2_lexical_feedback_corpus(), cached_context_word_usage_prior(), cached_usage_prior_snapshot(), context_word_usage_prior(), l2_candidate_phase_shadow(), l2_surface_words_by_usage(), l2_transition_phase_readout() (+7 more)

### Community 77 - "input_gate.rs"
Cohesion: 0.14
Nodes (25): append_lexical_authority_atoms(), append_projection_atoms(), learned_lexical_margin_threshold(), learned_margin_threshold(), learned_margin_threshold_for_centers(), lexical_projection(), lexical_relation_atoms(), lexical_verdict_from_margin() (+17 more)
...
Cohesion: 0.26
Nodes (9): ambiguity_geometry_link(), AmbiguityObservation, expanded_pair_residual_wave(), is_anchor_channel(), max_subcenter_coherence(), observed_sequence(), complex_coherence_milli(), expand_atom() (+1 more)
...
Cohesion: 0.12
Nodes (22): Deref, anchor_sequence_hash(), CouplingView, ForwardActivation, is_keyboard_channel(), LexicalGrokkingMemory, ObservedAtom, position_coherence() (+14 more)
...
Cohesion: 0.09
Nodes (40): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), causal_feedback_summary(), compact_usage_events_if_needed(), correction_feedback_events_from_jsonl(), correction_feedback_receipts_from_jsonl(), CorrectionFeedbackReceipt (+32 more)
...
Cohesion: 0.06
Nodes (63): bank_support(), candidate_semantic_relation_weight(), candidate_token_hash(), context_atom_hashes(), context_exact_hash(), context_preserving_candidate_token(), context_role_hash(), context_tokens_for_authority() (+55 more)
...
Cohesion: 0.07
Nodes (30): CandidateEvidence, correction_gate_runtime_stats(), correction_gate_stats(), correction_gate_stats_json(), CorrectionCandidateScoreTrace, CorrectionDecision, CorrectionDecisionSource, CorrectionGateAtomicStats (+22 more)
...
Cohesion: 0.20
Nodes (29): alternating_expected(), build_rows(), candidate_matches_operation(), clean_field(), corrupt_completion(), corrupt_composite(), corrupt_extra_letter(), corrupt_layout() (+21 more)
...
Cohesion: 0.09
Nodes (45): apply_l2_weight(), candidate_support(), correction_l2_word_candidates(), hot_layout_candidate(), hot_layout_candidate_with_noisy_projection(), hot_short_layout_candidates(), ime_l2_boundary_candidates(), ime_l2_completion_candidates() (+37 more)
...
Cohesion: 0.12
Nodes (40): build_and_prove_l3_context_phase_memory(), build_and_prove_l3_context_phase_memory_with_surface_evidence(), build_and_prove_l3_sentence_context_memory(), build_l3_context_feedback_corpus(), compact_l3_context_composite(), compile_l3_context_delta_for_manifest(), compile_l3_context_feedback_overlay_memory(), compile_l3_context_phase_memory() (+32 more)
...
Cohesion: 0.15
Nodes (19): normalize_lexical_surface(), String, AnchorSequence, apply_position_certificate_interference(), apply_sequence_certificate_interference(), apply_settlement_mode(), apply_structural_interference(), base_settled_energy() (+11 more)
...
Cohesion: 0.10
Nodes (45): abstain_demotes_all_owned_surface_candidates_not_only_reported_cohort(), abstain_demotes_lexical_authority_but_preserves_independent_layout(), apply_authority_to_candidate_lattice(), apply_standalone_l2_field(), boundary_text_candidates(), candidate_last_word_lower(), canonical_l2_field_fails_closed_without_l11_seeds(), canonical_owned_text_candidates() (+37 more)
...
Cohesion: 0.12
Nodes (33): candidate_prefix_and_next(), combined_phrase_score(), derive_llmwave_feedback(), encode_vocabulary(), hash32(), l3_candidate_scoring_uses_long_phrase_context(), llmwave_apply_feedback_is_main_l3_signal(), LlmWaveCandidateScore (+25 more)
...
Cohesion: 0.12
Nodes (28): DecoderEditPlan, Option, String, apply_replacement_plan_to_text(), checked_cursor(), plan_text_replacement(), plan_text_replacement_with_options(), replacement_plan_matches() (+20 more)
...
Cohesion: 0.16
Nodes (22): PhaseOperator, PhaseProofReports, candidate_matches_operator(), collect_lexical_pair_reports(), collect_lexical_pair_wrong_examples(), collect_lexical_proof_reports(), collect_phase_proof_reports(), destructive_safe_positive_support() (+14 more)
...
### Community 218 - "Sync"
Cohesion: 0.10
Nodes (42): anti_center_repels_same_operator_near_miss(), causal_phase_atom(), compiled_phase_package_contains_no_training_words(), concrete_surface_id(), default_phase_memory_path(), entry(), is_local_lexical_candidate(), is_trainable_pair() (+34 more)
...
Cohesion: 0.12
Nodes (23): completed_tail_context(), String, WordBuffer, contextual_priority(), push_contextual_rule(), Vec, typing_assist_pipeline_for_context(), user_config_allows_rule() (+15 more)
...
Cohesion: 0.12
Nodes (12): From, Option, Self, TransitionAudit, TransitionOperator, TransitionProof, automatic_decision_pair_is_valid(), completion_projection_is_valid() (+4 more)
...
Cohesion: 0.23
Nodes (22): is_common_ru_word(), is_ru_one_letter_function_word(), surface_motif_known_surface(), surface_motif_strict_known_surface(), boundary_replacement_beats_known_whole(), boundary_replacement_for_word(), boundary_scan_candidates(), boundary_split_candidates() (+14 more)
...
Cohesion: 0.08
Nodes (46): alpha_quality_is_low(), build_phrase_experience(), CleanCorpusIngestReport, contract(), decode_memory(), decode_record(), decode_vocabulary(), default_memory_path() (+38 more)
...
Cohesion: 0.13
Nodes (22): candidate_usage_context_prior(), context_candidate_blocker(), context_candidate_selection_blocker(), current_token_boundary_split_parts(), DecisionOutput, effective_phrase_report(), evaluate_admitted_phrase_candidates(), l3_context_field_readout() (+14 more)
...
Cohesion: 0.15
Nodes (11): ambiguous_layout_candidates(), CandidateScore, Case, choose_layout_rules(), ConsensusArbiter, current_token_bonus(), ranked_layout_candidates(), SageCorrector (+3 more)
...
Cohesion: 0.05
Nodes (48): handle_pending_auto_undo(), remember_auto_undo(), Instant, Option, VirtualDevice, WordBuffer, active_learning_log(), append_learning_log() (+40 more)
...
Cohesion: 0.29
Nodes (19): add_keep_lines(), add_nanda_seed_cases(), add_phase_transition_surfaces(), add_short_alternating_cases(), add_technical_layout_cases(), build_cases(), Case, decode_fixture() (+11 more)
...
Cohesion: 0.10
Nodes (28): map_target_events(), expected_correction_action(), manual_decision_case(), String, Vec, single_currency_tail_replays_ru_semicolon_as_us_dollar(), single_word_wrong_layout_replay_target_is_opposite_layout(), smart_decision_converts_mixed_layout_neighbor_only() (+20 more)

### Community 360 - "LayImeBridge"
Cohesion: 0.06
Nodes (93): AblationRow, applied_source_for_trace(), arg_value(), arg_values(), build_live_llmwave_memory(), candidate_output_for_original(), candidate_short(), case_changes_only_last_token() (+85 more)

### Community 361 - "verify_with_retry"
Cohesion: 0.04
Nodes (91): extra_letter_rule_defers_to_missing_letter_candidates(), correct_common_layout_extra_letter(), correct_layout_missing_initial_letter(), correct_layout_vowel_confusion(), is_known_russian_layout_autoswitch_word(), is_russian_layout_surface_authority_word(), is_strong_layout_polish_word(), layout_phase_surface_authority() (+83 more)
...
Cohesion: 0.16
Nodes (13): LlmWaveMemory, LlmWaveRecord, LlmWaveRuntimeIndex, load_default_memory(), load_default_memory_uncached(), record_energy(), BTreeMap, BTreeSet (+5 more)
...
Cohesion: 0.11
Nodes (26): handle_double_shift(), ManualCorrectionRequest, Option, VirtualDevice, WordBuffer, ScopedManualCorrectionRequest, Option, run_manual_correction_with_scope() (+18 more)

### Community 398 - "config.rs"
Cohesion: 0.30
Nodes (10): append_source(), load_manifest(), main(), parse_args(), Namespace, Path, dedupe(), main() (+2 more)
...
Cohesion: 0.23
Nodes (18): canonical_l2_status(), compile_canonical_l2_package(), default_l2_model_dir(), discover_installed_l2_package(), export_unseeded_l11_seed_corpus(), installed_l2_field(), prove_canonical_l2_package(), query_canonical_l2_package() (+10 more)
...
### Community 460 - ".what_to_replay"
Cohesion: 0.44
Nodes (9): en_words(), load_hunspell_words(), load_plain_words(), main(), normalize_word(), Path, read_cases(), ru_words() (+1 more)
...
### Community 463 - ".ru_l2_word_attractor_candidates"
Cohesion: 0.31
...
### Community 476 - "config_path"
Cohesion: 0.39
Nodes (7): enter_autocorrect_candidate(), handle_enter_autocorrect(), DecoderEditPlan, Option, Vec, VirtualDevice, WordBuffer
...
### Community 479 - "ManifestWriteLock"
Cohesion: 0.39
...
### Community 485 - ".remember_visible_text_for_correction"
Cohesion: 0.25
...
### Community 489 - "input_gate_space_contract.rs"
Cohesion: 0.40
...
Cohesion: 0.21
Nodes (13): batch_context_readout_matches_individual_scores(), learning_deltas(), learning_deltas_show_live_phrase_becoming_l3_route(), LlmWaveLearningDelta, LlmWaveNextTokenScore, next_token_score_backs_off_to_recent_phrase_modes(), prior_from_energy(), Item (+5 more)
...
### Community 495 - "13. 2026-08-05 Atomic Space And Nonblocking L3 Refresh"
Cohesion: 0.50
...
### Community 501 - "record_nanda_trace_if_enabled"
Cohesion: 0.50
...
### Community 503 - "ManifestWriteLock"
Cohesion: 0.50
Nodes (3): ManifestWriteLock, Drop, File

### Community 504 - "CorrectionMode"
Cohesion: 0.29
Nodes (4): Self, CorrectionMode, ActiveCompositionGateConfig, Self

## Knowledge Gaps
- **733 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+728 more)
...
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `ManualOutputCommon`, `transition.rs`, `collect_recent_text`, `.what_to_replay`, `candidate_explanation.rs`, `l2_candidate_phase.rs`, `TypingErrorClass`, `candidate_sources.rs`, `TypingAssistExplanation`, `journal_record.rs`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `WaveOptions` connect `PhysicalInputGrab` to `L3Feedback`, `main.rs`, `candidate.rs`, `apply_text_replacement_pipeline`, `candidate_sources.rs`, `l3.rs`, `layout_sync.rs`, `add_mechanistic_features`, `replacement_tests.rs`, `surface.rs`, `.ru_l2_word_attractor_candidates`, `status.rs`, `phase_proof_json`, `transition.rs`, `LayImeBridge`, `tests.rs`, `.what_to_replay`, `pattern_wave.rs`, `apply_l2_phase_shadow`, `ManualCorrectionOutputContext`, `l4_goal_state.rs`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `CandidateOrigin` connect `TypingErrorClass` to `L3Feedback`, `decode_ascii_tail`, `candidate.rs`, `l2_candidate_phase.rs`, `apply_text_replacement_pipeline`, `candidate_sources.rs`, `l3.rs`, `l2_wave_peak.rs`, `add_mechanistic_features`, `RecentActionGateTrace`, `correction_core.rs`, `candidate_explanation.rs`, `.commit_active_composition_with_suffix`, `candidate_explanation.rs`, `transition_relation.rs`, `journal_record.rs`, `transition.rs`, `recognize_token`, `ManualCorrectionOutputContext`?**
