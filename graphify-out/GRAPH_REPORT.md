# Graph Report - lay  (2026-08-05)

## Corpus Check
- 902 files · ~3,976,812 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11647 nodes · 29861 edges · 503 communities (448 shown, 55 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2955 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9116f92f`
...
Cohesion: 0.07
Nodes (43): Eq, merge_pair_bank(), strongest_center(), strongest_center_with_min_support(), OnlineContextPhaseLearner, String, Vec, magnitude_overlap() (+35 more)
...
Cohesion: 0.06
Nodes (40): has_later_typing_press(), InputEvent, original_event_char(), Option, mixed_visual_latin_word_target_layout(), Option, same_key_latin_cyrillic_homoglyph(), mark_single_current_word_layout_if_stale() (+32 more)
...
Cohesion: 0.07
Nodes (87): CandidateOrigin, l2_surface_candidate_cannot_apply_left_context_rewrite(), l2_surface_missing_letter_repair_from_dirty_surface_can_apply(), l2_surface_single_letter_repair_from_dirty_surface_can_apply(), TypingErrorClass, inserted_char_position_for_missing_letter(), Option, damerau_levenshtein() (+79 more)
...
Cohesion: 0.13
Nodes (30): add_rejected_fix_sources(), add_rejected_word_state(), add_state_authority_repel(), add_transition_counts(), add_usage_event_count(), context_ngram_keys(), context_ngram_prior_from_counts(), context_ngram_prior_from_keys() (+22 more)
...
Cohesion: 0.09
Nodes (44): CachedLexicalCandidates, LexicalReadoutCache, l2_surface_memory_status(), L2SurfaceMemoryStatus, warm_up_ime_word_candidate_memory(), warm_up_prefixes(), warm_up_surface_motif_memory(), cached_lexical_candidates() (+36 more)

### Community 43 - "RecentActionGateTrace"
Cohesion: 0.07
Nodes (47): correct_common_layout_extra_letter(), correct_layout_missing_initial_letter(), correct_layout_vowel_confusion(), is_known_russian_layout_autoswitch_word(), is_russian_layout_surface_authority_word(), is_strong_layout_polish_word(), layout_phase_surface_authority(), layout_polish_replacement_allowed() (+39 more)
...
Cohesion: 0.06
Nodes (47): enter_autocorrect_candidate_keeps_normal_english_word(), enter_autocorrect_candidate_rejects_multiword_scope(), enter_autocorrect_candidate_rejects_plain_layout_word_guess(), apply_typing_assist_to_text_tail_with(), ascii_hyphen_token_keycodes(), key_event(), key_event_with_shift(), key_events() (+39 more)
...
Cohesion: 0.06
Nodes (92): CorrectionSourceRole, BayesCandidateScore, Self, Vec, TypingErrorEvent, UnifiedCorrectionCandidate, predicted_state_id(), L4SurfaceStatus (+84 more)
...
Cohesion: 0.05
Nodes (60): AsRef, LayImeBridge, Option, Result, String, VisibleTailSource, tail_source_for_authority(), deferring_committed_tail_toggle_suppresses_next_boundary_autocorrect() (+52 more)

### Community 55 - "surface.rs"
Cohesion: 0.10
Nodes (59): is_ru_live_protected_word(), is_user_protected_word(), add_phase_birth_delta(), annotate_typed_damage_support(), apply_learned_transition_pressure(), candidate(), form_attractor_has_authority(), form_attractor_word_candidates() (+51 more)
...
Cohesion: 0.10
Nodes (34): accepted_fix_creates_negative_trace_for_corrected_away_word_only(), add_usage_event_counts(), full_rebuild_deduplicates_same_second_same_payload_events(), historical_unattested_prediction_positive_is_ignored(), hot_usage_prior_compiles_string_counts_into_packed_payload(), keep_jsonl_tail_bytes(), malformed_typed_v2_identity_fails_closed(), merge_count_map() (+26 more)
...
Cohesion: 0.24
Nodes (17): admission_truth_table_uses_verifier_latent_invariants_and_signed_l4_memory(), admit(), candidate(), event(), exact_l4_state_proof_allows_known_form_drift(), hidden_state_allows_unknown_to_known_typo_repair(), hidden_state_blocks_context_imported_candidate_text(), hidden_state_blocks_live_known_form_drifts_from_logs() (+9 more)
...
Cohesion: 0.11
Nodes (34): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), causal_feedback_summary(), compact_usage_events_if_needed(), correction_feedback_events_from_jsonl(), correction_feedback_receipts_from_jsonl(), CorrectionFeedbackReceipt (+26 more)
...
Cohesion: 0.06
Nodes (67): bank_support(), candidate_semantic_relation_weight(), candidate_token_hash(), canonical_relation_scene_wave(), canonical_scene_wave(), canonical_scene_wave_scaled(), context_atom_hashes(), context_exact_hash() (+59 more)
...
Cohesion: 0.17
Nodes (13): cached_usage_prior_snapshot(), automatic_apply_is_not_positive_feedback(), context_rejection_does_not_leak_into_empty_context_transition(), edited_ime_attracts_final_word_without_globally_rejecting_valid_suggestion(), exact_state_transition_overrides_global_target_frequency(), hot_readout_collects_usage_and_rejection_in_one_pass(), UsageCandidatePrior, UsageHotContext (+5 more)
...
Cohesion: 0.09
Nodes (49): apply_l2_weight(), candidate_support(), hot_layout_candidate(), hot_layout_candidate_with_noisy_projection(), hot_short_layout_candidates(), ime_l2_boundary_candidates(), ime_l2_completion_candidates(), l1_energy() (+41 more)
...
Cohesion: 0.11
Nodes (37): InputGateCandidateScoreTrace, InputGateScoreboard, canonical_replay_resolution(), decision_label(), CorrectionResolution, CorrectionScoreboard, Option, decide_input_gate() (+29 more)
...
Cohesion: 0.22
Nodes (17): derive_llmwave_feedback(), encode_memory(), encode_vocabulary(), hash32(), LlmWaveCandidateScore, LlmWavePhrasePrediction, LlmWavePreviousTokenCandidate, LlmWaveReport (+9 more)
...
Cohesion: 0.16
Nodes (16): CandidateEvidence, correction_gate_runtime_stats(), correction_gate_stats(), correction_gate_stats_json(), CorrectionCandidateScoreTrace, CorrectionDecision, CorrectionDecisionSource, CorrectionGateAtomicStats (+8 more)
...
Cohesion: 0.10
Nodes (27): ManualCorrectionRequest, Option, VirtualDevice, WordBuffer, ScopedManualCorrectionRequest, emit_forwarded_key_tap(), ForwardedTyping, PhysicalInputGrab (+19 more)
...
Cohesion: 0.23
Nodes (20): is_ru_one_letter_function_word(), surface_motif_known_surface(), boundary_replacement_beats_known_whole(), boundary_replacement_for_word(), boundary_scan_candidates(), boundary_split_candidates(), boundary_split_score(), contextual_boundary_replacement_for_word() (+12 more)
...
Cohesion: 0.18
Nodes (12): LayoutReplayMemory, manual_toggle_gate_trace(), remember_layout_replay_success(), Option, WordBuffer, apply_manual_correction_output(), apply_layout_replay(), Option (+4 more)
...
Cohesion: 0.08
Nodes (78): applied_source_for_trace(), arg_value(), arg_values(), build_live_llmwave_memory(), candidate_short(), collect_json_string_fields(), collect_json_string_fields_from_str(), collect_json_value_string_fields() (+70 more)

### Community 361 - "verify_with_retry"
Cohesion: 0.09
Nodes (38): extra_letter_rule_defers_to_missing_letter_candidates(), has_generated_russian_typo_candidate(), has_plausible_russian_typo_candidate(), looks_like_prefix_plus_known_russian_word(), correct_missing_letter(), has_common_missing_letter_candidate(), missing_letter_candidate_exists(), Item (+30 more)
...
Cohesion: 0.16
Nodes (15): batch_context_readout_matches_individual_scores(), decode_record(), encode_record(), LlmWaveMemory, LlmWaveNextTokenScore, LlmWaveRecord, LlmWaveRuntimeIndex, phase_for() (+7 more)
...
Cohesion: 0.09
Nodes (32): handle_double_shift(), Option, run_manual_correction_with_scope(), CorrectionEngine, Correction, String, correction_to_action(), decode_manual_tail() (+24 more)

### Community 398 - "config.rs"
Cohesion: 0.11
Nodes (28): adjusted_confidence(), candidate_usage_context_prior(), context_candidate_blocker(), context_candidate_selection_blocker(), current_token_boundary_split_parts(), DecisionOutput, effective_phrase_report(), evaluate_admitted_phrase_candidates() (+20 more)
...
Cohesion: 0.18
Nodes (25): active_layout_backend(), call_focused_window_info(), call_ime_ping(), call_ping(), call_replace_text(), detect_auto_layout_backend_hint(), Option, Result (+17 more)
...
Cohesion: 0.19
Nodes (19): log(), keyboard_device_paths(), log_startup_backends(), log_startup_mode(), make_virtual_keyboard_for_runtime(), probe_backends(), LayConfig, Option (+11 more)
...
Cohesion: 0.24
Nodes (11): stable_hash_with_position(), surface_atom_projection(), SurfaceWaveTrit, candidate_l2_signature(), candidate_l2_signature_for_schema(), compact_surface_phase_class(), legacy_candidate_l2_signature(), pair_view_hash() (+3 more)
...
Cohesion: 0.15
Nodes (21): PreeditFastState, four_letter_russian_prefix_can_use_wave_lookup(), preedit_candidates_suppress_noisy_single_letter_suffixes(), ImeCandidateProposal, ImeCandidateReadoutRequest, ImeCandidateSource, is_allowed_visible_completion_suffix(), next_word_suffix() (+13 more)
...
## Knowledge Gaps
- **726 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+721 more)
...
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `ManualOutputCommon`, `recognize_token`, `transition.rs`, `main.rs`, `.what_to_replay`, `l2_candidate_phase.rs`, `.forward_queued_typing`, `TypingErrorClass`, `candidate_sources.rs`, `TypingAssistExplanation`, `learning_deltas`, `journal_record.rs`, `read_entries`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `damerau_levenshtein()` connect `TypingErrorClass` to `l2_wave_peak.rs`, `DaemonLoopState`, `safe_extra_letter_candidates`, `replay_layout_decision`, `score_typing_candidate`, `.commit_active_composition_with_suffix`, `TailContext`, `candidate_explanation.rs`, `l3.rs`, `autocorrect_edit_safety`, `candidate_sources.rs`, `surface.rs`, `ManualCorrectionOutputContext`, `.forward_queued_typing`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `WaveOptions` connect `PhysicalInputGrab` to `L3Feedback`, `main.rs`, `config.rs`, `candidate_sources.rs`, `l3.rs`, `layout_sync.rs`, `WaveTrace`, `state.rs`, `LayIbusEngine`, `replacement_tests.rs`, `surface.rs`, `status.rs`, `input_gate.rs`, `ComplexBasisWave`, `phase_proof_json`, `transition.rs`, `.run`, `LayImeBridge`, `tests.rs`, `.what_to_replay`, `apply_l2_phase_shadow`, `ManualCorrectionOutputContext`, `l4_goal_state.rs`?**
