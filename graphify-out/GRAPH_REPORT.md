...
## Corpus Check
- 937 files · ~4,083,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12302 nodes · 31629 edges · 501 communities (443 shown, 58 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 3009 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e37a5305`
...
Cohesion: 0.04
Nodes (57): try_handle_deferred_typing_assist(), handle_hard_boundary_if_needed(), HardBoundaryContext, note_learning_backspace_if_needed(), KeyCode, Option, WordBuffer, alt_shift_target_layout() (+49 more)
...
Cohesion: 0.10
Nodes (30): Eq, merge_pair_bank(), repeated_pair_direction_settles_across_independent_subcenters(), max_random_center_coherence(), observe(), compile_centers(), L4PhaseWitnessBank, observe_surface() (+22 more)

### Community 17 - "word_reader.rs"
Cohesion: 0.08
Nodes (60): is_ru_short_function_word(), is_ru_short_pronoun(), is_common_be_verb_form(), is_common_short_russian_preposition(), is_common_short_russian_pronoun(), is_known_russian_phrase_part(), is_one_letter_russian_function_word(), is_short_russian_function_word() (+52 more)
...
Cohesion: 0.07
Nodes (80): CandidateOrigin, Into, l2_surface_candidate_cannot_apply_left_context_rewrite(), l2_surface_missing_letter_repair_from_dirty_surface_can_apply(), l2_surface_single_letter_repair_from_dirty_surface_can_apply(), TypingErrorClass, inserted_char_position_for_missing_letter(), Option (+72 more)
...
Cohesion: 0.06
Nodes (46): active_auto_switch_layout(), active_correction_safety(), active_enter_autocorrect(), active_enter_autocorrect_from_env(), active_nanda_autocorrect(), active_nanda_precognition(), active_nanda_trace(), active_replace_words() (+38 more)
...
Cohesion: 0.06
Nodes (36): 0. Canonical Live Owner Closure, 2026-08-01, 10. Forbidden Behaviors, 11. Canonical Summary, 12. 2026-07-27 Local Readout Safety Tightening, 13. 2026-07-27 Canonical Noun Package Full Safety Proof, 13. 2026-07-27 Full Russian Package And Live Lattice Boundary, 13. 2026-07-28 IBus L2 Cache Budget, 13. 2026-08-04 Internal Layout-Key Projection Contract (+28 more)
...
Cohesion: 0.06
Nodes (25): contextual_fuzzy_pairs(), correct_contextual_fuzzy_pair(), Item, Iterator, Option, String, center_memory_recovers_typical_dirty_surfaces(), fuzzy_known_word_candidates() (+17 more)

### Community 42 - "safe_extra_letter_candidates"
Cohesion: 0.10
Nodes (40): CachedLexicalCandidates, LexicalReadoutCache, cached_lexical_candidates(), candidate(), corrected_prefix_frontier_contains_attested_comparative(), corrected_prefix_rank_cannot_erase_exact_prefix_birth_lane(), correction_l2_word_candidates_impl(), ime_candidate() (+32 more)

### Community 43 - "RecentActionGateTrace"
Cohesion: 0.13
Nodes (31): append_atom_family(), atom_profile_similarity_milli(), atom_weight(), band_probes_cover_every_center_inside_their_exact_hamming_radius(), damerau_levenshtein_bounded(), damerau_levenshtein_bounded_rows(), damerau_levenshtein_rows(), hash_atom() (+23 more)

### Community 44 - "correction_core.rs"
Cohesion: 0.08
Nodes (45): LanguageActionProof, TransitionOperator, L1TransitionSignal, L2TransitionSignal, L3TransitionSignal, Self, String, transition_names_state_and_verifier_evidence() (+37 more)
...
Cohesion: 0.05
Nodes (100): CorrectionSourceRole, CandidateExplanation, BayesCandidateScore, explanation_for_candidate(), Self, Vec, TypingErrorEvent, UnifiedCorrectionCandidate (+92 more)
...
Cohesion: 0.17
Nodes (29): AsRef, debug_enabled_cached(), enabled(), json_string(), manual_toggle_route(), record(), record_capabilities(), record_committed_tail_replace() (+21 more)

### Community 55 - "surface.rs"
Cohesion: 0.10
Nodes (61): is_common_ru_word(), is_ru_live_protected_word(), is_user_protected_word(), damerau_levenshtein(), add_phase_birth_delta(), annotate_typed_damage_support(), apply_learned_transition_pressure(), candidate() (+53 more)
...
Cohesion: 0.06
Nodes (67): active_learning_log(), append_learning_log(), append_reverted_system_apply_learning_log(), append_user_correction_learning_log(), append_correction_learning_log_to_path(), append_learning_entry_to_path(), append_learning_log_to_path(), append_reverted_system_apply_learning_log_to_path() (+59 more)

### Community 66 - "PendingTypingAssist"
Cohesion: 0.10
Nodes (47): active_composition_autocorrect_can_use_nanda_fallback(), active_composition_autocorrect_uses_unified_input_gate(), active_composition_context_replacement_keeps_previous_words_out_of_commit(), active_composition_decision_returns_only_live_text_replacement(), active_composition_gate_text(), active_composition_gate_text_preserves_committed_prefix_for_decision_only(), active_english_layout_does_not_protect_internal_layout_letter_symbol(), active_english_layout_preserves_known_ascii_token_from_layout_projection() (+39 more)
...
Cohesion: 0.05
Nodes (54): apply_feedback_overlay(), build_feedback_corpus(), compile_context_phase(), compile_context_phase_delta_reader_with_projection_base(), compile_context_phase_reader(), compile_context_phase_reader_with_projection_base(), compile_context_phase_reader_with_surface_field(), compile_context_phase_reader_with_surface_field_and_schema() (+46 more)

### Community 71 - "DaemonLoopState"
Cohesion: 0.06
Nodes (42): BirthAtom, AmbiguityObservation, apply_geometry_certificate_interference(), birth_atoms_per_channel(), birth_posting_budget(), bounded_tail_does_not_evict_operator_evidence_already_inside_limit(), bounded_tail_keeps_the_strongest_operator_evidence(), CachePlanOrder (+34 more)

### Community 72 - "TypingAssistRuleConfig"
Cohesion: 0.04
Nodes (61): LayConfig, Vec, config_path(), LayConfig, Self, apply_auto_replace_policy(), normalize_typing_assist_pipeline(), Vec (+53 more)
...
Cohesion: 0.30
Nodes (10): is_long_upper_ascii_word(), is_single_ascii_letter(), is_single_cyrillic_letter(), obvious_quality_choice(), obvious_token_choice(), Option, short_unknown_prefers_original(), all_tokens_known() (+2 more)
...
Cohesion: 0.12
Nodes (21): Deref, anchor_sequence_hash(), compile_surface_indices(), CouplingView, ForwardActivation, is_keyboard_channel(), LexicalGrokkingMemory, ObservedAtom (+13 more)

### Community 88 - "journal_record.rs"
Cohesion: 0.14
Nodes (24): gate_action_name(), gate_action_label(), TransitionAdmission, producer_allows_authority_evaluation(), admission_truth_table_uses_verifier_latent_invariants_and_signed_l4_memory(), admit(), admit_with_l4_signal(), candidate() (+16 more)
...
Cohesion: 0.10
Nodes (37): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), causal_feedback_summary(), compact_usage_events_if_needed(), enqueue_usage_persist(), flush_usage_persist(), legacy_usage_prior_path() (+29 more)
...
Cohesion: 0.06
Nodes (69): bank_support(), candidate_l2_signature(), candidate_l2_signature_for_schema(), candidate_semantic_relation_weight(), candidate_token_hash(), canonical_relation_scene_wave(), canonical_scene_wave(), canonical_scene_wave_scaled() (+61 more)
...
Cohesion: 0.21
Nodes (7): benchmark_host_once(), L1RestorationHost, lattice_seed_score(), LatticeSeedRow, memory_seed_rows(), String, Vec
...
Cohesion: 0.05
Nodes (22): CompactPackageView, Option, CompetitionEdge, FormCenterRef, L2FieldPackage, LemmaCenter, LocalContextMode, NeighborCoupling (+14 more)
...
Cohesion: 0.11
Nodes (24): handle_force_layout_hotkey(), Option, VirtualDevice, WordBuffer, prepare_uinput_output(), VirtualDevice, ForceLayoutHotkeyContext, ForceLayoutHotkeys (+16 more)
...
Cohesion: 0.06
Nodes (80): InputGateCandidateScoreTrace, InputGateScoreboard, decode_enter_autocorrect_tail(), decode_typing_assist_current_tail(), DecoderEditPlan, Option, CorrectionSource, changed_committed_tail_plan() (+72 more)
...
Cohesion: 0.13
Nodes (15): try_ime_replace_tail(), authorize_backend_edit(), AuthorizedEdit, BackendDispatchReceipt, BackendEditAuthorization, ExecutionBackend, only_an_undispatched_receipt_allows_backend_reselection(), From (+7 more)
...
Cohesion: 0.25
Nodes (12): benchmark_diverse_restoration(), benchmark_package(), candidate_fingerprint(), candidate_json(), inspect_package_header(), query_package(), restoration_candidate_json(), restore_surface() (+4 more)
...
Cohesion: 0.08
Nodes (55): accepted_fix_creates_negative_trace_for_corrected_away_word_only(), add_usage_event_counts(), automatic_apply_is_not_positive_feedback(), compile_usage_feedback_snapshot(), compiled_feedback_snapshot_recovers_reverted_auto_undo_receipt(), compiled_feedback_snapshot_restores_exact_negative_transition(), context_ngram_prior_scores_partial_context_match(), context_rejection_does_not_leak_into_empty_context_transition() (+47 more)
...
Cohesion: 0.05
Nodes (53): candidate_source_label(), decision_label(), arg_value(), candidate_summary_json(), full_user_target(), input_path(), normalized_text(), print_json() (+45 more)
...
Cohesion: 0.15
Nodes (25): String, stale_surrounding(), stale_tail(), verify_visible_text_transition(), candidate(), completion_projection_is_valid(), decide_text_transition(), ime_auto_undo_produces_an_executable_recorded_undo() (+17 more)
...
Cohesion: 0.06
Nodes (44): should_try_ime_text_backend(), apply_typing_assist_correction(), defer_complex_edit(), DecoderEditPlan, should_defer_immediate_typing_edit(), ImeTypingReplacementContext, DecoderEditPlan, Option (+36 more)
...
Cohesion: 0.12
Nodes (20): DecoderEditPlan, Option, Self, String, CorrectionTrigger, committed_separator_is_preserved(), ensure_committed_tail_spacing(), last_token_start_byte() (+12 more)
...
### Community 181 - "Row"
Cohesion: 0.11
Nodes (36): CrossSceneCompileConfig, observation(), Default, candidate_relation_id(), context_signal_from_text(), encode_scene(), encoder_is_candidate_relative_but_application_independent(), keep_relation_id() (+28 more)
...
Cohesion: 0.12
Nodes (16): 0. Зафиксировать Baseline, 10. Release Target 1.0.19: process refresh and exact rollback learning, 1. Закрыть Ownership L2, 2. Довести Онлайн-Обучение L3, 3. Расширить L3 до контекста предложения, 4. Типизированное ядро L4, 5. Обучаемый Cross-Scene L4, 6. Производительность без потери кандидатов (+8 more)
...
Cohesion: 0.07
Nodes (8): decode(), encode(), Result, String, Vec, LemmaWaveIndex, LemmaWaveRange, RuntimeLemmaWaveIndex
...
### Community 218 - "Sync"
Cohesion: 0.19
Nodes (4): CompactLemmaWaveIndexView, Option, Range, validate_read_index()
...
Cohesion: 0.06
Nodes (35): replacement_last_word_memory_ignores_middle_insert_plan(), classify_planned_replacement(), DecisionTransitionEditInput, downgrade_low_confidence_boundary_edit(), downgrade_low_confidence_wide_edit(), EditAction, EditActionKind, ime_accept_candidate_cannot_rewrite_left_context() (+27 more)
...
Cohesion: 0.22
Nodes (8): From, TransitionProof, automatic_decision_pair_is_valid(), Option, Self, TextTransitionIntent, TransitionAuthority, TransitionAuthorityKind
...
Cohesion: 0.20
Nodes (27): is_ru_one_letter_function_word(), l2_center_contains_surface(), surface_motif_known_surface(), boundary_fuzzy_candidates(), boundary_replacement_beats_known_whole(), boundary_replacement_for_word(), boundary_scan_candidates(), boundary_split_candidates() (+19 more)
...
### Community 355 - ".run"
Cohesion: 0.15
Nodes (17): lexical_data_loads_without_code_word_lists(), protected_ascii_words_parser_keeps_short_user_tokens(), fixture_lines_from_str(), completed_tail_context(), String, WordBuffer, completed_tail_context_keeps_left_russian_context(), completed_tail_context_keeps_sentence_sized_window_for_l3() (+9 more)
...
Cohesion: 0.20
Nodes (7): cached_usage_prior_snapshot(), hot_readout_collects_usage_and_rejection_in_one_pass(), FnMut, Vec, UsageContextCandidate, UsageHotContext, UsagePriorSnapshot
...
Cohesion: 0.05
Nodes (67): Reverse, prepare_compositional_field(), PreparedCompositionalField, compile_l2_package(), FnMut, L2FieldPackage, Option, Result (+59 more)
...
Cohesion: 0.17
Nodes (24): apply_replacement_plan_to_text(), checked_cursor(), plan_text_replacement_with_options(), replacement_plan_matches(), Option, String, tail_chars(), try_apply_replacement_plan_to_text() (+16 more)
...
Cohesion: 0.30
Nodes (11): build_ru_to_us(), build_us_to_ru(), convert(), detect_direction(), Direction, is_latin(), HashMap, String (+3 more)
...
Cohesion: 0.12
Nodes (26): LayIbusEngine, PreeditFastState, Vec, four_letter_russian_prefix_can_use_wave_lookup(), preedit_candidates_suppress_noisy_single_letter_suffixes(), ImeCandidateProposal, ImeCandidateReadoutRequest, ImeCandidateSource (+18 more)
...
Cohesion: 0.08
Nodes (34): decide_text_correction(), boundary_gate_admits_bounded_current_token_repair_and_split(), boundary_gate_does_not_split_known_single_word(), boundary_gate_does_not_split_known_word_inside_phrase(), boundary_gate_rejects_known_word_split_from_non_boundary_candidate(), boundary_gate_rejects_short_function_split_with_unknown_tail(), boundary_preserving_candidate_survives_explanation_gate(), composite_gate_blocks_same_tail_consonant_semantic_drift() (+26 more)

### Community 476 - "Option"
Cohesion: 0.12
Nodes (30): normalize_lexical_surface(), String, ambiguity_geometry_link(), AnchorSequence, apply_position_certificate_interference(), apply_sequence_certificate_interference(), apply_settlement_mode(), apply_structural_interference() (+22 more)
...
Cohesion: 0.23
Nodes (26): Copy, is_backed_clean_reference_form(), is_backed_ka_declension_form(), is_backed_russian_ch_verb_present_form(), is_backed_russian_consonant_alternating_form(), is_backed_russian_form(), is_backed_russian_imperative_i_form(), is_backed_russian_imperative_y_form() (+18 more)
...
Cohesion: 0.07
Nodes (32): RecentActionRecord, record_recent_action(), Instant, Option, Args, EnterAutocorrectContext, Arc, Device (+24 more)
...
Cohesion: 0.11
Nodes (15): live_candidate_gate_stats(), live_candidate_gate_stats_json(), live_stats(), LiveCandidateGateAtomicStats, LiveCandidateGateStats, LiveGateRecord, LiveSignedOutcomeStats, record_live_gate_stats() (+7 more)
...
## Knowledge Gaps
- **774 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `NANDA_WAVE_STATUS_FALLBACK` (+769 more)
...
- **Why does `UnifiedCorrectionCandidate` connect `.commit_active_composition_with_suffix` to `ManualOutputCommon`, `decode_ascii_tail`, `l2_candidate_phase.rs`, `correct_wrong_layout_ascii_word`, `TypingErrorClass`, `candidate_sources.rs`, `CanonicalL2FieldReadout`, `journal_record.rs`, `layout_sync.rs`, `phase_proof_json`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `damerau_levenshtein()` connect `surface.rs` to `l2_wave_peak.rs`, `safe_extra_letter_candidates`, `RecentActionGateTrace`, `TailContext`, `autocorrect_edit_safety`, `l3.rs`, `auto_undo.rs`, `choose_token_consensus_with_chooser`, `ManualCorrectionOutputContext`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `WaveOptions` connect `PhysicalInputGrab` to `make_ibus_text`, `LayImeBridge`, `canonical_l2_recent.rs`, `LayIbusEngine`, `main.rs`, `L3Feedback`, `replacement_tests.rs`, `packet.rs`, `l3.rs`, `candidate_sources.rs`, `surface.rs`, `eval.rs`, `ManualCorrectionOutputContext`, `layout_sync.rs`, `phase_proof_json`, `status.rs`, `l4_goal_state.rs`?**
