...
## Corpus Check
- 1061 files · ~4,679,710 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22919 nodes · 60937 edges · 850 communities (767 shown, 83 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 4304 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `429e164d`
...
- LexicalPairReport
- 5. Frozen-H Manifest
- select_single_letter_substitution
- choose_best_with_gap
- AtomKeyHasher
- CharNgramModel
- run_command_capture
...
- l3-self-teacher-promotion-gate.sh
...
- .trace_key
- AGENTS.md
- future_auxiliary_allows_candidate
- tests.rs
...
1. `UnifiedCorrectionCandidate` - 166 edges
2. `default_typing_assist_pipeline()` - 150 edges
3. `StandaloneL2Field` - 131 edges
4. `WordCandidate` - 115 edges
5. `KeyEvent` - 110 edges
6. `Harness` - 108 edges
7. `TypingErrorClass` - 107 edges
8. `PackagedProductiveRuntimeV1` - 98 edges
9. `CandidateOrigin` - 96 edges
10. `L2 Canonical Architecture Above L1.1` - 93 edges
...
- 2-file cycle: `src/nanda_wave/candidate_gate.rs -> src/nanda_wave/candidate_gate/cache.rs -> src/nanda_wave/candidate_gate.rs`
...
## Communities (850 total, 83 thin omitted)

### Community 0 - "learning_loop.rs"
Cohesion: 0.06
Nodes (107): boundary_enumeration(), boundary_reserve_is_two_surfaces_and_overflow_is_whole_field(), bounded_common_exact_view_preserves_raw_identity_without_proof_authority(), build_relation_partition_proof(), candidate(), canonical_anchor_contour_enumeration(), certified_exact_peak_enumeration(), combined_target_set_digest() (+99 more)

### Community 1 - "default_typing_assist_pipeline"
Cohesion: 0.06
Nodes (79): handle_force_layout_hotkey(), Option, WordBuffer, prepare_uinput_output(), settle_after_physical_trigger_release(), emit_backspaces(), emit_backspaces_for_text_replace(), emit_backspaces_for_text_replace_fast() (+71 more)
...
Cohesion: 0.05
Nodes (75): apply_manual_correction_output(), ManualCorrectionOutputContext, ManualOutputCommon, OutputFlow, Instant, Option, WordBuffer, execute() (+67 more)
...
Cohesion: 0.05
Nodes (55): JoinedMessages, MatchRule, Sequence, ActivationOutcome, AdapterConfig, AdapterError, AdapterState, before_deadline() (+47 more)
...
Cohesion: 0.06
Nodes (54): text_field_context_keeps_unfinished_words_separate_inside_same_window(), text_field_context_prunes_old_saved_slots(), text_field_context_separates_fields_without_window_identity(), window_input_state_keeps_separate_word_buffers(), push_text_as_layout(), text_replacement_from_fixture(), typed_buffer_from_semicolon_fixture(), backspace_autorepeat_deletes_one_known_event_without_release_effects() (+46 more)
...
Cohesion: 0.04
Nodes (52): ActivationGeneration, ActivationGrant, BootstrapIdentity, AdmissionDiagnosticSnapshot, AdmissionStatus, AdmissionToken, bounded_identifier(), CanonicalContextPath (+44 more)

### Community 14 - "PhaseReadout"
Cohesion: 0.09
Nodes (46): assess_exact_witness(), BoundSettlementContextV1, CanonicalL1AnchorReplayContextV1, CanonicalL1AnchorReplayContextV1<'a>, CohortCompareStatusV1, CohortFirstDivergenceV1, compare_material_membership(), compare_settlement() (+38 more)

### Community 15 - "LlmWaveMemory"
Cohesion: 0.08
Nodes (32): ColdBindingDerivationDiagnosticsV1, ColdLemmaSourceV1, decode_anchor(), decode_prepared_section(), dense_paradigm_flags_preserve_independent_sorted_memberships(), DenseParadigmFlagsV1, DenseProgramExecutionLaneV1, ExposedFormConstraintsV1 (+24 more)

### Community 16 - "WordCandidate"
Cohesion: 0.04
Nodes (130): MorphologySlotEvidence, IntoIterator, Item, TypingErrorEvent, UnifiedCorrectionCandidate, LexicalAuthorityEvaluationContextV1, predicted_state_id(), score_to_milli() (+122 more)

### Community 17 - "word_reader.rs"
Cohesion: 0.05
Nodes (94): ascii_lexical_neighbor_cannot_outrank_exact_layout_replacement(), authority_proposal(), bind_verified_lexical_repair_evidence(), bound_live_l2_material(), cache_only_readout_preserves_complete_gate_and_does_no_work_on_miss(), cached_live_completion_candidates(), clear_last_live_completion_timing(), clear_live_completion_cache() (+86 more)

### Community 18 - "KeyEvent"
Cohesion: 0.09
Nodes (41): base_contours(), BaseContourKindV1, BaseContourV1, contour_alphabet(), contour_derivation_ref(), digest128(), DiscoveryBucket, elapsed_us() (+33 more)
...
Cohesion: 0.07
Nodes (79): CandidateOrigin, TypingErrorClass, short_surface_gate_guard(), inserted_char_position_for_missing_letter(), Option, AdmissionLexicalFacts, candidate_admission_with_facts(), CandidateGateDecision (+71 more)

### Community 21 - "TypingErrorClass"
Cohesion: 0.05
Nodes (90): run_l1(), correction_l2_word_candidates(), ime_l2_word_candidates(), run_l2(), run_l2_with_options(), autocorrect_completion_does_not_extend_a_complete_inflected_form(), boundary_cell_births_short_pronoun_glue_before_length_cutoff(), boundary_cell_births_strong_short_left_field_centers() (+82 more)

### Community 22 - "candidate_sources.rs"
Cohesion: 0.20
Nodes (32): is_common_ru_word(), is_ru_one_letter_function_word(), surface_motif_known_surface(), surface_motif_strict_known_surface(), boundary_fuzzy_candidates(), boundary_replacement_beats_known_whole(), boundary_replacement_for_word(), boundary_scan_candidates() (+24 more)
...
Cohesion: 0.06
Nodes (86): admitted_ascii_projection(), admitted_contextual_short_layout_surface(), admitted_mixed_layout_surface(), admitted_physical_layout_surface(), append_exact_morphology_evidence(), append_productive_surface_candidates(), apply_standalone_l2_field(), boundary_text_candidates() (+78 more)
...
Cohesion: 0.04
Nodes (37): Actual IME client, without reconstructing a cache harness, Everyday commands, from the checkout being edited, Existing opt-in diagnostics, One-time machine setup, Short maintenance loop, What happens automatically, What this deliberately does not solve, Accepted settings inventory (+29 more)
...
Cohesion: 0.07
Nodes (26): InputFrameIdentity, EngineOutput, ascii_layout_symbol_continues_token(), candidate_index_for_target(), fast_token_boundary(), is_ascii_layout_token_char(), is_hard_precognition_boundary(), is_ime_candidate_russian_word() (+18 more)

### Community 31 - "read_entries"
Cohesion: 0.16
Nodes (36): is_boundary_punctuation(), L1TypedEditTraversal, LexicalEditState, operator_program_key(), OperatorProgram, ordered_children(), permutation_key(), phase7a_schedule_cannot_change_terminal_or_metric_bytes() (+28 more)

### Community 32 - "ContextPhasePackage"
Cohesion: 0.06
Nodes (83): AdmittedSpaceAutocorrect, committed_tail_autocorrect_decision_is_authorized(), active_composition_gate_text(), active_composition_gate_text_preserves_committed_prefix_for_decision_only(), active_english_layout_preserves_known_ascii_token_from_layout_projection(), active_layout_preserves_known_token(), ActiveCompositionAutocorrectDecision, ActiveCompositionAutocorrectRequest (+75 more)
...
Cohesion: 0.07
Nodes (89): ablation_rows(), AblationRow, applied_source_for_trace(), arg_value(), arg_values(), build_live_llmwave_memory(), candidate_short(), collect_json_string_fields() (+81 more)
...
Cohesion: 0.07
Nodes (64): candidate_has_live_authority(), canonical_live_scene_bytes(), CanonicalContourProvenance, CanonicalContourRelation, CanonicalContourSeed, CanonicalFormGrounding, CanonicalSurfaceGrounding, certified_exact_peaks() (+56 more)
...
Cohesion: 0.07
Nodes (46): assert_smart_pair(), layout_from_fixture(), typed_tail(), current_tail_case(), String, Vec, scoped_tail_keeps_completed_ascii_title_word_and_flips_current_latin_keys(), scoped_tail_keeps_good_english_previous_word_and_flips_current_layout_word() (+38 more)
...
Cohesion: 0.06
Nodes (50): manual_decoder_keeps_completed_russian_preposition_before_completed_ascii_tail(), CorrectionEngine, Correction, String, correction_to_action(), decode_manual_tail(), manual_decode_result(), ManualDecodeRequest (+42 more)
...
Cohesion: 0.08
Nodes (28): BirthAtom, CompiledSurfaceIndices, anchor_sequence_hash(), compile_surface_indices(), compile_surface_indices_impl(), compile_surface_indices_with_decoded_pool(), birth_atoms_per_channel(), birth_posting_budget() (+20 more)
...
Cohesion: 0.13
Nodes (23): candidate_output_for_original(), case_changes_only_last_token(), decision_label(), expected_candidate_blocker(), flow_example(), l2_candidate_flow_worker(), L2CandidateFlowPartial, L2CandidateFlowStats (+15 more)

### Community 49 - "correct_wrong_layout_ascii_word"
Cohesion: 0.06
Nodes (60): extra_letter_rule_defers_to_missing_letter_candidates(), correct_common_layout_extra_letter(), correct_layout_missing_initial_letter(), correct_layout_vowel_confusion(), has_known_cyrillic_hyphen_fragment(), is_cyrillic_hyphenated_word_for_layout(), is_known_cyrillic_hyphenated_word(), is_plain_cyrillic_technical_source() (+52 more)
...
Cohesion: 0.05
Nodes (80): DecoderEditPlan, Option, Self, String, does_not_glue_long_latin_tail_to_russian_word(), hybrid_keeps_domain_and_converts_neighbor_word(), hybrid_keeps_mixed_case_ascii_brand_and_converts_neighbor_letter(), hybrid_keeps_valid_russian_phrase_without_partial_single_letter_flip() (+72 more)
...
Cohesion: 0.09
Nodes (32): config_path(), default_typing_assist_rules(), Vec, LayConfig, Self, PathBuf, parse_bool_fixture(), single_fixture_row() (+24 more)
...
Cohesion: 0.14
Nodes (37): J, assign_best_terminals(), bounded_postings_put_stronger_corpus_support_first(), compile_centers(), compile_decoder(), compile_words(), compile_words_with_training(), compiler_emits_valid_stringless_artifact() (+29 more)
...
Cohesion: 0.07
Nodes (61): contextual_exact_prefetch_scopes_physical_edit_to_observed_token(), contextual_full_prefetch_scopes_physical_edit_to_observed_token(), current_full_no_apply_is_terminal_and_consumed_once(), current_full_no_apply_suppresses_prepared_exact_lease(), DesiredWork, evaluate_full(), exact_config(), exact_lease() (+53 more)
...
Cohesion: 0.05
Nodes (42): classify_planned_replacement(), DecisionTransitionEditInput, downgrade_low_confidence_boundary_edit(), downgrade_low_confidence_wide_edit(), EditAction, EditActionKind, ime_accept_candidate_allows_an_explicit_full_token_replacement(), ime_accept_candidate_allows_surface_preserving_boundary_split() (+34 more)
...
Cohesion: 0.07
Nodes (33): c_int, RecentActionRecord, record_recent_action(), Instant, Option, Args, EnterAutocorrectContext, Arc (+25 more)
...
### Community 79 - "mod.rs"
Cohesion: 0.04
Nodes (77): facade_exposes_candidate_scoring(), facade_exposes_decoder_contract(), facade_exposes_minimal_text_replacement(), facade_exposes_physical_keyboard_mapping(), facade_exposes_replay_layout_decision(), facade_exposes_text_to_uinput_runs(), facade_exposes_word_buffer(), facade_exposes_word_event_splitting_and_text_tail() (+69 more)
...
Cohesion: 0.08
Nodes (59): active_layout_backend(), activate_gnome_layout_once(), activate_target_layout_once_for_exact_replay(), detect_auto_layout_backend_hint(), Option, call_focused_window_info(), call_focused_window_info_once(), call_ime_ping() (+51 more)
...
Cohesion: 0.08
Nodes (34): add_relation(), activation_for_state(), elapsed_us(), EpochSearchMetrics, EpochSearchResult, EpochShard, Instant, Self (+26 more)

### Community 92 - "ShiftState"
Cohesion: 0.11
Nodes (57): is_ru_live_protected_word(), is_user_protected_word(), damerau_levenshtein(), add_phase_birth_delta(), annotate_typed_damage_support(), apply_learned_transition_pressure(), candidate(), form_attractor_has_authority() (+49 more)
...
Cohesion: 0.18
Nodes (36): HeldoutReservoir, corpus_words(), corpus_words_from_lines(), crystallize_l1_lexical_grokking(), crystallize_l1_lexical_grokking_with_rss_budget(), crystallize_l1_lexical_grokking_with_surface_policy(), evaluate_clean_parallel(), evaluate_parallel() (+28 more)
...
Cohesion: 0.07
Nodes (41): AtomKeySet, AtomRefcountMap, Hasher, append_atom_family(), atom_weight(), hash_atom(), simhash(), typed_atom_key() (+33 more)
...
Cohesion: 0.09
Nodes (36): CandidateDecisionBatch, closed_exact_candidate_is_verified(), closed_exact_readout_route_preserves_retained_target(), elapsed_us(), evaluate_closed_exact(), exact_action_operator(), exact_action_proof(), exact_candidate_authority() (+28 more)

### Community 108 - "What You Must Do When Invoked"
Cohesion: 0.07
Nodes (27): typing_assist_auto_replace_off_keeps_layout_only_rules(), LayConfig, Vec, apply_auto_replace_policy(), normalize_typing_assist_pipeline(), Vec, rule_allowed_by_safety(), sort_typing_assist_pipeline() (+19 more)
...
Cohesion: 0.13
Nodes (41): empty_factory_stale_focus_case(), firefox_observed_reset_after_release_preserves_prefix_in_both_callback_orders(), residual_atomic_unsubmitted_input_revokes_an_already_observed_prefix(), residual_first_numeric_word_bridge_refuses_without_delegation_or_output(), residual_first_word_observation_waits_for_atomic_submission_receipt(), residual_first_word_suffix_tracks_unicode_backspace_and_rejects_retained_prefix_after_gap(), residual_later_empty_factory_isolated_from_stale_focus_before_or_after_old_bind(), residual_legacy_enter_backspace_revokes_beyond_the_observed_mirror() (+33 more)
...
Cohesion: 0.12
Nodes (57): assert_exact_literal_delivery(), bootstrap_harness(), bootstrap_harness_with_config(), bootstrap_harness_with_profile_and_budget(), bootstrap_harness_with_profiles_and_budget(), complete_native_activation(), context(), controlled_p2p_bootstrap_and_compatibility_get_marker_are_real_zbus() (+49 more)

### Community 130 - "Vec"
Cohesion: 0.10
Nodes (47): calibrated_readout(), calibrated_readout_packaged(), calibrated_readout_selected(), calibration_key_hash(), CalibrationBackoffKeyV1, CalibrationCandidateV1, CalibrationCellV1, CalibrationGroupV1 (+39 more)

### Community 131 - "previous_token_allows_layout_tail"
Cohesion: 0.08
Nodes (58): candidate_state_tag(), canonical_member_cmp(), canonicalize_blockers(), cohort_digest(), complete(), completeness_bytes(), component_root(), conflict_component_count() (+50 more)
...
Cohesion: 0.09
Nodes (57): artifact_map(), known_failures_for_lanes(), PerformanceLaneError, Any, BaseException, Namespace, RuntimeError, Command-line orchestration for Lay's test lanes. (+49 more)
...
Cohesion: 0.11
Nodes (7): ExactManualToggleSuppression, advance_suppression_revision(), committed_tail_range_keeps_separator_outside_token(), exact_manual_toggle_handoff_preserves_tail_and_epoch_for_target_engine(), last_tail_token_range(), LayIbusEngine, publish_accepted_completion_feedback()
...
Cohesion: 0.04
Nodes (68): correct_contextual_known_word_missing_letter(), Option, String, has_generated_russian_typo_candidate(), has_plausible_russian_typo_candidate(), has_plausible_russian_typo_candidate_uncached(), correct_hard_sign_typo(), correct_hard_sign_typo_uncached() (+60 more)
...
Cohesion: 0.08
Nodes (78): Data, OrderedStream, Poll, PollResult, BarrierNonce, ConnectionGeneration, LineageGeneration, abandoned_key_requires_exact_owner_and_header_and_invalidates_sealed_transfer() (+70 more)
...
Cohesion: 0.08
Nodes (83): bootstrap_harness_with_budget(), actual_disable(), actual_focus_out(), actual_pending_early_key(), actual_pending_word_reset(), actual_reset(), assert_window_interaction_reset_rereceipt_contract(), bridge_delegate_exact_without_gui_edit() (+75 more)
...
Cohesion: 0.13
Nodes (20): accepted_word_usage_count_cached(), apply_usage_event_to_cache(), cached_usage_hot_state(), cached_usage_prior_snapshot(), context_word_usage_prior(), context_word_usage_prior_cached(), ensure_usage_cache_initialized(), ingest_usage_hot_state_if_stale() (+12 more)
...
Cohesion: 0.18
Nodes (23): initialize(), committed_texts(), exact_config(), exact_lease(), identity(), identity_for_layout(), install_exact_lease(), install_exact_lease_with_material_generation() (+15 more)

### Community 171 - "lay_daemon.rs"
Cohesion: 0.12
Nodes (26): BoundaryKindV1, decode_boundary(), decode_punctuation(), directional_scene_key(), empty_scene_is_sixty_zero_cells(), LocalTokenObservationV1, PreeditContinuationStateV1, PunctuationKindV1 (+18 more)

### Community 172 - "l4_hidden_state.rs"
Cohesion: 0.08
Nodes (29): handle_pending_auto_undo(), remember_auto_undo(), Instant, Option, WordBuffer, force_target_layout_for_replacement(), script_signal(), ScriptSignal (+21 more)
...
Cohesion: 0.06
Nodes (24): LayConfig, apply_l3_feedback(), derive_l3_feedback(), feedback_summary(), FeedbackAdjustment, L3Feedback, looks_like_technical_tail(), String (+16 more)
...
Cohesion: 0.09
Nodes (54): atom_profile_similarity_milli(), band_candidate_lemmas(), band_probes_cover_every_center_inside_their_exact_hamming_radius(), banded_ranking_is_identical_to_exhaustive_ranking(), build_band_postings(), consensus_code(), damerau_levenshtein_bounded(), damerau_levenshtein_bounded_rows() (+46 more)
...
Cohesion: 0.08
Nodes (36): add_usage_event_count(), add_usage_event_counts(), keep_jsonl_tail_bytes(), load_persisted_usage_counts(), snapshot_from_usage_events_for_tests(), accepted_fix_creates_negative_trace_for_corrected_away_word_only(), automatic_apply_is_not_positive_feedback(), compiled_feedback_snapshot_recovers_reverted_auto_undo_receipt() (+28 more)
...
Cohesion: 0.11
Nodes (43): InputGateCandidateScoreTrace, InputGateScoreboard, input_gate_outcome_name(), input_gate_stage_name(), correction_boundary_preserves_frame_presence_and_identity(), correction_request_from_input_gate(), decide_closed_exact_input_gate_observed(), decide_input_gate() (+35 more)
...
Cohesion: 0.05
Nodes (62): ProductiveSourceCell, context_mode(), scene_wave(), birth_surfaces(), attach_productive_context_pair_evidence(), CanonicalL1LexicalAnchorV1, CanonicalL2FieldReadout, classify_exact_grounded_geometry() (+54 more)
...
Cohesion: 0.09
Nodes (60): bridge(), bridge_fence(), bridge_toggle_terminal(), consume_detached_callback_reply(), cycle09_add_trailing_boundary(), cycle09_assert_no_local_text_effect(), cycle09_exact_handoff_is_live(), cycle09_exact_suppression_is_armed() (+52 more)
...
Cohesion: 0.11
Nodes (53): add_legacy_usage_counts(), add_rejected_fix_sources(), add_rejected_word_state(), add_state_authority_repel(), add_transition_counts(), causal_feedback_summary(), compact_usage_counts_for_persist(), compact_usage_events_if_needed() (+45 more)
...
Cohesion: 0.06
Nodes (36): 1.0.34 Double-Shift Delegation Regression, 1.0.35 Physical False-Handled Finding, 1.0.35 Release And Runtime Installation, 1.0.36 Delegated Output Re-entry Finding, 1.0.37 Installed Live Verdict, 1.0.38 Deterministic Double Shift Repair, 1.0.39 Ordered Double Shift Authority, 1.0.44 IME Suggestion Shape And Window Latency (+28 more)
...
### Community 214 - ".run"
Cohesion: 0.10
Nodes (16): autocorrect_replacement_has_one_trailing_space(), committed_tail_toggle_plan_uses_visible_ime_tail_not_old_daemon_buffer(), engine(), focus_reset_cancels_pending_double_shift(), ime_auto_undo_contexts(), LayIbusEngine, manual_toggle_suppresses_next_boundary_autocorrect_once(), pending_double_shift_cancels_on_unrelated_nonempty_snapshot() (+8 more)

### Community 215 - "live_field.rs"
Cohesion: 0.11
Nodes (37): print_reason_breakdown(), print_worsened(), ablation_json(), build_status_json(), candidate_stats_json(), CandidateSourceStats, EvalResult, evaluate_deterministic() (+29 more)
...
Cohesion: 0.15
Nodes (24): normalize_lexical_surface(), String, direct_typed_certificates(), direct_typed_oracle(), L1TypedEditTraversal<'a>, L1TypedQueryField, LayoutDirection, phase7d_certificate_keys() (+16 more)
...
Cohesion: 0.21
Nodes (30): audit_productive_anchor_recovery_v1(), compact_canonical_l2_package(), compile_canonical_l2_package(), compile_exact_v13_sidecar(), compile_productive_l2_sidecar(), compile_productive_paradigm_field_v1(), estimate_productive_semantic_transducer_heldout_v1(), estimate_productive_semantic_transducer_v1() (+22 more)
...
Cohesion: 0.04
Nodes (88): ambiguity_shell_extends_the_tied_basin_without_granting_authority(), ambiguity_veto(), anti_evidence_cannot_collapse_an_objective_tied_basin(), anti_veto_preserves_the_full_certified_basin(), authority_evidence_is_consistent(), bounded_evidence(), calibration_can_abstain_without_inventing_a_winner(), candidate() (+80 more)
...
Cohesion: 0.10
Nodes (11): OutcomeProof, ContextResetRereceiptCandidate, LayIbusEngine, LifecycleReceipt, ObservationReceipt, AtomicCapability, AtomicEnvelope, AtomicPriorReceipt (+3 more)
...
Cohesion: 0.05
Nodes (71): is_cyrillic_letter(), is_plain_cyrillic_layout_token(), correct_ascii_prefix_with_ru_layout_tail(), correct_duplicate_layout_prefix_on_ascii_token(), correct_wrong_layout_ascii_technical_token(), has_clear_ascii_technical_layout_signal(), is_ascii_layout_anchor(), Option (+63 more)

### Community 246 - "autocorrect_edit_safety"
Cohesion: 0.15
Nodes (28): previous_word_segment(), apply_auto_replace(), apply_auto_replace_with_visual_b(), apply_manual_replay_auto_replace(), builtin_replacement_rules(), has_cyrillic_text(), has_phrase_context(), latin_b_should_stay() (+20 more)

### Community 247 - "choose_token_consensus_with_chooser"
Cohesion: 0.14
Nodes (19): gate_action_label(), admit_evaluated_hidden_transition(), generic_l4_negative_can_veto(), hidden_short_transposition_requires_state_proof(), verified_layout_transition(), verified_typed_boundary_transition(), verified_typed_word_count_increasing_boundary_split(), producer_allows_authority_evaluation() (+11 more)
...
Cohesion: 0.14
Nodes (20): AtomPostingSections, build_atom_postings(), build_lemma_wave_row(), decode_delta_postings(), delta_postings_roundtrip_strictly_ordered_lemma_ids(), L2FieldPackage, LemmaWaveBuildRow, LemmaWaveSource (+12 more)
...
Cohesion: 0.15
Nodes (44): armed_exact_replay(), completed_exact_replay_retires_before_ordinary_managed_input(), completed_expired_exact_replay_cannot_consume_the_next_ordinary_key(), exact_replay_active_path_and_expiry_refuse_before_text_effect(), exact_replay_duplicate_and_identity_mismatches_revoke_without_text_effect(), exact_replay_order_and_visible_glyph_mismatches_revoke_without_text_effect(), exact_replay_surrounding_receipt(), exact_replay_unhandled_callback_preserves_six_complete_transactions() (+36 more)
...
Cohesion: 0.13
Nodes (29): CorrectionSourceRole, center_resonance(), context_words_before_last(), drift_anti_wave(), foundation_resonance(), known_surface_mass(), L2CorrectionPeakContext, L2WavePeakScore (+21 more)
...
Cohesion: 0.17
Nodes (22): ArtifactParts, ArcRecord, ArtifactHeader, CenterRecord, DecoderArcRecord, DecoderStateRecord, NodeRecord, read_arc() (+14 more)
...
Cohesion: 0.11
Nodes (16): ArtifactBytes, decoder_reconstructs_training_form_absent_from_terminal_graph(), LexicalPhaseStats, MappedFile, reconstruction_lane_survives_field_frontier_cut(), Box, c_void, Drop (+8 more)
...
Cohesion: 0.16
Nodes (16): PendingSystemOutcomeFeedback, VisibleTailSource, ClientContextState, PendingContextResetRereceipt, PublishedPreeditWitness, Instant, Option, Self (+8 more)
...
Cohesion: 0.05
Nodes (75): admit_l3_context_delta(), admit_l3_context_delta_with_full_proof(), balanced_l2_surface_words(), build_and_prove_l3_context_phase_memory(), build_and_prove_l3_context_phase_memory_with_surface_evidence(), build_and_prove_l3_sentence_context_memory(), build_l2_lexical_feedback_corpus(), build_l3_context_feedback_corpus() (+67 more)
...
Cohesion: 0.17
Nodes (16): AutocorrectSuppression, CurrentWordSuppression, PendingImeAutoUndo, PendingImeAutoUndoRetry, Instant, Option, String, SharedState (+8 more)
...
Cohesion: 0.07
Nodes (47): coupling_order(), Ordering, WaveCoupling, analyze_package(), canonical_relations(), decode_posting(), encode_posting(), EncodedPosting (+39 more)
...
Cohesion: 0.07
Nodes (38): alt_shift_target_layout(), apply_focus_state(), listen_pointer(), Arc, AtomicU64, InputEvent, Option, PathBuf (+30 more)
...
Cohesion: 0.20
Nodes (13): config(), engine(), envelope(), parses_ibus_text_surrounding_text(), physical_double_shift_owner_legacy_route_is_observation_only(), prepare_atomic_space(), LayConfig, Shared (+5 more)
...
Cohesion: 0.19
Nodes (17): ProductiveV1LoadResult, default_l2_model_dir(), discover_installed_exact_v13_sidecar(), discover_installed_l2_package(), discover_installed_productive_l2_sidecar(), discover_installed_productive_l2_v1_package(), failed_admission_is_cached_until_explicit_reload(), installed_productive_l2_v1() (+9 more)
...
Cohesion: 0.21
Nodes (23): main(), prepare(), canonical(), cargo_build_environment(), cargo_configuration_closure(), cargo_discovery(), cargo_sandbox_command(), classify() (+15 more)
...
Cohesion: 0.16
Nodes (16): admitted_engine(), AdmittedEngine, callback_message(), engine(), exact_request(), Connection, LayIbusEngine, Message (+8 more)
...
Cohesion: 0.20
Nodes (8): configured_atomic_double_shift_key(), physical_double_shift_owner_legacy_observation_has_no_cleanup_or_word_effect(), is_accept_completion_with_space_key(), is_key_press(), is_shift_key(), has_command_modifier(), observed_tail_append_effect(), observed_tail_append_length()
...
Cohesion: 0.15
Nodes (18): InputConfigIdentity, correction_affecting_config_is_part_of_frame_identity(), DeferredLearningAction, exact_text_and_focus_dimensions_are_not_hash_only(), frame_fingerprint(), FrameFingerprintInput, identity(), lexical_authority_frame_conversion_is_lossless() (+10 more)
...
Cohesion: 0.08
Nodes (31): candidate(), anchor_replay(), assess(), canonical_anchor_material(), canonical_index(), empty_enumeration(), exact_witness_replay_accepts_owned_exact_peak_root(), exact_witness_replay_rejects_raw_terminal_substitution() (+23 more)
...
Cohesion: 0.16
Nodes (9): cached_usage_prior_snapshot(), FnMut, Vec, UsageCandidatePrior, UsageContextCandidate, UsageContextFrontier, UsageHotContext, UsageHotReadout (+1 more)
...
Cohesion: 0.11
Nodes (16): Scoped atomic settlement — обязательная часть, не отложенная регрессия, TD-120: Ограничить обычный запрет автозамены жизнью своего слова, Последствия, бюджет и границы, Постоянный внутренний контракт, Проблема и доказанный результат baseline, Промежуточные результаты (история, не финальный verdict), Уточнение дизайна до production-кода, Фиксированная TDD-матрица и критерии приёмки (+8 more)

### Community 433 - "TextTransitionRejection"
Cohesion: 0.24
Nodes (14): clear_productive_runtime_dependents(), hex_sha256(), installed_canonical_l2_identity(), installed_productive_l2_sidecar(), load_productive_l2_v1(), productive_sidecar_state(), reload_productive_l2_sidecar(), reload_productive_l2_sidecar_inner() (+6 more)

### Community 434 - "correct_wrong_layout_ascii_phrase"
Cohesion: 0.29
...
Cohesion: 0.04
Nodes (46): TD-122: Привязать legacy replay suppression к конкретному запросу, Варианты, До кода, Причина и границы, Приёмка будущего решения, Current TD-121 acceptance — 2026-09-13, Current TD-121 repair — 2026-09-14, Historical C20 installation — before the Firefox report (+38 more)
...
Cohesion: 0.09
Nodes (25): Protocol, is_completion_learning_boundary(), LayIbusEngine, Result, legacy_engine(), press(), LayIbusEngine, String (+17 more)
...
### Community 456 - "teacher.rs"
Cohesion: 0.20
Nodes (8): ActiveBindingV1, PreparedSlotEvaluationV1, ProductiveEvaluationModeV1, ProductiveTargetProbeIdentityV1, ProductiveTargetProbeV1, LemmaParadigmBindingV1, Option, SlotPhaseProfileRecordV1

### Community 457 - "typing_assist_short_alternating.rs"
Cohesion: 0.19
Nodes (13): ExactV13LoadResult, canonical_form_contains_surface(), canonical_l2_status(), exact_v13_state(), exact_v13_status(), installed_exact_v13(), installed_l2_field(), load_exact_v13() (+5 more)

### Community 458 - "update"
Cohesion: 0.03
Nodes (76): DeferredTypingAssistContext, Arc, Device, Instant, Mutex, Option, WordBuffer, try_handle_deferred_typing_assist() (+68 more)
...
### Community 460 - "installed_l2_field"
Cohesion: 0.16
...
Cohesion: 0.40
Nodes (5): Remote compilation boundary, TD-120/121: продолжение после допуска пользователя, Бюджет изменения, Новый диагностический bootstrap — последствия до изменения harness, Параллельная работа с разными владельцами
...
### Community 479 - "L3Feedback"
Cohesion: 0.12
Nodes (30): CompletionEditTrace, adjacent_usage_event_is_duplicate(), append_usage_event(), compile_usage_feedback_snapshot(), correction_feedback_events_from_jsonl(), correction_feedback_receipts_from_jsonl(), correction_receipt_is_exact_system_revert(), correction_receipt_user_target() (+22 more)
...
Cohesion: 0.07
Nodes (26): DerefMut, deferring_committed_tail_toggle_suppresses_next_boundary_autocorrect(), LayIbusEngine, Option, Result, terminal_committed_tail_double_shift_round_trips_and_preserves_boundary(), terminal_committed_tail_double_shift_uses_one_ime_output_frame(), ContextBridgeOutput (+18 more)
...
### Community 485 - "installed_productive_l2_v1"
Cohesion: 0.38
...
Cohesion: 0.22
Nodes (8): Accepted development simplification — 2026-09-07, Architecture evidence discipline, Automated checks and compact evidence, Cargo disk budget, Consequence analysis before code changes, graphify, Protected Double Shift route, Systemic wave-contour fixes
...
### Community 496 - "Poor-input authority repair, 2026-09-11"
Cohesion: 0.29
...
### Community 497 - "load_plain_words"
Cohesion: 0.39
...
Cohesion: 0.20
Nodes (10): Join, join_ordered_streams(), next_ordered_message(), A, B, Message, Option, Pin (+2 more)

### Community 504 - "Lay 1.0.66 remote sidecar: independent review, pass 2"
Cohesion: 0.11
...
### Community 506 - "TD-121 — final engine wiring handoff"
Cohesion: 0.29
...
### Community 507 - "TD-124 execution evidence"
Cohesion: 0.13
...
Cohesion: 0.12
Nodes (12): BinaryHeap, typo_tolerant_completion_candidates(), CompletionFrontier, LexicalPhaseMemory, ArtifactBytes, AtomicU64, AtomicUsize, Debug (+4 more)
...
### Community 514 - "TD-120 bounded repair pass 2 — consequence addendum"
Cohesion: 0.20
...
### Community 519 - "TD-125 — Authorized-plan execution: actual RED/GREEN"
Cohesion: 0.10
Nodes (18): Bounded mechanism and consequence analysis — 2026-09-07, Immediate work, in order, Regression matrix and pitfalls, Required behavior, Scope and stop conditions, TD-125 — Preserve the preceding word and separator during autocorrection, Client process exit and replacement-boundary investigation — 2026-09-07, Consequences and boundaries (+10 more)

### Community 520 - "score_typing_candidate"
Cohesion: 0.33
Nodes (6): Current TD-121 acceptance — 2026-09-13, TD-121 C20 release and installation checkpoint, Все задачи tech_debt: план, отчёты и публикация, Исторический C18/C19 gate, История TD-121: C18/C19 до C20, Полное дерево
...
### Community 525 - "select_repeated_letter_candidate"
Cohesion: 0.22
...
### Community 527 - "choose_token_consensus_with_chooser"
Cohesion: 0.18
...
### Community 537 - "find_typing_rule"
Cohesion: 0.03
Nodes (55): История и восстановление проекта, Current: exact manual handoff V2 installed, physical pending, Current: TD-121 acceptance, 2026-09-13, Current TD-121 acceptance — 2026-09-13, Historical: Alt+Shift/source-frame follow-up installation before V2, Historical: browser legacy FocusIn exact-tail receipt projection source-only V1, Historical: Lay 1.0.70 GitHub fixes installed runtime, Historical: poor-input mechanics installed before 1.0.71 release (+47 more)
...
### Community 539 - "normalize_ngram_word"
Cohesion: 0.40
...
### Community 544 - "Proof pipeline revision and first live admission, 2026-08-10"
Cohesion: 0.40
...
### Community 546 - "typing_assist_short_alternating.rs"
Cohesion: 0.40
Nodes (5): Lay — текущая очередь, Operating Rules, Очередь после текущего checkpoint, Текущая очередь, Текущее состояние TD-121 — 2026-09-13

### Community 547 - "auto_undo.rs"
Cohesion: 0.08
Nodes (25): Affected closure and clean-HEAD harness audit — 2026-09-20, Automatic affected GREEN and architecture state — 2026-09-20, Capability-publication race and ownership retention — 2026-09-20, Consequence analysis before production code, Controlled RED — 2026-09-20, Cursor-zero cancellation admission preflight — 2026-09-20, Explicit transport marker implementation and Firefox proof — 2026-09-20, Final immutable release, installation and client acceptance — 2026-09-20 (+17 more)
...
### Community 549 - "TD-122: Привязать legacy replay suppression к конкретному запросу"
Cohesion: 0.15
Nodes (9): ColdLemmaBindingV1, empty_productive_readout(), PackagedGroundedLemmaV1, PackagedProductiveReadoutV1, ProductiveWorkLimiterV1, EnumerationWorkCountersV1, encode_scene_wave(), L2LocalSceneV1 (+1 more)
...
### Community 551 - "EpochShard"
Cohesion: 0.25
Nodes (8): Candidate result: focused callback proof, runtime unchanged, Consequences and proof boundary, Current consequence and rejected release-only alternative, Final changed-suite structural matcher correction, One text-target contract, existing owners, Preflight: exact-replay native delivery and side-effect quarantine, 2026-09-12, Required causal RED and candidate proof, Selected bounded design
...
### Community 554 - "5. Training Data Contract"
Cohesion: 0.25
...
### Community 555 - "Sentence multiview field and portable delta proof, 2026-08-01"
Cohesion: 0.25
...
### Community 560 - "Lay — текущая очередь"
Cohesion: 0.07
Nodes (31): try_ime_replace_tail(), authorize_backend_edit(), AuthorizedEdit, BackendDispatchReceipt, BackendEditAuthorization, ExecutionBackend, only_an_undispatched_receipt_allows_backend_reselection(), From (+23 more)
...
### Community 570 - "prepare_exact_layout_active_composition_autocorrect_observed"
Cohesion: 0.20
...
### Community 571 - "load_personal_correction_events"
Cohesion: 0.20
...
### Community 572 - "verify_with_retry"
Cohesion: 0.52
...
### Community 573 - "TD-124 — Воспроизводимый короткий цикл сопровождения"
Cohesion: 0.22
...
### Community 574 - "PendingAtomicTransition"
Cohesion: 0.21
...
Cohesion: 0.29
Nodes (7): Accepted repairs and supporting source evidence, Closing supplement — source contracts and canonical execution, Exact read scope and fingerprints, Findings and verdict, Mechanical continuation of pass 2 — final source binding, Proof denominators and execution status, TD-120 independent code review — pass 2
...
Cohesion: 0.29
Nodes (7): Bounded proof plan, Candidate focused result, Consequence analysis, Design comparison and selected boundary, Frozen V3 causal result, Measured causal hole, Preflight: exact external tail at both replay leases, 2026-09-12
...
### Community 587 - "install-l3-context-delta.sh"
Cohesion: 0.29
...
### Community 591 - "51. V67 Shared-Support Recovery-Birth Paper"
Cohesion: 0.29
...
### Community 609 - "Local n-gram corpora"
Cohesion: 0.29
...
### Community 610 - "12. Promotion Gate"
Cohesion: 0.25
...
### Community 612 - "typing_context_tests.rs"
Cohesion: 0.19
...
### Community 617 - "mod.rs"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 618 - "18. Implementation Route"
Cohesion: 0.33
...
### Community 619 - "10. Boundedness, Cache And Failure Semantics"
Cohesion: 0.33
...
### Community 622 - "9.12 Normative single-pass streaming crystallizer contract"
Cohesion: 0.33
...
### Community 631 - "update-architecture-graph.sh"
Cohesion: 0.33
...
### Community 634 - ".process_pressed_key"
Cohesion: 0.33
...
### Community 637 - "check-lay-lints.sh"
Cohesion: 0.33
...
### Community 639 - "visit_tokenized_fragments"
Cohesion: 0.33
...
### Community 651 - "7. Three-Level Decision Model"
Cohesion: 0.40
...
Cohesion: 0.07
Nodes (28): C18 autocomplete: effect settlement on key release, C18 GUI diagnostic: первый доказанный reducer, Consequence analysis, Controlled discriminator outcome — 2026-09-13, Cross-profile execution outcome — C10 through C12, Current acceptance — 2026-09-14, final R5 native FAIL, Current R6 native result — 2026-09-14, Current R7 development — 2026-09-14 (+20 more)
...
### Community 655 - "Supervised sentence online delta closure, 2026-08-10"
Cohesion: 0.40
...
### Community 656 - "21. Exact User Rollback Feedback And Standard Publication, 2026-08-10"
Cohesion: 0.15
Nodes (3): Option, typing_correction_should_skip_auto_undo(), unsafe_word_count_shrink()

### Community 657 - "Local Outcome Corpus"
Cohesion: 0.53
...
### Community 660 - "Public issues 42–44 and release 1.0.70"
Cohesion: 0.33
...
### Community 665 - "14. 2026-08-06 Short-Function Boundary Shift And Space Timing"
Cohesion: 0.40
...
### Community 672 - "TD-120 bounded repair pass 2 — consequence addendum"
Cohesion: 0.40
...
### Community 675 - "46. 2026-08-16 Unified IME Token Field Plan"
Cohesion: 0.40
...
### Community 687 - "9.12 Normative single-pass streaming crystallizer contract"
Cohesion: 0.40
...
### Community 688 - "resolve_l1_terminals"
Cohesion: 0.40
...
### Community 693 - "Очистка новой рабочей ветки — 2026-09-08"
Cohesion: 0.40
...
### Community 694 - "Slice 5: missing target birth and retention shadow"
Cohesion: 0.50
...
### Community 695 - "Incremental Runtime Memory"
Cohesion: 0.50
...
### Community 696 - "TD-121 remote deployed-IBus private transport proof"
Cohesion: 0.20
...
### Community 697 - "record_typing_memory_episode_if_enabled"
Cohesion: 0.29
...
Cohesion: 0.47
Nodes (4): LayGdkEventKey, gtk_im_context_filter_keypress(), gtk_im_context_reset(), request_surrounding()

### Community 709 - "TD-121 — deployed IBus private transport baseline"
Cohesion: 0.40
...
### Community 715 - "20. 2026-08-10 Productive Decoder Cache V26"
Cohesion: 0.50
...
### Community 717 - "l2_transition_phase_shadow_readout"
Cohesion: 0.50
...
### Community 721 - "PreparedCompositionalField"
Cohesion: 0.50
...
### Community 722 - "restore_word_cli.rs"
Cohesion: 0.50
...
### Community 724 - "Все задачи tech_debt: план, отчёты и публикация"
Cohesion: 0.50
...
### Community 726 - "Mutter/GTK event-dispatch consumer probe, 2026-09-12"
Cohesion: 0.50
...
### Community 732 - "correct_wrong_layout_cyrillic_word_with_policy"
Cohesion: 0.50
...
### Community 734 - "Causal live-feedback reducer and mandatory full gate, 2026-07-31"
Cohesion: 0.67
...
### Community 736 - "l3-self-teacher-promotion-gate.sh"
Cohesion: 0.83
Nodes (3): run_bin(), l3-self-teacher-promotion-gate.sh script, usage()

### Community 737 - "resolve-l2-package.sh"
Cohesion: 0.83
...
### Community 740 - "Proof And Publication"
Cohesion: 0.67
...
### Community 746 - "input_gate_space_contract.rs"
Cohesion: 0.35
...
### Community 748 - "8. Productive Prefix Trie"
Cohesion: 0.83
...
### Community 752 - "build-release-binaries.sh"
Cohesion: 0.67
...
### Community 753 - "bump-version-from-git.sh"
Cohesion: 0.67
...
### Community 757 - "main"
Cohesion: 0.67
Nodes (3): Exact extracted remote probe, Historical rejected handwritten mirror, Mutter/GTK event-dispatch consumer probe, 2026-09-12

### Community 759 - "reject_quality_mutation"
Cohesion: 0.67
Nodes (3): 2.1 Included, 2.2 Excluded, 2. Scope

### Community 760 - "tests.rs"
Cohesion: 0.67
...
### Community 761 - "Public issues 42–44 and release 1.0.70"
Cohesion: 0.22
...
### Community 776 - "3. Architectural Defects To Remove"
Cohesion: 0.33
...
### Community 801 - "21. Exact User Rollback Feedback And Standard Publication, 2026-08-10"
Cohesion: 0.40
...
Cohesion: 0.05
Nodes (45): NonZeroU32, set_original_status_for_test(), BoundedTargetSetV1, completeness_states_roundtrip_without_truncation(), CompletenessScopeV1, EnumerationCompletenessV1, EnumerationStateV1, EnumerationWorkCountersV1 (+37 more)

### Community 955 - "server.rs"
Cohesion: 0.13
Nodes (27): Args, Now, main(), Box, Error, Result, collect_startup_warmups(), collect_startup_warmups_with_now() (+19 more)
...
## Knowledge Gaps
- **2736 isolated node(s):** `dev-reload.sh script`, `IBUS_SYNC_RETRY_MS`, `_uid`, `LayIndicator`, `app` (+2731 more)
...
- **Why does `StandaloneL2Field` connect `balanced_l2_words_by` to `tests.rs`, `correction_memory_runtime.rs`, `PhaseReadout`, `KeyEvent`, `TextEditBackend`, `config_runtime.rs`, `typing_assist_deferred.rs`, `WaveTrace`, `WordBuffer`, `ensure_engine`, `usage_prior.rs`, `candidate_gate.rs`, `decode_ascii_tail`, `String`, `TextTransitionRejection`, `typing_assist_short_alternating.rs`, `install-l2-transition-phase.sh`, `String`, `.load`, `LayIbusEngine`, `.forward_queued_typing`, `technical.rs`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `KeyEvent` connect `mod.rs` to `default_typing_assist_pipeline`, `lay_nanda_wave_eval.rs`, `L1-L4 Intelligence Route`, `canonical_l2_recent.rs`, `text_edit_gate_contract.rs`, `l3.rs`, `layout_sync.rs`, `l2_wave_peak.rs`, `correction_core.rs`, `decide_scoped_tail_correction`, `l4_active_disambiguation.rs`, `L2ProbePool`, `Double Shift вместо ручного удаления: локальный помощник раскладки для Linux`, `PendingTypingAssist`, `TypingRuleContext`, `update`, `WaveOptions`, `README.md`, `typing_context_tests.rs`, `lay-kde-tray.py`, `layout_niri.rs`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `CandidateOrigin` connect `LexicalPhaseMemory` to `decode_typing_assist_tail`, `L3Feedback`, `EvalCase`, `WordCandidate`, `EnterAutocorrectContext`, `surface_motif_memory`, `graphify reference: GitHub clone and cross-repo merge`, `usage_prior.rs`, `Two-word model evaluation`, `l3_context_metrics.rs`, `.forward_queued_typing`, `PhysicalInputGrab`, `installed_l2_field`, `replay_layout_decision`, `preposition.rs`, `structural_relation.rs`, `cargo-guard.sh`, `Русские площадки для первой волны`, `choose_token_consensus_with_chooser`, `gate_candidate_with_source`?**
...
- **Should `learning_loop.rs` be split into smaller, more focused modules?**
  _Cohesion score 0.060615677562678515 - nodes in this community are weakly interconnected._
